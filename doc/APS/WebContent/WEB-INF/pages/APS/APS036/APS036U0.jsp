		...
		<table class="MainBodyColor" id="table3" cellpadding="0" cellspacing="0" width="870px" border="0">
			...
			<tr>
				...
				<td align="left" colspan="3">
					<s:select key="reinsInwardMainData.cmnpNo" id="cmnpNo" theme="simple" 
			...
			<tr>
				...
				<td align="left" colspan="3"><s:textfield key="reinsInwardMainData.broker" id="broker" size="40" maxlength="40" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td align="left" >
					...
					<s:textfield key="reinsInwardMainData.endDate" id="endDate" size="7" maxlength="7" cssClass="number"/></td>
