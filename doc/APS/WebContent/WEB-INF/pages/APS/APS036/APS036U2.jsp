...
<script language="JavaScript">
	...
	$(function() {
		...
		$("#endorseStartDate").change(function() {
			var endorseStartDate = $("#endorseStartDate").val();
			if(endorseStartDate != "" && endorseStartDate != null){
				if (endorseStartDate.length != 7) { 
					alert("日期格式錯誤(YYYMMDD，例如：1110203)");
					$("#endorseStartDate").val("");
					$("#endorseStartDate").focus();
					return;
				}
				
				var re = /^[0-9]*/;//判斷字串是否為數字//判斷正整數/[1−9] [0−9]∗]∗/ 
				if (!re.test(endorseStartDate)) { 
					alert("請輸入數字");
					$("#endorseStartDate").val("");
					$("#endorseStartDate").focus();
					return;
				...
				//1110612
				var year = endorseStartDate.substr(0,3);
				var mm = endorseStartDate.substr(3,2);
				var dd = endorseStartDate.substr(5,2);
		...
		$("#mainForm").validate({
			...
			rules: {
				...
				**/
				"reinsInwardMainData.endorseStartDate":{
					"required":true
				},
				"reinsInwardMainData.endorseEndDate":{
					"required":true
				}
	...
	function form_submit(method){
		 $("label").html('');
		 if('endorseCreate' == method){
			 
			 $("#reinsInwardInsDataStr").val(JSON.stringify(insObj)); 
			 $("#mainForm").attr("action","btnEndorse.action");
			 $("#mainForm").submit();
		 }
		 if('endorseUpdate' == method){
		 ...
		 if('clear' == method){
				if (confirm("請確認是否放棄批改並返回查詢頁面？")==true){
					$("#clearForm").submit();
				}
			return false;
		 }
	...
	function calculateFb1PremA(sumPrem){
		...
		for(var i = 0 ; i < insObj.length ; i++){
			...
			if("F-F-28-FT" == key || "F-F-25-FE01" == key){
				...
				var oriCurrAmount = obj.oriCurrAmount;
				if(oriCurrAmount == "" || oriCurrAmount == null ){
					continue;
				}
				if(oriCurrPrem == "" || oriCurrPrem == null ){
					oriCurrPrem = 0;
	...
	function calculateFb1Prem(){
		...
		var undertakingRate = $("#undertakingRate").val();
		if(undertakingRate == "" || undertakingRate == null){
			undertakingRate = 0;
		}
		var oriCurrPrem = $("#oriCurrPrem").val().replace(/\,/g, '');
		if(oriCurrPrem == "" || oriCurrPrem == null){
		...
		for(var i = 0 ; i < insObj.length ; i++){
			...
			if("F-F-28-FT" == key || "F-F-25-FE01" == key){
				...
				var tmpAmount = obj.oriCurrAmount.replace(/\,/g, '');
				if(tmpAmount == "" || tmpAmount == null ){
					continue;
				}
	...
	function updateDetail(idx) {
		...
		calculateInsDetail();
		//觸發險種佣金計算
		$("#insCommissionRate").trigger("change");
...
<s:form theme="simple" namespace="/aps/036" id="mainForm" name="mainForm">
	...
	<input type="hidden" name="reinsInwardMainData.oid" id="oid" value="<s:property value="reinsInwardMainData.oid" />"/>
	<input type="hidden" name="reinsInwardMainData.type" id="type" value="<s:property value="reinsInwardMainData.type" />"/>
	<input type="hidden" name="reinsInwardMainData.classcode" id="classcode" value="<s:property value="reinsInwardMainData.classcode" />"/>
	<input type="hidden" name="reinsInwardMainData.cmnpNo" id="cmnpNo" value="<s:property value="reinsInwardMainData.cmnpNo" />"/>
	<input type="hidden" name="reinsInwardMainData.broker" id="broker" value="<s:property value="reinsInwardMainData.broker" />"/>
	<input type="hidden" name="reinsInwardMainData.policyNo" id="policyNo" value="<s:property value="reinsInwardMainData.policyNo" />"/>
	<input type="hidden" name="reinsInwardMainData.endorseNo" id="endorseNo" value="<s:property value="reinsInwardMainData.endorseNo" />"/>
	<input type="hidden" name="reinsInwardMainData.signDate" id="signDate" value="<s:property value="reinsInwardMainData.signDate" />"/>
	<input type="hidden" name="reinsInwardMainData.startDate" id="startDate" value="<s:property value="reinsInwardMainData.startDate" />"/>
	<input type="hidden" name="reinsInwardMainData.endDate" id="endDate" value="<s:property value="reinsInwardMainData.endDate" />"/>
	<input type="hidden" name="reinsInwardMainData.status" id="status" value="<s:property value="reinsInwardMainData.status" />"/>
		...
		<table class="MainBodyColor" id="table3" cellpadding="0" cellspacing="0" width="870px" border="0">
			<tr>
				...
				<td align="left" width="200px">
					<s:if test='reinsInwardMainData.classcode == "A"'>任意車險</s:if>
					<s:if test='reinsInwardMainData.classcode == "B"'>強制險</s:if>
					<s:if test='reinsInwardMainData.classcode == "E"'>工程險</s:if>
					<s:if test='reinsInwardMainData.classcode == "F01"'>商業火險</s:if>
					<s:if test='reinsInwardMainData.classcode == "F02"'>住火險</s:if>
					<s:if test='reinsInwardMainData.classcode == "M"'>水險</s:if>
					<s:if test='reinsInwardMainData.classcode == "C"'>新種險</s:if>
					<s:if test='reinsInwardMainData.classcode == "C1"'>傷害險</s:if>
				</td>
			...
			<tr>
				...
				<td align="left" colspan="3">
					<s:if test='reinsInwardMainData.cmnpNo == "01"'>01-臺灣產物保險股份有限公司</s:if>
					<s:if test='reinsInwardMainData.cmnpNo == "02"'>02-兆豐產物保險股份有限公司</s:if>
					<s:if test='reinsInwardMainData.cmnpNo == "05"'>05-富邦產物保險股份有限公司</s:if>
					<s:if test='reinsInwardMainData.cmnpNo == "06"'>06-和泰產物保險股份有限公司</s:if>
					<s:if test='reinsInwardMainData.cmnpNo == "07"'>07-泰安產物保險股份有限公司</s:if>
					<s:if test='reinsInwardMainData.cmnpNo == "08"'>08-明台產物保險股份有限公司</s:if>
					<s:if test='reinsInwardMainData.cmnpNo == "09"'>09-南山產物保險股份有限公司</s:if>
					<s:if test='reinsInwardMainData.cmnpNo == "10"'>10-第一產物保險股份有限公司</s:if>
					<s:if test='reinsInwardMainData.cmnpNo == "12"'>12-旺旺友聯產物保險股份有限公司</s:if>
					<s:if test='reinsInwardMainData.cmnpNo == "13"'>13-新光產物保險股份有限公司</s:if>
					<s:if test='reinsInwardMainData.cmnpNo == "14"'>14-華南產物保險股份有限公司</s:if>
					<s:if test='reinsInwardMainData.cmnpNo == "15"'>15-國泰世紀產物保險股份有限公司</s:if>
					<s:if test='reinsInwardMainData.cmnpNo == "17"'>17-新安東京海上產物保險股份有限公司</s:if>
					<s:if test='reinsInwardMainData.cmnpNo == "28"'>28-比利時商裕利安宜產物保險股份有限公司台灣分公司</s:if>
					<s:if test='reinsInwardMainData.cmnpNo == "29"'>29-新加坡商美國國際產物保險股份有限公司台灣分公司</s:if>
					<s:if test='reinsInwardMainData.cmnpNo == "30"'>30-法商科法斯產物保險股份有限公司台灣分公司</s:if>
					<s:if test='reinsInwardMainData.cmnpNo == "32"'>32-美商安達產物保險公司台北分公司</s:if>
					<s:if test='reinsInwardMainData.cmnpNo == "46"'>46-法商法國巴黎產物保險股份有限公司台灣分公司</s:if>
				</td>
			</tr>
			<tr>
				<td align="right" width="200px">分出保經代公司：</td>
				<td align="left">
					<s:property value="reinsInwardMainData.broker" />
				</td>
			...
			<tr>
				...
				<td align="right" width="200px">批單起迄日(YYYMMDD)：</td>
				<td align="left" ><s:textfield key="reinsInwardMainData.endorseStartDate" id="endorseStartDate" size="7" maxlength="7" cssClass="number"/>-<s:textfield key="reinsInwardMainData.endorseEndDate" id="endorseEndDate" size="7" maxlength="7" cssClass="number"/></td>
			</tr>
			<tr>
	...
	<fieldset style="width:800px;">
		...
		<table class="MainBodyColor" id="table3" cellpadding="0" cellspacing="0" width="870px" border="0">
			<tr>
				...
				<td align="left" ><s:textfield key="reinsInwardMainData.exchangeRate" id="exchangeRate" size="10" maxlength="10" cssClass="numberDot"/></td>
			</tr>
			<tr>
	    ...
	    <div id="dialog" title="新增險種">
			<table class="MainBodyColor" id="table3" cellpadding="0" cellspacing="0" width="870px" border="0">
				...
				<tr>
					...
					<td align="left" ><s:textfield key="reinsInwardInsData.typAmountRate" id="insTypAmountRate" size="10" maxlength="10" cssClass="numberDot"/>%</td>
					<td align="right" width="200px">颱洪保費比例：</td>
					<td align="left" ><s:textfield key="reinsInwardInsData.typPremRate" id="insTypPremRate" size="10" maxlength="10" cssClass="numberDot"/>%</td>
				</tr>
				<tr>
					<td align="right" width="200px">地震保額比例：</td>
					<td align="left" ><s:textfield key="reinsInwardInsData.earthAmountRate" id="insEarthAmountRate" size="10" maxlength="10" cssClass="numberDot"/>%</td>
					<td align="right" width="200px">地震保費比例：</td>
					<td align="left" ><s:textfield key="reinsInwardInsData.earthPremRate" id="insEarthPremRate" size="10" maxlength="10" cssClass="numberDot"/>%</td>
				</tr>
				<tr>
	...
	<fieldset style="width:800px;">
		...
		<table class="MainBodyColor" id="table3" cellpadding="0" cellspacing="0" width="870px">
			...
			<tr>
				...
				<td align="left" colspan="3"><s:textfield key="reinsInwardMainData.commissionDate" id="commissionDate" size="8" maxlength="8"/></td>
			</tr>
			<tr>
				<td align="right" width="200px">保費收款/退款日：</td>
				<td align="left" colspan="3"><s:textfield key="reinsInwardMainData.payDate" id="payDate" size="8" maxlength="8"/></td>
			</tr>
			<tr>
				<td align="right" width="200px">第一期保費到期日：</td>
				<td align="left" colspan="3"><s:textfield key="reinsInwardMainData.firstPremDueDate" id="firstPremDueDate" size="8" maxlength="8"/></td>
			</tr>
			 -->
		</table>
	</fieldset>
	<fieldset style="width:800px;">
		...
		<table class="MainBodyColor" id="table3" cellpadding="0" cellspacing="0" width="870px">
			...
			<tr>
				...
				<td align="left"><s:property value="reinsInwardMainData.creater" /></td>
				<td align="right" width="200px">輸入日期：</td>
				<td align="left"><s:property value="reinsInwardMainData.createDate"/></td>
			</tr>
			<tr>
	...
	<table width="970px">
		<tr>
			<td align="center">
				<s:if test='(roleType == "RI001" && reinsInwardMainData.status == "")'>
					<input value="存檔" type="button" onclick="javascript:form_submit('endorseCreate');">&nbsp;&nbsp;&nbsp;&nbsp; 
				</s:if>
				<s:if test='(roleType == "RI001" && reinsInwardMainData.status == "0")'>
					<input value="存檔" type="button" onclick="javascript:form_submit('endorseUpdate');">&nbsp;&nbsp;&nbsp;&nbsp;
				</s:if>
