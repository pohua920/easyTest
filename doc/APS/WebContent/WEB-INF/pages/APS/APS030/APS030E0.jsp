...
<%
	...
	String title = "金控利關人資料同步作業";
	String image = path + "/" + "images/";
	String GAMID = "APS030E0";
	String mDescription = "金控利關人資料同步作業";
	String nameSpace = "/aps/030";
%>
...
<s:form theme="simple" namespace="/aps/030" id="mainForm" name="mainForm">
...
<table class="MainBodyColor" id="table3" cellpadding="0" cellspacing="0" width="970px">
	<tbody>
		<tr>
			...
			<input type="button" value="執行金控利關人資料同步作業" onclick="javascript:form_submit('excute');"/>
			</td>
		</tr>
	</tbody>
</table>
