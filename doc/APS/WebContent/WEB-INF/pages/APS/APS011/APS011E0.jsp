...
<%
	...
	String title = "AML洗錢手動登錄查詢作業";
	String image = path + "/" + "images/";
	String GAMID = "APS011E0";
	String mDescription = "AML洗錢手動登錄查詢作業";
...
<s:url action="lnkDtlGoQuery?amlQueryObjMain.oid=" namespace="/aps/011" var="dtlQuery"/>
<s:url action="lnkResultMainGoQuery?amlQueryObjMain.oid=" namespace="/aps/011" var="resultQuery"/>
<body style="margin:0;text-align:left">
<table cellspacing="1" cellpadding="1" width="970px" border="0">
	<tr>
		<td width="485px">
			<img src="${pageContext.request.contextPath}/images/Help_Icon.gif" border="0" width="49" height="26">
			<a href="${pageContext.request.contextPath}<%=nameSpace%>/lnkGoCreate.action"><img src="${pageContext.request.contextPath}/images/New_Icon.gif" border="0" width="49" height="26"></a>
		</td>
...
<s:form theme="simple" namespace="/aps/011" id="mainForm" name="mainForm">
	...
	<table class="MainBodyColor" id="table3" cellpadding="0" cellspacing="0" width="970px">
		<tr>
        	<td width="200px" align="right">使用者ID：</td>
