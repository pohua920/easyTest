...
// 		}
	...
	function ajaxAction(action,value){
		...
		if(action == 'verifyBasicData'){
	    	...
	    	path = contextPath + '/aps/ajax016/verifyBotBasicData.action?checkType='+value;
		}
		var async = false;
		...
		if(action == 'structureLeval'){
			path = contextPath + '/aps/ajax016/checkStructureLeval.action';
		}
		if(action == 'handleridentifynumber'){
			path = contextPath + '/aps/ajax016/checkHandleridentifynumber.action';
		}
...
<!-- clear form -->
<s:form theme="simple" action="lnkGoQuery" namespace="/aps/055" id="clearForm" name="clearForm"/>
<!-- form 開始 -->
<s:form theme="simple" namespace="/aps/055" id="mainForm" name="mainForm">	
	...
	<table class="MainBodyColor" id="table3" cellpadding="0" cellspacing="0" width="970px" >
		<tr>
			...
			<td width="200px" align="left">
				<s:property value="botDetailVo.batchNo"/>
				<s:hidden key="botDetailVo.batchNo" id="batchNo"></s:hidden>
			</td>
			<td width="150px" align="right">序號：</td>
			<td width="200px" align="left">
				<s:property value="botDetailVo.batchSeq"/>
				<s:hidden key="botDetailVo.batchSeq" id="batchSeq"></s:hidden>
			</td>
		</tr>
		<tr>
			<td width="150px" align="right">險別：</td>
			<td width="200px" align="left">
				<c:choose>
					<c:when test="${botDetailVo.temp1 == '11'}">住火</c:when>
					<c:when test="${botDetailVo.temp1 == '10'}">商火</c:when>
				</c:choose>
				<s:hidden key="botDetailVo.temp1" id="temp1"></s:hidden>
			</td>
			<td width="150px" align="right">續保約定：</td>
			<td width="200px" align="left">
				<s:property value="botDetailVo.isAutoRenew"/>
			</td>
		</tr>
		...
		<tr>
			...
			<td width="200px" align="left">
				<c:choose>
					<c:when test="${botDetailVo.dataStatus == '0'}">未處理</c:when>
					<c:when test="${botDetailVo.dataStatus == '1'}">APS暫存失敗</c:when>
					<c:when test="${botDetailVo.dataStatus == '2'}">APS暫存成功</c:when>
					<c:when test="${botDetailVo.dataStatus == '3'}">轉核心暫存成功</c:when>
					<c:when test="${botDetailVo.dataStatus == '4'}">轉核心暫存失敗</c:when>
					<c:when test="${botDetailVo.dataStatus == '5'}">轉核心要保成功</c:when>
					<c:when test="${botDetailVo.dataStatus == '6'}">轉核心要保失敗</c:when>
					<c:when test="${botDetailVo.dataStatus == '7'}">轉核心完成</c:when>
					<c:when test="${botDetailVo.dataStatus == '8'}">轉核心失敗-寫入收付失敗</c:when>
					<c:when test="${botDetailVo.dataStatus == 'A'}">人工判定不轉核心</c:when>
					<c:when test="${botDetailVo.dataStatus == 'B'}">臺銀已鎖定尚未比對簽署檔</c:when>
					<c:when test="${botDetailVo.dataStatus == 'C'}">臺銀比對簽署檔不一致</c:when>
		...
		<tr>
			...
			<td width="200px" align="left">
				<s:property value="botDetailVo.checkErrMsg"/>
			</td>
		</tr>
		<tr><td width="150px" align="right"></td></tr>
		<tr>
			...
			<td width="200px" align="left">
				<s:property value="botDetailVo.checkWarnMsg"/>
			</td>
		</tr>
		<tr><td width="150px" align="right"></td></tr>
		<tr>
	...
	<table class="MainBodyColor" id="table3" cellpadding="0" cellspacing="0" width="970px" >
		<tr>
			...
			<td width="200px" align="left">
				<s:textfield key="botDetailVo.oldpolicyno" id="oldpolicyno" onkeyup="toUpperCase(this);" size="20" maxLength="40"/>
			</td>
			<td width="150px" align="right">受理編號：</td>
			<td width="200px" align="left">
				<s:textfield key="botDetailVo.orderseq" id="orderseq" maxLength="20" size="20"/>
			</td>
		</tr>
		<tr>
			<td width="150px" align="right">歸屬單位：</td>
			<td width="200px" align="left">
				<s:textfield key="botDetailVo.comcode" id="comcode" readonly="true" cssClass="txtLabel" maxLength="10" size="10"/>
			</td>
			<td width="150px" align="right">服務人員：</td>
			<td width="200px" align="left">
				<s:textfield key="botDetailVo.handler1code" id="handler1code" readonly="true" cssClass="txtLabel" maxLength="20" size="20"/>
			</td>
		</tr>
		<tr>
			<td width="150px" align="right">保單生效日：</td>
			<td width="200px" align="left">
				<s:textfield key="botDetailVo.startdate" id="startdate" maxLength="10" size="10"/>
			</td>
		</tr>
		<tr>
			<td width="150px" align="right">業務員登錄證號：</td>
			<td width="200px" align="left">
				<s:textfield key="botDetailVo.handleridentifynumber" id="handleridentifynumber" onkeyup="toUpperCase(this);" maxLength="20" size="20"/>
			</td>
			<td width="150px" align="right">分行員編：</td>
			<td width="200px" align="left">
				<s:textfield key="botDetailVo.temp2" id="temp2" maxLength="10" size="10"/>
			</td>
		</tr>
		<tr>
			<td width="150px" align="right">分行代號：</td>
			<td width="200px" align="left">
				<s:textfield key="botDetailVo.extracomcode" id="extracomcode" maxLength="20" size="10" />
			</td>
			<td width="150px" align="right">分行名稱：</td>
			<td width="200px" align="left">
				<s:textfield key="botDetailVo.extracomname" id="extracomname" maxLength="20" size="20"/>
			</td>
		</tr>
	</table>
	<span>=========================================================================抵押權人========================================================================</span>
	<table class="MainBodyColor" id="table3" cellpadding="0" cellspacing="0" width="970px" >
		<tr>
			...
			<td width="200px" align="left">
				<s:textfield key="botDetailVo.mortgageepcode1" id="mortgageepcode1" readonly="true" cssClass="txtLabel" maxLength="20" size="20"/>
			</td>
			<td width="150px" align="right">授信號碼：</td>
			<td width="200px" align="left">
				<s:textfield key="botDetailVo.creditnumber1" id="creditnumber1" maxLength="40" size="20"/>
			</td>
		</tr>
		<tr>
			<td width="150px" align="right">擔保品編號：</td>
			<td width="200px" align="left">
				<s:textfield key="botDetailVo.collateralnumber1" id="collateralnumber1" maxLength="40" size="20"/>
			</td>
			<td width="150px" align="right">貸款編號：</td>
			<td width="200px" align="left">
				<s:textfield key="botDetailVo.loansbehalfnumber1" id="loansbehalfnumber1" maxLength="40" size="20"/>
			</td>
		</tr>
		<tr>
			<td width="150px" align="right">放款帳號：</td>
			<td width="200px" align="left">
				<s:textfield key="botDetailVo.loanaccount1" id="loanaccount1" maxLength="40" size="20"/>
			</td>
			<td width="150px" align="right">放款部門別：</td>
			<td width="200px" align="left">
				<s:textfield key="botDetailVo.loansdepartment1" id="loansdepartment1" maxLength="40" size="20"/>
			</td>
		</tr>
		<tr>
			...
			<td width="200px" align="left">
						<!-- mantis：FIR0621，處理人員：BJ085，需求單編號：FIR0621 住火_臺銀續保作業_續件資料處理作業 第二階段 -->
				<s:textfield key="botDetailVo.accountno" id="accountno" maxLength="40" size="40"/>
			</td>
		</tr>
	</table>
	<span>==========================================================================標的物=========================================================================</span>
	<table class="MainBodyColor" id="table3" cellpadding="0" cellspacing="0" width="970px" >
		<tr>
			...
			<td width="200px" align="left">
				<s:textfield key="botDetailVo.addresscode" id="addresscode" maxLength="3" size="3"/>
			</td>
			<td width="150px" align="right">縣市行政區：</td>
			<td width="200px" align="left">
				<s:textfield key="botDetailVo.addressname" id="addressname" readonly="true" cssClass="txtLabel" maxLength="40" size="40"/>
			</td>
		</tr>
		<tr>
			<td width="150px" align="right">標的物地址：</td>
			<td width="200px" align="left">
				<s:textfield key="botDetailVo.addressdetailinfo" id="addressdetailinfo" maxLength="200" size="50"/>
			</td>
		</tr>
		<tr>
			<td width="150px" align="right">外牆：</td>
			<td width="200px" align="left">
				<s:textfield key="botDetailVo.wallmaterial" id="wallmaterial" maxLength="5" size="5"/>
				<s:textfield key="botDetailVo.wallname" id="wallname" value="" readonly="true" cssClass="txtLabel"></s:textfield>
			</td>
			<td width="150px" align="right">屋頂：</td>
			<td width="200px" align="left">
				<s:textfield key="botDetailVo.roofmaterial" id="roofmaterial" maxLength="10" size="10"/>
				<s:textfield key="botDetailVo.roofname" id="roofname" value="" readonly="true" cssClass="txtLabel"></s:textfield>
			</td>
		</tr>
		<tr>
			<td width="150px" align="right">使用面積(坪)：</td>
			<td width="200px" align="left">
				<s:textfield key="botDetailVo.buildarea" id="buildarea" maxLength="10" size="10"/>
			</td>
			<td width="150px" align="right">總樓層數：</td>
			<td width="200px" align="left">
				<s:textfield key="botDetailVo.sumfloors" id="sumfloors" maxLength="10" size="10"/>
			</td>
		</tr>
		<tr>
			<td width="150px" align="right">建築等級：</td>
			<td width="200px" align="left">
				<s:textfield key="botDetailVo.structure" id="structure" readonly="true" cssClass="txtLabel" maxLength="5" size="5"/>
			</td>
			<td width="150px" align="right">建築年分：</td>
			<td width="200px" align="left">
				<s:textfield key="botDetailVo.buildyears" id="buildyears" maxLength="3" size="3"/>
			</td>
		</tr>
		<tr>
			<td width="150px" align="right">建築等級說明：</td>
			<td width="200px" align="left">
				<s:textfield key="botDetailVo.structureText" id="structureText" readonly="true" cssClass="txtLabel" maxLength="50" size="50"/>
			</td>
		</tr>
		<tr>
			<td width="150px" align="right">複保險序號：</td>
			<td width="200px" align="left">
				<s:textfield key="botDetailVo.repeatpolicyno" id="repeatpolicyno" readonly="true" cssClass="txtLabel" maxLength="15" size="20"/>
			</td>
			<td width="150px" align="right">複保險結果：</td>
			<td width="200px" align="left">
				<s:textfield key="botDetailVo.dquakeStatus" id="dquakeStatus" readonly="true" cssClass="txtLabel" maxLength="40" size="40"/>
			</td>
		</tr>
	</table>
	...
	<table class="MainBodyColor" id="table3" cellpadding="0" cellspacing="0" width="970px" >
		<tr>
			...
			<td width="200px" align="left">
				<s:textfield key="botDetailVo.amountF" id="amountF" maxLength="10" size="10"/>
			</td>
			<td width="150px" align="right">地震險保額：</td>
			<td width="200px" align="left">
				<s:textfield key="botDetailVo.amountQ" id="amountQ" maxLength="10" size="10"/>
			</td>
		</tr>
		<tr>
			<td width="150px" align="right">火險保費：</td>
			<td width="200px" align="left">
				<s:textfield key="botDetailVo.premiumF" id="premiumF" maxLength="10" size="10"/>
			</td>
			<td width="150px" align="right">地震險保費：</td>
			<td width="200px" align="left">
				<s:textfield key="botDetailVo.premiumQ" id="premiumQ" maxLength="10" size="10"/>
			</td>
		</tr>
		<tr>
			<td width="150px" align="right">高樓加費：</td>
			<td width="200px" align="left">
				<s:textfield key="botDetailVo.highrisefee" id="highrisefee" readonly="true" cssClass="txtLabel" maxLength="14" size="14"/>
			</td>
		</tr>
	</table>
	...
	<table class="MainBodyColor" id="table3" cellpadding="0" cellspacing="0" width="970px" >
		<tr>
			...
			<td width="200px" align="left">
				<s:textfield key="botDetailVo.amountFLast" id="amountFLast" readonly="true" cssClass="txtLabel" maxLength="12"/>
			</td>
			<td width="150px" align="right">前期地震保額：</td>
			<td width="200px" align="left">
				<s:textfield key="botDetailVo.amountQLast" id="amountQLast" readonly="true" cssClass="txtLabel" maxLength="12"/>
			</td>
		</tr>
		<tr>
			<td width="150px" align="right">前期火險保費：</td>
			<td width="200px" align="left">
				<s:textfield key="botDetailVo.premiumFLast" id="premiumFLast" readonly="true" cssClass="txtLabel" maxLength="12"/>
			</td>
			<td width="150px" align="right">前期地震保費：</td>
			<td width="200px" align="left">
				<s:textfield key="botDetailVo.premiumQLast" id="premiumQLast" readonly="true" cssClass="txtLabel" maxLength="12"/>
			</td>
		</tr>
	</table>
	<span>=======================================================================要被保人資料=======================================================================</span>	
	...
	<table class="MainBodyColor" id="table3" cellpadding="0" cellspacing="0" width="970px" >
		<tr>
			...
			<td width="200px" align="left">
				<s:property value="botDetailVo.icreate"/>
			</td>
			<td width="150px" align="right">新增時間：</td>
			<td width="200px" align="left">
				<fmt:formatDate value='${botDetailVo.dcreate}' pattern='yyyy/MM/dd HH:mm:ss'/>
			</td>
		</tr>
		<tr>
			<td width="150px" align="right">最後修改人員：</td>
			<td width="200px" align="left">
				<s:property value="botDetailVo.iupdate"/>
			</td>
			<td width="150px" align="right">最後修改時間：</td>
			<td width="200px" align="left">
				<fmt:formatDate value='${botDetailVo.dupdate}' pattern='yyyy/MM/dd HH:mm:ss'/>
			</td>
		</tr>
		<tr>
			<td width="150px" align="right">剔退：</td>
			<td width="200px" align="left">
				<s:select key="botDetailVo.sfFlag" id="sfFlag" theme="simple" list="#{'N':'N', 'Y':'Y'}"/>
			</td>
		</tr>
		<tr>
			<td width="150px" align="right">剔退原因：</td>
			<td width="200px" align="left">
				<s:textfield key="botDetailVo.sfReason" id="sfReason" maxLength="300" size="20"/>
			</td>
		</tr>
		<tr>
			<td width="150px" align="right">剔退人員：</td>
			<td width="200px" align="left">
				<s:textfield key="botDetailVo.sfUser" id="sfUser" readonly="true" cssClass="txtLabel" maxLength="20" size="20"/>
			</td>
			<td width="150px" align="right">剔退時間：</td>
			<td width="200px" align="left">
				<fmt:formatDate value='${botDetailVo.sfDate}' pattern='yyyy/MM/dd HH:mm:ss'/>
			</td>
		</tr>
		<tr>
			<td width="150px" align="right">鎖定人員：</td>
			<td width="200px" align="left">
				<s:textfield key="botDetailVo.fixUser" id="fixUser" readonly="true" cssClass="txtLabel" maxLength="20" size="20"/>
			</td>
			<td width="150px" align="right">鎖定時間：</td>
			<td width="200px" align="left">
				<fmt:formatDate value='${botDetailVo.fixDate}' pattern='yyyy/MM/dd HH:mm:ss'/>
			</td>
		</tr>
		<tr>
			<td width="150px" align="right">轉核心狀態：</td>
			<td width="200px" align="left">
				<c:if test="${botDetailVo.prpinsBatchStatus == 0}">未處理</c:if>
				<c:if test="${botDetailVo.prpinsBatchStatus == 1}">執行中</c:if>
				<c:if test="${botDetailVo.prpinsBatchStatus == 2}">完成</c:if>
			</td>
			<td width="150px" align="right">轉核心時間：</td>
			<td width="200px" align="left">
				<fmt:formatDate value='${botDetailVo.transPpsTime}' pattern='yyyy/MM/dd HH:mm:ss'/>
			</td>
		</tr>
		<tr>
			<td width="150px" align="right">轉核心批號：</td>
			<td width="200px" align="left">
				<s:property value="botDetailVo.prpinsBatchNo"/>
			</td>
			<td width="150px" align="right">核心要保書號：</td>
			<td width="200px" align="left">
				<s:property value="botDetailVo.proposalno"/>
			</td>
		</tr>
		
		<s:hidden key="botDetailVo.dquakeNo" id="dquakeNo" value=""></s:hidden>
		<s:hidden key="botDetailVo.oidFirPremcalcTmp" id="oidFirPremcalcTmp" value="" ></s:hidden>
		<s:hidden key="botDetailVo.wsFirAmt" id="wsFirAmt" value="" ></s:hidden>
		<s:hidden key="botDetailVo.wsQuakeAmt" id="wsQuakeAmt" value="" ></s:hidden>
		<s:hidden key="botDetailVo.famtStatus" id="famtStatus" value="" ></s:hidden>
		<s:hidden key="botDetailVo.qamtStatus" id="qamtStatus" value="" ></s:hidden>
		<s:hidden key="botDetailVo.addrStatus" id="addrStatus" value="" ></s:hidden>
		<s:hidden key="botDetailVo.addrDetail" id="addrDetail" value="" ></s:hidden>
		<s:hidden key="botDetailVo.oidFirPremcalcTmp2" id="oidFirPremcalcTmp2" value="" ></s:hidden>
		<s:hidden key="botDetailVo.dataStatus" id="dataStatus" ></s:hidden>
	</table>
	...
	<table width="970px">
		<tr>
			<td align="center">
				<c:choose>
					<c:when test="${botDetailVo.temp1 == 11}">
		    	...
		    	<a href="${pageContext.request.contextPath}<%=nameSpace%>/lnkGoDetailQuery.action?goBack=Y&batchNo=${botDetailVo.batchNo}"><input type="button" value="回上頁"/></a>
		    </td>
		</tr>
	</table>
	<table class="MainBodyColor" id="msgTable" cellpadding="0" cellspacing="0" width="970px" >
		<tr>
			...
			<td width="200px" align="left">
				<s:textarea key="botDetailVo.checkErrMsg" id="errMsg" readonly="true" value="" style="margin: 0px; width: 600px; height: 46px;"/>
			</td>
		</tr>
		<tr>
			<td width="150px" align="right">資料檢查提示：</td>
			<td width="200px" align="left">
				<s:textarea key="botDetailVo.checkWarnMsg" id="warnMsg" readonly="true" value=""  style="margin: 0px; width: 600px; height: 46px;"/>
			</td>
		</tr>
	</table>
