...
<%
	...
	String title = "臺銀續保資料處理作業-明細資料";
	String image = path + "/" + "images/";
	String GAMID = "APS055E1";
...
<s:url action="lnkGoUpdate?" namespace="/aps/055" var="goUpdate"/>
...
<s:form theme="simple" namespace="/aps/055" id="mainForm" name="mainForm">
	...
	<table class="MainBodyColor" id="table3" cellpadding="0" cellspacing="0" width="970px">
		...
		<tr>
			...
			<td width="285px" align="left">
				<s:textfield key="dFilter.orderseq" id="orderseq" />
			</td>
	...
	<s:if test="dtlDevResults != null && 0 != dtlDevResults.size">
		...
		<table border="1" id="gridtable" width="970px" border="0" class="main_table">
			<tr align="center">
				...
				<th width="90px">
					資料狀態
					<c:url value="/aps/055/lnkSortDtlQuery.action" var="sortURL">
			...
			<tr onmouseover="GridOver(this)" onmouseout="GridOut(this)" bgcolor="#EFEFEF">
				...
				<td align="center">
					...
					<c:choose>
						...
						<c:when test="${dataStatus == 'B'}">臺銀已鎖定尚未比對簽署檔</c:when>
						<c:when test="${dataStatus == 'C'}">臺銀比對簽署檔不一致</c:when>
				...
				<td align="center"><s:property value="fixStatus"/></td>
