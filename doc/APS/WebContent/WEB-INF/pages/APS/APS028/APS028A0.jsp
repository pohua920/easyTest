...
<script language="JavaScript">
	$(document).ready(function(){
		...
		$("#orgicode").bind("change",function(){
			ajaxAction("findAgentname");
		});
		
		var validstatus = $("input[name='prpdagentsub.validstatus']:checked");
		if(typeof(validstatus.val()) == "undefined"){
			$("input[name='prpdagentsub.validstatus']")[0].checked = true;
		}
	});
	...
	function form_submit(type){
		if("create" === type && confirm("確認新增此筆資料?")){
	...
	function ajaxAction(action){
		...
		if(action == 'findAgentname'){
	   		var orgicode = $("#orgicode").val();
	    	path = contextPath + '/aps/ajax010/findAgentnameByParams.action?orgicode='+orgicode;
		}
		//執行ajax
		$.ajax({
			url : path,
		...
		<table class="MainBodyColor" id="table3" cellpadding="0" cellspacing="0" width="970px" >
			<tbody>
				<tr bgcolor="white">
					...
					<span id="lbSearch"><b>單筆新增</b></span>
					</td>
					<td class="image" style="width:20px"></td>	
					<td class="SelectTdColor" style="width:200px" align="center">
						<span id="lbSearch"><a href="${pageContext.request.contextPath}<%=nameSpace%>/lnkGobatchUpload.action"><b>批次上傳</b></a></span></td>
			...
			<tbody>
				<tr>
					...
					<td width="180px" align="left">
						<s:textfield key="orgicode" id="orgicode" size="15" maxlength="30" theme="simple" />
					</td>
				</tr>
				<tr>
					<td width="120px" align="right"><font color="#FF0000">*</font>保經代編號：</td>
					<td width="180px" align="left">
						<s:textfield key="prpdagentsub.agentcode" id="agentcode" size="15" maxlength="40" theme="simple"  readonly="true" class="txtLabel" />
					</td>
					<td width="120px" align="right">保經代名稱：</td>
					<td width="285px" align="left">
						<input name="agentname" id="agentname" readonly="readonly" class="txtLabel" size="30"/>
					</td>			
				</tr>
				<tr>
					<td width="120px" align="right"><font color="#FF0000">*</font>保經代分支機構編號：</td>
					<td width="180px" align="left">
						<font size="1" color="#AAAAAA">(由系統自動產生)</font>
					</td>
				...
				<tr>
					...
					<td width="180px" align="left">
						<s:textfield key="prpdagentsub.postcode" id="postcode" size="10" maxlength="20" theme="simple"/>
					</td>
				...
				<tr>
					...
					<td width="180px" align="left">
						<s:textfield key="prpdagentsub.email" id="email" size="25" maxlength="120" theme="simple" />
					</td>
				...
				<tr>
					...
					<td width="180px" align="left">
						<s:textfield key="prpdagentsub.phonenumber" id="phonenumber" size="15" maxlength="40" theme="simple"/>
					</td>
