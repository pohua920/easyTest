...
<s:url action="lnkGoDetailQuery?" namespace="/aps/060" var="dtlQuery"/>
<s:url action="lnkGoDownload" namespace="/aps/060" var="downloadQuery"/>
<s:url action="btnFixData?" namespace="/aps/060" var="fixData"/>
					...
					<td>
						<div align="right">
							<custom:ddlChangePage formId="mainForm" name="pageInfo"
								nameSpace="/aps/060" currentPage="${pageInfo.currentPage}"
			...
			<table border="1" id="gridtable" width="970px" border="0" class="main_table">
				...
				<s:iterator var="row" value="devResults">
					<tr onmouseover="GridOver(this)" onmouseout="GridOut(this)" bgcolor="#EFEFEF">
						<td align="left">
							<a href='${dtlQuery}batchNo=${row.batchNo}&rnYyyymm=${rnYyyymm}'><!--mantis：FIR0676，處理人員：DP0706，需求單編號：FIR0676_住火_元大續保作業_N+1比對擔保品檔案-->
