...
<script language="JavaScript">
	$(document).ready(function(){
		...
		$("#mainForm").validate({
			...
			rules: {
				"aps017EditVo.branchName":{
					"required":true,
				},
				"aps017EditVo.handler1code":{
					"required":true
				}
			},
			messages: {
...
<s:hidden name="aps017EditVo.oid" id="oid"/>
	...
	<tbody>
		...
		<tr>
			...
			<td width="285px" align="left">
				<s:property value="aps017EditVo.businessnature" />-<s:property value="aps017EditVo.codecname" />
			</td>
		...
		<tr>
			...
			<td width="285px" align="left">
				<s:property value="aps017EditVo.branchNo" />
			</td>
			<td width="200px" align="right">分行名稱：</td>
			<td width="285px" align="left">
				<s:textfield key="aps017EditVo.branchName" id="branchName"  theme="simple" />
			</td>			
		</tr>
		<tr>
			<td width="200px" align="right">服務人員：</td>
			<td width="285px" align="left">
				<s:textfield key="aps017EditVo.handler1code" id="handler1code"  theme="simple"  onchange="ajaxAction('findHandler1codeData')"/>
				<span id="handler1codename"><s:property value="aps017EditVo.handler1name" /></span>
			</td>
			<td width="200px" align="right">歸屬單位：</td>
			<td width="285px" align="left">
				<span id="comcode"><s:property value="aps017EditVo.comcode" /></span>
				<span id="comcname"><s:property value="aps017EditVo.comcname" /></span>
			</td>			
		</tr>
		<tr>
			<td width="200px" align="right">備註：</td>
			<td width="285px" align="left" colspan="3">
				<s:textfield key="aps017EditVo.remark" id="remark"  theme="simple"  size="100"/>
			</td>
		</tr>
		<tr>
			<td width="200px" align="right">刪除註記：</td>
			<td width="285px" align="left" colspan="3">
				<s:select key="aps017EditVo.deleteFlag" id="deleteFlag" list="#{'Y':'是','N':'否'}"/>
			</td>			
		</tr>
		<tr>
			<td width="200px" align="right">建檔人員：</td>
			<td width="285px" align="left">
				<s:property value="aps017EditVo.icreate" />
			</td>
			<td width="200px" align="right">建檔日期：</td>
			<td width="285px" align="left">
				<s:property value="aps017EditVo.dcreate" />
			</td>			
		</tr>
		<tr>
			<td width="200px" align="right">最後異動人員：</td>
			<td width="285px" align="left">
				<s:property value="aps017EditVo.iupdate" />
			</td>
			<td width="200px" align="right">最後異動日期：</td>
			<td width="285px" align="left">
				<s:property value="aps017EditVo.dupdate" />
			</td>			
		</tr>
	</tbody>
</table>
