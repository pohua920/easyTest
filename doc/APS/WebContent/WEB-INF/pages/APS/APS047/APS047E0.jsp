	...
	<s:form theme="simple" namespace="/aps/047" id="mainForm" name="mainForm">
		<table id="table2"  cellspacing="0" cellpadding="0" width="970px">
			<tr>
				<td class="SelectTdColor" style="width:200px" align="center">
					<span id="lbSearch"><a href="${pageContext.request.contextPath}<%=nameSpace%>/lnkGoUpload.action"><b>審核作業</b></a></span>
				</td>
		...
		<table class="MainBodyColor" id="table3" cellpadding="0" cellspacing="0" width="970px">
			<tr>
				...
				<td width="285px" align="left">
					<s:select key="filter.nclaim" id="nclaim" 
					theme="simple" list="#{'Y':'已審核', 'N':'未審核'}" />
				</td>
				<td colspan="5"></td>
					...
					<td>
						<div align="right">
							<custom:ddlChangePage formId="mainForm" name="pageInfo"
								nameSpace="/aps/047" currentPage="${pageInfo.currentPage}"
