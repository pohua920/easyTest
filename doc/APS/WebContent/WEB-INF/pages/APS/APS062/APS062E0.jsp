...
<%
	...
	String title = "元大回饋檔排程查詢作業";
	String image = path + "/" + "images/";
	String GAMID = "APS062E0";
...
<s:url action="lnkGoDetailQuery?" namespace="/aps/062" var="dtlQuery"/>
<s:url action="downloadBopFile?" namespace="/aps/062" var="dowGenFile"/>
...
<s:form theme="simple" namespace="/aps/062" id="mainForm" name="mainForm">
	...
	<table class="MainBodyColor" id="table3" cellpadding="0" cellspacing="0" width="970px">
		...
		<tr>
			...
			<td width="285px" align="left">
				<s:select key="filter.batchType" id="batchType" theme="simple" list="#{'03':'保單檔'}" />
			</td> 
			<td colspan="5"></td> 
