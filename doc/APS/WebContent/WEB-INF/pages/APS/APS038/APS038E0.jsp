...
<%
	...
	String title = "板信回饋檔排程查詢作業";
	String image = path + "/" + "images/";
	String GAMID = "APS038E0";
	String mDescription = "板信回饋檔排程查詢作業";
	String nameSpace = "/aps/038";
%>
...
<s:url action="lnkGoDetailQuery?" namespace="/aps/038" var="dtlQuery"/>
<s:url action="downloadBopFile?" namespace="/aps/038" var="dowGenFile"/>
...
<!-- form 開始 -->
<s:form theme="simple" namespace="/aps/038" id="mainForm" name="mainForm">
