...
<script language="JavaScript">
	...
	//存放險種明細用
	var insObj = [];
	var detail = $("#reinsInwardDataStr").val();
	...
	function ajaxAction(action){
		...
		if(action == 'findPolicy'){
			...
			if((endorseNo == "" || endorseNo == null) && (policyNo == "" || policyNo == null)){
				clearPolicyForm();
				return;
			}
		...
		if(action == 'findDamageCode'){
			
			var classCode = $("#classcode1").val();
			
			if(classCode == 'F01' || classCode == 'F02'){
				classCode = 'F';
			}
	    	path = contextPath + '/aps/ajax013/findDamageCode.action?classCode=' + classCode;;
		}
		//執行ajax
		$.ajax({
			url : path,
	...
	function clearPolicyForm(){
		...
		insObj = null;
		$('#gridtable tr').remove();
		$('#gridtablePre tr').remove();
		$('#gridtableCon tr').remove();
	...
	function reBuildClaimTable(tableId, type){
		if(insObj != null && insObj.length > 0){
			$('#' + tableId + ' tr').remove();
			...
			for(var i = 0 ; i < insObj.length ; i++){
				...
				+ '<td align="center">' + obj.poname + '</td>'
				+ '<td align="center"><input type="text" name="reinsInwardClaimInsDataList[' + i + '].' + type + 'KindlossO" value="0" size="20" maxlength="20" id="' + type + 'KindlossO' + i + '" onkeyup="onlyNumdot1(this)" onclick="replaceComa1(this)" onblur="addComa1(this),calculate(\'' + type + '\')" ></td>'
				+ '<td align="center"><input type="text" name="reinsInwardClaimInsDataList[' + i + '].' + type + 'KindfeeO" value="0" size="20" maxlength="20" id="' + type + 'KindfeeO' + i + '" onkeyup="onlyNumdot1(this)" onclick="replaceComa1(this)" onblur="addComa1(this),calculate(\'' + type + '\')" ></td>'
				+ '<td align="center"><input type="text" name="reinsInwardClaimInsDataList[' + i + '].' + type + 'KindlossN" value="0" size="20" tabindex="-1" maxlength="20" id="' + type + 'KindlossN' + i + '" onkeyup="onlyNumdot1(this)" onclick="replaceComa1(this)" onblur="addComa1(this),calculate(\'' + type + '\')" ></td>'
				+ '<td align="center"><input type="text" name="reinsInwardClaimInsDataList[' + i + '].' + type + 'KindfeeN" value="0" size="20" tabindex="-1" maxlength="20" id="' + type + 'KindfeeN' + i + '" onkeyup="onlyNumdot1(this)" onclick="replaceComa1(this)" onblur="addComa1(this),calculate(\'' + type + '\')" ></td></tr>');
				if(type == "prepare"){
  		...
  		<table width="870px" cellpadding="0" cellspacing="0" border="0" >
			<tr>
				...
				<td align="left" width="200px" >
					<s:textfield key="reinsInwardClaimData.policyNo" id="policyNo" size="20" maxlength="20"/>
					<input type="hidden" name="reinsInwardMainData.oid" id="oidReinsInwardMainData" />
				</td>
				<td align="right" width="200px">中信產險批單號碼：</td>
				<td align="left"><s:textfield key="reinsInwardClaimData.endorseNo" id="endorseNo" size="20" maxlength="20"/></td>	
			</tr>
		</table>
		<table class="MainBodyColor" id="table3" cellpadding="0" cellspacing="0" width="870px" border="0">
			<tr>
				<td align="right" width="200px" nowrap="nowrap">險種別：</td>
				<td align="left" width="200px">
	...
	<fieldset style="width:800px;">
		...
		<table class="MainBodyColor" id="table3" cellpadding="0" cellspacing="0" width="870px" border="0">
			...
			<tr>
				...
				<td align="left" colspan="3">
					<s:select key="reinsInwardClaimData.damageCode" id="damageCode" theme="simple" list="#{'':''}" />
				</td>				
			</tr>
		</table>
	</fieldset>
	<fieldset style="width:800px;">
		...
		<table class="MainBodyColor" id="table3" cellpadding="0" cellspacing="0" width="870px" border="0">
			...
			<tr>
				...
				<td align="left" ><s:textfield key="reinsInwardClaimData.preExchangeRate" id="preExchangeRate" size="10" maxlength="10" cssClass="numberDot" value="1"/></td>
			</tr>
			<tr>
				<td colspan="4">
					<fieldset style="width:800px;">
	...
	<fieldset style="width:800px;">
		...
		<table class="MainBodyColor" id="table3" cellpadding="0" cellspacing="0" width="870px" border="0">
			...
			<tr>
				...
				<td align="right" width="200px">匯率：</td>
				<td align="left" ><s:textfield key="reinsInwardClaimData.conExchangeRate" id="conExchangeRate" size="10" maxlength="10" cssClass="numberDot" value="1"/></td>
			</tr>
			<tr>
				<td colspan="4">
					<fieldset style="width:800px;">
