...
<%
	...
	String title = "強制險第四次明信片手動執行作業";
	String image = path + "/" + "images/";
	String GAMID = "APS033E0";
	String mDescription = "強制險第四次明信片手動執行作業";
	String nameSpace = "/aps/033";
%>
...
<s:form theme="simple" namespace="/aps/033" id="mainForm" name="mainForm">
...
<table class="MainBodyColor" id="table3" cellpadding="0" cellspacing="0" width="970px">
	<tbody>
		<tr>
			...
			<input type="button" value="執行強制險第四次明信片功能" onclick="javascript:form_submit('excute');"/>
			</td>
		</tr>
	</tbody>
</table>
