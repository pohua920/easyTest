package com.tlg.util.resultType;
...
public class StringResultType extends StrutsResultSupport {
  ...
  private static final long serialVersionUID = 8942347346094676186L;
  private String contentTypeName;
  private String stringName = "success";
  ...
  protected void doExecute(String finalLocation, ActionInvocation invocation) throws Exception {
    ...
    out.println( JsonUtil.getJSONString(result));
    out.flush();
    out.close();
  }
