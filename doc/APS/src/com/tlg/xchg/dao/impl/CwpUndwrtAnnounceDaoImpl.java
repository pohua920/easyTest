...
public class CwpUndwrtAnnounceDaoImpl extends IBatisBaseDaoImpl<CwpUndwrtAnnounce, BigDecimal> implements CwpUndwrtAnnounceDao {
	/* mantis：OTH0093，處理人員：BJ085，需求單編號：OTH0093 傷害險通報查詢、重送介面 start */
	@Override
	public String getNameSpace() {
		return "CwpUndwrtAnnounce";
	}
	...
	@Override
	public List<Map> selectUnsendUndwrtData(Map params) throws Exception {
		List<Map> queryForList = getSqlMapClientTemplate().queryForList(getNameSpace()+".selectUndwrtForUnsend", params);
		return queryForList;
	}
}