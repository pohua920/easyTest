...
public class ChubbProductEndorseDaoImpl extends IBatisBaseDaoImpl<ChubbProductEndorse, BigDecimal> implements ChubbProductEndorseDao {
	@Override
	public String getNameSpace() {
		return "ChubbProductEndorse";
	}
}