...
public class APS038Action extends BaseAction {
	//Service
	...
	public String btnQuery() throws Exception {
		try{
			...
			getPageInfo().getFilter().put("businessnature", "I99065");
			getPageInfo().getFilter().put("newBackFileFlag", "Y");
	...
	/** APS038E0.jsp(主檔)分頁資料中，重新輸入要顯示的頁數  */
	...
	/** APS038E0.jsp，(主檔)分頁資料中，重新選擇下拉式選單中更改每頁所顯示的資料筆數 */
	...
	/** APS038E0.jsp頁面按下主檔批次號碼資料，查詢明細資料 */
	@SuppressWarnings("unchecked")
	...
	private Result dtlQuery() throws Exception {
		...
		if(getDPageInfo().getFilter().get("batchType").equals("01")) {//批次類型 =01 要保書受理檔
			result = firAgtBatchDtlService.findAPS038Detail01ByPageInfo(getDPageInfo());
	...
	/** APS038E1.jsp(明細)分頁資料中，重新輸入要顯示的頁數 */
	...
	/** APS038E1.jsp(明細)分頁資料中，重新選擇下拉式選單中更改每頁所顯示的資料筆數 */
	...
	/** APS038E2.jsp檔案清單資料中，按下檔案名稱，下載檔案 */
