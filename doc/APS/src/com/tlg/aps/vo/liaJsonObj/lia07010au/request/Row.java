...
@JsonPropertyOrder({ "dataserno", "cmptype", "cmpno", "name", "idno",
		"birdate", "sex", "insnom", "insno", "origin", "channel", "prdcode",
		"insclass", "inskind", "insitem", "paytype", "itema", "itemb", "itemc",
		"itemd", "iteme", "itemf", "itemg", "itemh", "itemi", "itemj", "itemk",
		"iteml", "itemm", "itemn", "itemo", "itemp", "itemq", "itemr", "items",
		"valdate", "valtime", "ovrdate", "ovrtime", "prm", "bamttype",
		"prmyears", "con", "condate", "contime", "askname", "askidno",
		"askbirdate", "asktype", "filldate", "broktype" })
public class Row implements Serializable {
	...
	@JsonProperty("askname")
	private String askname;
	@JsonProperty("askidno")
	private String askidno;
	@JsonProperty("askbirdate")
	private String askbirdate;
	@JsonProperty("asktype")
	private String asktype;
	@JsonProperty("filldate")
	private String filldate;
	@JsonProperty("broktype")
	private String broktype;
	private final static long serialVersionUID = 3314200687331961367L;
