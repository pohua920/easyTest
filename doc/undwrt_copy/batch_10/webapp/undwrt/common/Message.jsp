...
<script language="javascript">
  ...
  */
  function goRelevanceTask()
  {
    fm.handType.value = "12";
    fm.editType.value = "deal";
    var url = "/undwrt/undwrtDeal/hebaoTaskDeal.do?actionType=relevanceQueryQta&amp;handType=12&amp;editType=deal";      
    fm.action=url;
    fm.method="post";
    fm.submit();
  }
