...
//            }
            ...
            if(schemaColumn==null){
                log(i18n.messages.field + field.name + i18n.messages.donotDefine);
                continue;
            }
            //跳过可以为空的输入域
    ...
    if (fields.length>0) {
        ...
        {
            message = message + fields[i].desc + i18n.messages.cannotNull +"\n";
        }
...

{
    ...
    var month = parseInt(strValue.substring(5,7),10);
...
//            }
            ...
            if (property=="text"){ //text类型无需校验
                ...
                log(i18n.messages.warn+field.name+i18n.messages.type +property + i18n.messages.contractProvider);
    ...
    if (fields.length>0) {
...

        {
            ...
            if (property=="integer"){
                ...
                typeDesc = i18n.messages.integer;
...
//                typeDesc = typeDesc + "(最大为" + MAX_INTEGER + ",最小为" + MIN_INTEGER + ")";
                ...
                typeDesc = i18n.messages.smallInt;
...
//                typeDesc = typeDesc + "(最大为" + MAX_SMALLINT + ",最小为" + MIN_SMALLINT + ")";
                ...
                typeDesc = i18n.messages.dateFormat + DATE_DELIMITER + "MM" + DATE_DELIMITER + "DD)";

            }

            else if(property.indexOf("datetime")!=-1){

            	typeDesc = i18n.messages.dateTimeFormat + trim(property.substring(8)) + ","+i18n.messages.dateDecollator + DATE_DELIMITER + ")";

            }

            else if(property.indexOf("varchar")!=-1){

                typeDesc = i18n.messages.string;

                typeDesc = typeDesc + i18n.messages.maxLength2 + maxLength ;

                if (minSpace>0) {

                    typeDesc = typeDesc + ","+i18n.messages.minLength + minSpace ;
                ...
                typeDesc = i18n.messages.value;

                typeDesc = typeDesc + i18n.messages.validDigit + maxLength ;

                if (minSpace>0) {

                    typeDesc = typeDesc + ","+i18n.messages.valueIs + minSpace ;
            ...
            message = message + "\"" + field.desc + "\""+i18n.messages.mustBe + typeDesc + "\n";
...
//   }
   ...
   return checkIndiv() && validateRequired(form) && validateType(form);
    ...
    for(i=0;i<document.forms.length;i++){
        ...
        for(j=0;j<document.forms[i].elements.length;j++){
            ...
            if(schemaColumn==null){
                ...
                log(i18n.messages.field + element.name + i18n.messages.donotDefine);
...

{
    ...
    if(schemaColumn==null){
        ...
        log(i18n.messages.field + this.name + i18n.messages.donotDefine);
        ...
        if (dataType=="integer"){
            ...
            log(i18n.messages.warn+this.name+i18n.messages.type +dataType + "."+i18n.messages.donotDeal);
