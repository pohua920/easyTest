...
/**
 * work for the firefox outHTML method. 【让ie和firefox 的多行录入展现一样,增加firefox的outerHTML】
 */
...
function private_deleteRow(field,pageCode,pageDataRowsCount,controlRowsCount){
  var oTBODY = field;
  while (oTBODY!==null&&oTBODY.parentNode!==null&&oTBODY.tagName !== "TBODY"&&oTBODY.parentNode.id!==pageCode)	{
