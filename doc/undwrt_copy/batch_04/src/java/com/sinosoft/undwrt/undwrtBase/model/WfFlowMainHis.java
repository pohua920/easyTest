 ...
 * POJO类WfFlowMainHis.
 */
@Entity(name = "WFFLOWMAINHIS_UNDWRT")
@Table(name = "WFFLOWMAINHIS")
public class WfFlowMainHis implements java.io.Serializable {
	...
	/**
	 * 类WfFlowMainHis的默认构造方法.
	 */
	public WfFlowMainHis() {
	}
