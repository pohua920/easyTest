 ...
 * POJO类PrpCengage
 */
@Entity(name = "PRPCPNOTE_undwrt")
@Table(name = "PRPCPNOTE")
public class PrpCPnote implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 属性id */
	private PrpCPnoteId id;

	/** 属性PRPCMAIN */
	private PrpCPmain prpCPmain;
	...
	public PrpCPnoteId getId() {
		return this.id;
	}

	public void setId(PrpCPnoteId id) {
		this.id = id;
	}

	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "POLICYNO", nullable = false, insertable = false, updatable = false)
	public PrpCPmain getPrpCPmain() {
		return this.prpCPmain;
	}

	public void setPrpCPmain(PrpCPmain prpCPmain) {
		this.prpCPmain = prpCPmain;
	}
