...
<html>
  <head>
    ...
    <title><s:property value="editTitle"/><s:property value="handTitle"/><s:text name="undwrt.PolicyDealContent.task"/></title>
    <!--通用函数-->
  ...
  <body onload=initDangerUnit()>
    ...
    <!--隐含域，数据提交-->
        ...
        <input type="hidden" name="strRiskCode" value=<s:property value="riskCode"/>>
        ...
        <input type="hidden" name="OperatorCode" value="<s:property value="operatorCode"/>">
        <input type="hidden" name="OperatorName" value="<s:property value="operatorName"/>">
        <input type="hidden" name="SubmitDirection" value="">
        <input type="hidden" name="selectNodeNo" value='<s:property value="endNodeNo"/>'>
        <input type="hidden" name="selectNodeName" value='<s:property value="endNodeName"/>'>
        <input type="hidden" name="FlowStatus">
        <input type="hidden" name="Flag" value="1">
        <input type="hidden" name="submitTip">
        <!-- add by zhulei 20060426 增加登陆机构传参myComCode -->
        <input type="hidden" name="myComCode" value="<s:property value="myComCode"/>">
      ...
      <table class="common" cellpadding="5" cellspacing="1" align="center" border="0">
        <tr class=listtitle>
          <td colspan="4"><s:property value="editTitle"/><s:property value="handTitle"/><s:text name="undwrt.PolicyDealContent.task1"/></td>
        </tr>
      <br>
        <tr>
          <td class=title4><s:text name="undwrt.PolicyDealContent.dealDepart"/>：</td>
        <td class=input4><input readonly class=readonly type="text"
			name="DeptCode" value="<s:property value="dealInfo.deptName" />"
			style="width: 185px"></td>
		<td class=title4><s:text name="undwrt.PolicyDealContent.submitTime"/>：</td>
		<td class=input4><input readonly class=readonly type="text"
			name="HandleTime" value="<s:property value="dealInfo.flowInTime" />"
			style="width: 150px"></td>
		<input type="hidden" name="DefaultFlag" value="1">        
        </tr>
     <!-- 危险单位 -->
   		
        <%@include file = "/common/PolicyDangerUnits.jsp"%>
        ...
        <s:if test='iNodeStatus!="4"&&iNodeStatus!="0"'>  
        <tr class=listtitle>
            <td colspan="9" ><s:text name="undwrt.PolicyDealContent.approvalInfo"/></td>
        </tr>
        <tr>
          <td class=title4 ><s:text name="undwrt.PolicyDealContent.approvalPhrase"/>：</td>
          <td class=input4>
            ...
            <select class=common name="notion" onchange="changeNotion1(this)" >
               <option value="">----- <s:text name="undwrt.PolicyDealContent.pleaseChoose"/> -----444</option>
          ...
          <td class=title4><s:text name="undwrt.PolicyDealContent.signApprovaleAdvice"/>：</td>
                    <td class=input4>
...
<s:if test='editType != "query"'>
  ...
  <s:if test='"<s:text name='undwrt.CommonDealContent.orderApprovalPassNode'/>" ==iNodeName'>
  <td class="button">
