...
}};}else{setStyle=function(el,property,val){if(property=='float'){property='cssFloat';}el.style[property]=val;};}
...
if(YAHOO.lang.isString(el)){var c=document.getElementById(el);if(c!=null){return c;} return document.getElementsByName(el);}
