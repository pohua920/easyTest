 ...
 */
@Entity
@Table(name = "PRPQPLANE")
public class PrpQplane implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 属性id */
	private PrpQplaneId id;
	 ...
	 * 属性id的setter方法
	 */
	public void setId(PrpQplaneId id) {
		this.id = id;
	}
