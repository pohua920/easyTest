 ...
 */
@Entity
@Table(name="PRPTCARGOITEM"
)
public class PrpTCargoItem  implements java.io.Serializable {
    private static final long serialVersionUID = 1L;


   
 /** 属性id */
     private PrpTCargoItemId id;
 ...
 /** 属性短信转存后是否删除标记 */
    ...
    public PrpTCargoItemId getId() {
        return this.id;
    }
    /**
     * 属性id的setter方法
     */
    public void setId(PrpTCargoItemId id) {
        this.id = id;
    }
    /**
     * 属性货物大类代码的getter方法
