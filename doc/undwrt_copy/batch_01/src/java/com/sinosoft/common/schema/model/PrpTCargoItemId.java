 ...
 */
@Embeddable
public class PrpTCargoItemId implements java.io.Serializable {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof PrpTCargoItemId)) {
            return false;
        }
        PrpTCargoItemId castOther = (PrpTCargoItemId) other;
