 ...
 */
@Entity
@Table(name="PRPQAIRLINE"
)
public class PrpQairline  implements java.io.Serializable {
    private static final long serialVersionUID = 1L;


   
 /** 属性id */
     private PrpQairlineId id; 
 ...
 /** 属性预留字段2*/ 
	 ...
	 * 属性id的setter方法
	 */
	public void setId(PrpQairlineId id) {
		this.id = id;
	}
	/**
