 ...
 */
@Entity
@Table(name = "PRPTSCHEME")
public class PrpTscheme implements java.io.Serializable {
	private static final long serialVersionUID = 1L;
	/** 属性id */
	private PrpTschemeId id;
	...
	public PrpTschemeId getId() {
		return this.id;
	}

	public void setId(PrpTschemeId id) {
		this.id = id;
	}
