 ...
 */
@Entity
@Table(name = "PRPQPLANEDRIVER")
public class PrpQplaneDriver implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 属性id */
	private PrpQplaneDriverId id;
	...
	/**
	 * 类prpQplaneDriver的默认构造方法
	 */
	public PrpQplaneDriver() {
	}
	...
	public PrpQplaneDriverId getId() {
		return this.id;
	}
	 ...
	 * 属性id的setter方法
	 */
	public void setId(PrpQplaneDriverId id) {
		this.id = id;
	}
