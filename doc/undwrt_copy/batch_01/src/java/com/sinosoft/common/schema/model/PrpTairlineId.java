 ...
 */
@Embeddable
public class PrpTairlineId  implements java.io.Serializable {
 ...
 /** 属性序號 */
     ...
     /**
      * 类PrpTairlineId的默认构造方法
      */
	public PrpTairlineId() {
	}
	...
	public boolean equals(Object other) {
        if ( (this == other ) ) {return true;}
		 ...
		 if ( !(other instanceof PrpTairlineId) ) {return false;}
		 PrpTairlineId castOther = ( PrpTairlineId ) other; 
