 ...
 */
@Entity
@Table(name = "PRPQREINFO")
public class PrpQreinfo implements java.io.Serializable {
	private static final long serialVersionUID = 1L;
	/** 属性id */
	private PrpQreinfoId id;
	...
	public PrpQreinfoId getId() {
		return this.id;
	}

	public void setId(PrpQreinfoId id) {
		this.id = id;
	}
