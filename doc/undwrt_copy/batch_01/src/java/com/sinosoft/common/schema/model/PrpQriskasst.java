 ...
 */
@Entity
@Table(name = "PRPQRISKASST")
public class PrpQriskasst implements java.io.Serializable {
	private static final long serialVersionUID = 1L;
	/** 属性id */
	private PrpQriskasstId id;
	...
	public PrpQriskasstId getId() {
		return this.id;
	}

	public void setId(PrpQriskasstId id) {
		this.id = id;
	}
