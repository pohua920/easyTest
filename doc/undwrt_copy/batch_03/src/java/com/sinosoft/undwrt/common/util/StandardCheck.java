...
/**
 * The Class StandardCheck.
 */
public class StandardCheck {


    /** 通过判处异常来将结果展示给用户 add 2005-8-29 by qinyongli. */
    //static Logger logger = Logger.getLogger(UIUndwrtTaskDealFacade.class);
    
    private static String POLICY_LOSE = "03";//保单遗失
    ...
    // added by gengxiaobo begin 20080619 添加抛出异常函数。
    /**
    ...
    // added by gengxiaobo end 20080619 添加抛出异常函数。   
...
//      //add by zhouhui 20090625 end 批改保险期限时，短期费率标志为3时，只能1c级以上才能核过
    ...
    //核赔条件判断
//  public boolean checkHepei(String iBusinessNo,
//          HePeiConditionDto carHepeiConditionDto, DBManager dbManager,
//          String BusinessType) throws Exception {
//
//      try{
//      BLBusinessHepeiData blBusinessData = new BLBusinessHepeiData(
//              iBusinessNo, dbManager, BusinessType);
//      if (BusinessType.equals("precompensate")) {
//          if (carHepeiConditionDto.getSumPrepaid() != 0
//                  && carHepeiConditionDto.getSumPrepaid() < blBusinessData
//                          .getSumPrepaid()) {
//              String title = "预赔金额不符合条件!";
//              String standardData = "小于等于"
//                      + NumberFormat.getInstance().format(
//                              carHepeiConditionDto.getSumPrepaid())
//                      + "元";
//              String businessData = NumberFormat.getInstance().format(
//                      blBusinessData.getSumPrepaid())
//                      + "元";
//              this.throwException(title, standardData, businessData);
//          }
//          return true;
//      } else {
//          if (carHepeiConditionDto.getManDamageClaim() != 0.01
//                  && carHepeiConditionDto.getManDamageClaim() < blBusinessData
//                          .getPersonLossSumRealpay()) {
//              String title = "人伤预赔不符合条件!";
//              String standardData = "小于等于"
//                      + NumberFormat.getInstance().format(
//                              carHepeiConditionDto.getManDamageClaim()) + "元";
//              String businessData = NumberFormat.getInstance().format(
//                      blBusinessData.getPersonLossSumRealpay())
//                      + "元";
//              this.throwException(title, standardData, businessData);
//          } else if (carHepeiConditionDto.getPrepayProportion() != 0.01
//                  && carHepeiConditionDto.getPrepayProportion() < blBusinessData
//                          .getPrepayProportion()) {
//              String title = "人伤预赔比例不符合条件!";
//              String standardData = "小于等于"
//                      + NumberFormat.getInstance()
//                              .format(
//                                      carHepeiConditionDto
//                                              .getPrepayProportion())
//                      + "元";
//              String businessData = NumberFormat.getInstance().format(
//                      blBusinessData.getPrepayProportion())
//                      + "元";
//              this.throwException(title, standardData, businessData);
//          } else if (carHepeiConditionDto.getSumRealPay() != 0.01
//                  && carHepeiConditionDto.getSumRealPay() < blBusinessData
//                          .getSumRealPay()) {
//              String title = "费用金额不符合条件!";
//              String standardData = "小于等于"
//                      + NumberFormat.getInstance().format(
//                              carHepeiConditionDto.getSumRealPay()) + "元";
//              String businessData = NumberFormat.getInstance().format(
//                      blBusinessData.getSumRealPay())
//                      + "元";
//              this.throwException(title, standardData, businessData);
//          } else if (carHepeiConditionDto.getSumpaid() != 0.01
//                  && carHepeiConditionDto.getSumpaid() < blBusinessData
//                          .getSumpaid()) {
//              String title = "核赔金额不符合条件!";
//              String standardData = "小于等于"
//                      + NumberFormat.getInstance().format(
//                              carHepeiConditionDto.getSumpaid())
//                      + "元";
//              String businessData = NumberFormat.getInstance().format(
//                      blBusinessData.getSumpaid())
//                      + "元";
//              this.throwException(title, standardData, businessData);
//          } else if (carHepeiConditionDto.getSumpaid() != 0.01
//                  && carHepeiConditionDto.getSumpaid() < blBusinessData
//                          .getCarDamageAmount()) {
//              String title = "车损赔款不符合条件!";
//              String standardData = "小于等于"
//                      + NumberFormat.getInstance().format(
//                              carHepeiConditionDto.getSumpaid())
//                      + "元";
//              String businessData = NumberFormat.getInstance().format(
//                      blBusinessData.getCarDamageAmount())
//                      + "元";
//              this.throwException(title, standardData, businessData);
//          } else if (carHepeiConditionDto.getCarStealAmount() != 0.01
//                  && carHepeiConditionDto.getCarStealAmount() < blBusinessData
//                          .getCarStealAmount()) {
//              String title = "全车盗抢险赔款不符合条件!";
//              String standardData = "小于等于"
//                      + NumberFormat.getInstance().format(
//                              carHepeiConditionDto.getCarStealAmount())
//                      + "元";
//              String businessData = NumberFormat.getInstance().format(
//                      blBusinessData.getCarStealAmount())
//                      + "元";
//              this.throwException(title, standardData, businessData);
//          } else if (carHepeiConditionDto.getCarSelf_ignite() != 0.01
//                  && carHepeiConditionDto.getCarSelf_ignite() < blBusinessData
//                          .getCarSelf_ignite()) {
//              String title = "自燃赔款不符合条件!";
//              String standardData = "小于等于"
//                      + NumberFormat.getInstance().format(
//                              carHepeiConditionDto.getCarSelf_ignite()) + "元";
//              String businessData = NumberFormat.getInstance().format(
//                      blBusinessData.getCarSelf_ignite())
//                      + "元";
//              this.throwException(title, standardData, businessData);
//          } else if (blBusinessData.getBackOperation().equals("Y")
//                  && carHepeiConditionDto.getBackOperation().equals("N")) {
//              String title = "倒签单不符合条件!";
//              String standardData = "没有审核倒签单权限";
//              String businessData = "此赔案原保单为倒签单";
//              this.throwException(title, standardData, businessData);
//          } else {
//              // 判断是否是特殊赔案
//              boolean isSpecial = false;
//              String registNo = "";
//              double thisSumPaid = 0;
//              String strC = "select * from Prplcompensate where compensateno = '"
//                      + iBusinessNo + "'";
//              ResultSet rsC = dbManager.executeQuery(strC);
//              if (rsC.next()) {
//                  thisSumPaid = rsC.getDouble("SUMTHISPAID");
//                  // registNo = rsC.getString("registno");
//                  // //Prplcompensate无此字段！
//              }
//              if (!registNo.equals("")) { // 判断是否存在立案号
//                  String strCheck = "select * from prplcheck where claimtype in ('1','2','3','9') and registno = '"
//                          + registNo + "'";
//                  ResultSet rsCheck = dbManager.executeQuery(strCheck);
//                  if (rsCheck.next()) {
//                      isSpecial = true;
//                  } else {
//                      String StrReg = "select * from prplregist where claimtype in ('1','2','3','9') and registno = '"
//                              + registNo + "'";
//                      ResultSet rsReg = dbManager.executeQuery(StrReg);
//                      if (rsReg.next()) {
//                          isSpecial = true;
//                      }
//                  }
//              }
//              // 判断如果是特殊赔案，判断赔款金额是否符合条件
//              if (isSpecial) {
//                  if (carHepeiConditionDto.getSpecialClaim() != 0.01
//                          && carHepeiConditionDto.getSpecialClaim() < blBusinessData
//                                  .getSpecialClaim()) {
//                      String title = "特殊赔案金额不符合条件!";
//                      String standardData = "小于等于"
//                              + NumberFormat.getInstance().format(
//                                      carHepeiConditionDto.getSpecialClaim())
//                              + "元";
//                      String businessData = NumberFormat.getInstance()
//                              .format(blBusinessData.getSpecialClaim())
//                              + "元";
//                      this.throwException(title, standardData, businessData);
//                  }
//              }
//          }
//          // add by zhulei begin 20060524 保费未实收允许核赔金额权限
//          if (blBusinessData.getRealPayFlag() == -1
//                  && carHepeiConditionDto.getUnPayClaim() != 0
//                  && blBusinessData.getUnPayClaim() > carHepeiConditionDto
//                          .getUnPayClaim()) {
//              String title = "保费未实收允许核赔金额不符合条件!";
//              String standardData = "小于等于"
//                      + NumberFormat.getInstance().format(
//                              carHepeiConditionDto.getUnPayClaim()) + "元";
//              String businessData = NumberFormat.getInstance().format(
//                      blBusinessData.getUnPayClaim())
//                      + "元";
//              this.throwException(title, standardData, businessData);
//          }
//          // add by zhulei end 20051223 保费未实收允许核赔金额权限
//          // add by zhulei begin 20051223 保费未实收权限
//          // if(blBusinessData.getRealPayFlag()==-1 &&
//          // carHepeiConditionDto.getRealPayFlag()==0){
//          // String title = "是否实收不符合条件!";
//          // String standardData = "没有审核未实收保费赔案权限";
//          // String businessData = "此赔案原保单未实收保费";
//          // this.throwException(title,standardData,businessData);
//          // }
//          // add by zhulei end 20051223 保费未实收权限
//      }}
//      catch (Exception e) {
//          return false;
//          // logger.warn("异常，判断自动核保失败，进如手工提交流程...");
//      }
//
//      return true;        
//  }
//add by zhangruifeng  20071111 begin reason: 增加商业险根据条件自动核保功能
/**
	 * Check auto hebao.
	 * 
	 * @param iBusinessNo
	 ...
	 *             the exception
	 */
    public boolean checkAutoHebao(String iBusinessNo,
        HeBaoConditionVo heBaoConditionDto, DBManager dbManager,
        String iBusinessType,String autoUnderWriteFlag) throws Exception {
//        BLBusinessData blBusinessData = null;
//        if (iBusinessType.equals("T")) {// 判断业务类型
//            blBusinessData = new BLBusinessAutoProposalData(iBusinessNo, dbManager); 
...
//        }
//        //关于车损险保额问题
//        if(heBaoConditionDto.getAmountA()>-1&&(heBaoConditionDto.getAmountA() < blBusinessData
//                .getAmountA())) {
//               return false;
//        }
//        //三者险保额问题
//        if(heBaoConditionDto.getAmountB()>-1&&(heBaoConditionDto.getAmountB() < blBusinessData
//                .getAmountB())) {
//               return false;
//        }
//       if(heBaoConditionDto.getTonCount() <= blBusinessData.getTonCount()){//货车根据吨位数不同自动核保条件不同
//            if(heBaoConditionDto.getAmountH0UppA()>-1&&(heBaoConditionDto.getAmountH0UppA() < blBusinessData
//                    .getAmountH0UppA())) {
//              //n吨以上货车车损险保额 ，其中n是在平台系统中配置的TonCount因子
//                   return false;
//            }
//            if(heBaoConditionDto.getAmountH0Upp()>-1&&(heBaoConditionDto.getAmountH0Upp() < blBusinessData
//                    .getAmountH0Upp())) {
//                //n吨以上货车三者险保额 ，其中n是在平台系统中配置的TonCount因子
//                   return false;
//            }
//       }else{
//            if(heBaoConditionDto.getAmountH0LowA()>-1&&(heBaoConditionDto.getAmountH0LowA() < blBusinessData
//                    .getAmountH0LowA())) {
//            //n吨以下货车车损险保额 ，其中n是在平台系统中配置的TonCount因子
//                   return false;
//            }
//            if(heBaoConditionDto.getAmountH0Low()>-1&&(heBaoConditionDto.getAmountH0Low() < blBusinessData
//                    .getAmountH0Low())) {
//                //n吨以下货车三者险保额 ，其中n是在平台系统中配置的TonCount因子
//                   return false;
//            }
//       }
//        //车上人员责任险
//        if(heBaoConditionDto.getAmountD1()>-1&&(heBaoConditionDto.getAmountD1() < blBusinessData
//                .getAmountD11())) {
//               return false;
//        }
//        if(heBaoConditionDto.getAmountD1()>-1&&(heBaoConditionDto.getAmountD1() < blBusinessData
...
//        }
//        //新增设备损失保险金额
//        if(heBaoConditionDto.getAmountNX()>-1&&(heBaoConditionDto.getAmountNX() < blBusinessData
//                .getAmountNX())) {
//               return false;
//        }
//        if(heBaoConditionDto.getAmountNY()>-1&&(heBaoConditionDto.getAmountNY() < blBusinessData
//                .getAmountNY())) {
//               return false;
//        }
//        //车身划痕损失保险金额 需要配合年限与车辆种类使用
//        if(heBaoConditionDto.getAmountL()>-1&&(heBaoConditionDto.getAmountL() < blBusinessData
//                .getAmountL())||(blBusinessData.getUseYears()>heBaoConditionDto
//                .getUseYearsL()&&blBusinessData.getAmountL()>0&&heBaoConditionDto.getAmountL()>-1)||
//                (heBaoConditionDto.getCarKindCodeL().indexOf(blBusinessData.getCarKindCode())<0)&&blBusinessData
//                .getAmountL()>0&&blBusinessData.getAmountL()>0&&heBaoConditionDto.getAmountL()>-1) {
//               return false;
//        }
//        if(blBusinessData.getLicenseNo().indexOf(heBaoConditionDto.getLicenseNoInClude())>-1) {
//               return false;
//        }
//        if(blBusinessData.getAppliLinkerName().indexOf(heBaoConditionDto.getAppliLinkerName())>-1) {
//               return false;
//        }
        return true;
     }
//add by zhangruifeng  20071111 end 
    //added by gengxiaobo begin 20080619 校验重复投保
    /**
 * Check.
 * 
 * @param strPrposalNo
 ...
 *             the exception
 */
public String check(String strPrposalNo) throws SQLException, Exception {
        String strSql = "";
        String strEngineNo = ""; // 发动机号
        String strFrameNo = ""; // 车架号
        String strVINNo = ""; // vin码
        String strStartDate = ""; // 起保日期
        String strEndDate = "";// 终保日期
        String strClauseType = ""; // 条款类别
        String strOtherNature = "";
        String strOtherNature7 = ""; // 新车标志位
        String strLicenseColorCode = ""; // 号牌底色
        String strLicenseNo = ""; // 车牌号码
        String strCarKindCode = ""; // 车辆种类
        String strRiskCode = "";        
        //int intCount = 0;
        
        String strReturn = "false";
        String strRtnPolicyNo = "";
        String strRtnComCode = "";
        String strRtnOperatorCode = "";
        String strRtnInputDate = "";
        String strRtnInsuerdName = "";  
        
        BLPrpTitemCar blPrpTitemCar = new BLPrpTitemCar();
        BLPrpTmain blPrpTmain = new BLPrpTmain();       
        blPrpTitemCar.getData(strPrposalNo);
        blPrpTmain.getData(strPrposalNo);
        if(blPrpTitemCar.getSize()>0){
            strEngineNo = blPrpTitemCar.getArr(0).getEngineNo();
            strFrameNo = blPrpTitemCar.getArr(0).getFrameNo();
            strVINNo = blPrpTitemCar.getArr(0).getVINNo();
            strClauseType = blPrpTitemCar.getArr(0).getClauseType();
            strOtherNature = blPrpTitemCar.getArr(0).getOtherNature();
            strOtherNature7 = strOtherNature.substring(6, 7); // 新车标志位
            strLicenseColorCode = blPrpTitemCar.getArr(0)
                    .getLicenseColorCode(); // 号牌底色
            strLicenseNo = blPrpTitemCar.getArr(0).getLicenseNo(); // 车牌号码
            strCarKindCode = blPrpTitemCar.getArr(0).getCarKindCode(); // 车辆种类          
            strRiskCode = blPrpTitemCar.getArr(0).getRiskCode();            
        }       
        if(blPrpTmain.getSize()>0){
            strStartDate = blPrpTmain.getArr(0).getStartDate();
            strEndDate = blPrpTmain.getArr(0).getEndDate();         
        }
        if (strOtherNature7.equals("0")) {
            strSql = "select b.PolicyNo,b.ComCode,b.OperatorCode,b.InputDate,b.InsuredName from PrpCitemCar a, PrpCmain b  where a.PolicyNo=b.PolicyNo"
                    + " and a.EngineNo='"
                    + strEngineNo
                    + "' and a.riskcode='"
                    + strRiskCode + "' ";
            if (strFrameNo == null || strFrameNo.equals("")) {
                strSql = strSql + " and a.VINNo='" + strVINNo + "'";
            }
            else {
                strSql = strSql + " and a.FrameNo='" + strFrameNo + "'";
            }
            strSql = strSql
                    + " and ((b.EndDate >='"
                    + strStartDate
                    ...
                    + strEndDate
                    + "'))"
                    + " and substr(b.OthFlag,3,1)!='1' and substr(b.OthFlag,4,1)!='1' "
                    + " and a.ClauseType ='" + strClauseType + "' ";
            DbPool dbpool = new DbPool();
            dbpool.open(SysConfig.getProperty("DDCCDATASOURCE"));
            try {
                ResultSet resultSet = dbpool.query(strSql);
                //intCount = resultSet.getRow();
                if (resultSet.next()) {
                    strRtnPolicyNo = resultSet.getString("PolicyNo");
                    strRtnComCode = resultSet.getString("ComCode");
                    strRtnOperatorCode = resultSet.getString("OperatorCode");
                    strRtnInputDate = resultSet.getString("InputDate");
                    strRtnInsuerdName = resultSet.getString("InsuredName"); 
                    strReturn = "已存在保单："
                          +strRtnPolicyNo
                          +"，录单机构："
                          +strRtnComCode
        ...
        else if (strOtherNature7.equals("1")) {
            strSql = "select b.PolicyNo,b.ComCode,b.OperatorCode,b.InputDate,b.InsuredName from PrpCitemCar a, PrpCmain b  where a.PolicyNo=b.PolicyNo"
                    + " and a.LicenseNo='"
                    + strLicenseNo
                    + "' and a.riskcode='"
                    + strRiskCode
                    + "' and a.CarKindCode='" + strCarKindCode + "' ";
    
            if (strLicenseColorCode != "" && strLicenseColorCode != null) {
                strSql = strSql + "and a.LicenseColorCode='"
                        + strLicenseColorCode + "' ";
            }
    ...
    //added by gengxiaobo end 20080619 校验重复投保
