...
<html lang="zh">
<head>
<title><s:text name="guarantee.sponsorshipQuery" /></title>
<!-- 担保查询 -->
...
<body onload="">
	<form name="fm" action="/claim/guarantee.do?actionType=searchShow" method="post">
		...
		<table>
			...
			<logic:iterate id="prpLclaimDto" name="claimList">
				<tr class=listodd>
					...
					<td align="center">
						<a href="/claim/guarantee.do?actionType=show&prpLGuaranteeClaimNo=<bean:write name='prpLclaimDto' property="claimNo"/>"><bean:write name='prpLclaimDto' property="claimNo" /> </a>
					</td>
					<td align="center">
