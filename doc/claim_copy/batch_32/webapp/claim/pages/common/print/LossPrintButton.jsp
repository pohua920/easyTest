...
<p>
  <table cellpadding="0" cellspacing="0" width="80%" style="display:">
    <tr>
      ...
      <td class=button style="width:25%" align="center">
        <input class="button" type="button"  name="buttonPrintAdd" value="配件清单列印"  onclick="javascript:printPageAdd();">
      </td>
       <td class=button style="width:25%" align="center">
        <input class="button" type="button"  name="buttonPrintAdd" value="修理项目清单列印"  onclick="javascript:printPageAdd1();">
      </td>
