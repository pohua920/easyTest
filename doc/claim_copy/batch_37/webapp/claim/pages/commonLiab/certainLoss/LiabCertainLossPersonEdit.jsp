    ...
    <span style="display:" id="SpanPerson" cellspacing="1" cellpadding="0">  
          ...
          <tbody>       
            <tr>   
              <td class="input">  
                ...
                <input type="input" name="prpLpersonKindCode" class="codecode" style="width:40px"
                      ondblclick= "code_CodeSelect(this,'PolicyKindCode');"
                      onkeyup= "code_CodeSelect(this,'PolicyKindCode');">         
              </td>
              <td class="input">   
                  <input type="input" name="prpLpersonKindName" class="codename" style="width:100px"
              ...
              <td class="input">  
                <input type="input" name="prpLpersonItemCode" class="codecode" style="width:40px"
                      ondblclick= "code_CodeSelect(this,'PolicyKindCode');"
                      onkeyup= "code_CodeSelect(this,'PolicyKindCode');">         
                  <input type="input" name="prpLpersonItemName" class="codename" style="width:80px"
			             ondblclick="code_CodeSelect(this, 'PolicyKindCode','-1','always','none','post');"
			             onkeyup= "code_CodeSelect(this, 'PolicyKindCode','-1','always','none','post');">         
              </td> 
                            
              <td class="input">  
                <input type="input" name="prpLpersonFeeTypeCode" class="codecode" style="width:40px"
                      ondblclick= "code_CodeSelect(this,'FeeTypeCode');"
                      onkeyup= "code_CodeSelect(this,'FeeTypeCode');">         
                  <input type="input" name="prpLpersonFeeTypeName" class="codename" style="width:60px"
              ...
              <td class="input">  
                <input type="input" name="prpLpersonCurrency" class="codecode" style="width:30px"
                      ondblclick= "code_CodeSelect(this,'Currency');"
                      onkeyup= "code_CodeSelect(this,'Currency');">         
                  <input type="input" name="prpLpersonCurrencyName" class="codename" style="width:60px"
      ...
      <!--表示显示多行的-->    
        <tr>
          <td class="subformtitle" colspan="4" align="center">
            <s:text name="commonAcci.certainLoss.personnelShallDamage" /><%--人员核定损清单--%>
          </td>
        </tr>
        <tr>
                     ...
                     <td class="subformtitle">
                       <table  cellpadding="0" cellspacing="1" class="common">
                         ...
                         <tr>
                           ...
                           <td class="title" style="width:15%"><s:text name="db.prpLperson.personAge" />:</td><%--年龄--%>
                           <td class="input" style="width:35%">
                         ...
                         <tr>   
                           <td class="title" style="width:15%"><s:text name="commonAcci.certainLoss.currency" />:</td><%--折合币别--%>
                           <td class="input" style="width:35%">
                           ...
                           <td class="title" style="width:15%"><s:text name="compensate.compel.lossTotal" />:</td><%--损失合计--%>
                           <td class="input" style="width:35%">
                             <input name="prpLpersonSumDefLossSum" class="readonly" readonly style="width:150px"> 
                            </td>
                         </tr>  
                         <tr>
                           <td class="title" style="width:15%"><s:text name="db.prpLcomponent.remark" />:</td><%--备注--%>
                           ...
                           <td class="input" align="center" style="width:35%"><input type="button" name="button_Person_Collect"  class="bigbutton" value="损失合计" onclick="alert('损失合计');"></td>
                         </tr>  
                        <tr> 
                        <td colspan="4">
                            ...
                            <thead>
                              <tr>
                                <td class="subformtitle" colspan=11>
                                  <s:text name="certainLoss.costInformation" /> <font color="#FF0000">*</font><%--人员伤亡费用清单信息--%>
                                </td> 
                              </tr>
                              <tr> 
                                <td class="centertitle" style="width:7%"><s:text name="regist.prpLregist.kindCode" /></td><%--险别代码--%>
                                <td class="centertitle" style="width:17%"><s:text name="regist.prpLregist.kindName" /></td><%--险别名称--%>
                                <td class="centertitle" style="width:20%"><s:text name="commonAcci.certainLoss.classificateResponsib" /></td><%--责任分类--%>
                                <td class="centertitle" style="width:18%"><s:text name="commonAcci.certainLoss.responsibilityDetail" /></td><%--责任明细--%>
                                <td class="centertitle" style="width:15%"><s:text name="db.prpLperson.currency" /></td><%--币别--%>
                                <td class="centertitle" style="width:10%"><s:text name="certainLoss.prpLcheck.prpLcheckEstimateLoss2" /></td><%--报损金额--%>
                                <td class="centertitle" style="width:10%"><s:text name="compensate.amountNucDamage" /></td><%--核损金额--%>
                                <td class="centertitle" style="width:3%">&nbsp;</td>                                        
                              </tr>  
                            </thead>                            
                            <tfoot>
                              <tr>
                                <td class="title" colspan="7" style="width:97%"><s:text name="prompt.certainLoss.addRemoveIformation" /></td><%--(按"+"号键增加人员伤亡费用信息，按"-"号键删除信息)--%>
     ...
     <span  id="spanPerson">
       ...
       <table id="person" class="common" align="center" cellspacing="1" cellpadding="0">
         <thead>
           <tr>
             <td class="title" style="width:4%"><s:text name="regist.prpLregist.serialNo" /></td><%--序号--%>
                       ...
                       <table  cellpadding="0" cellspacing="1" class="common">
                         ...
                         <tr>
                           ...
                           <select name="prpLpersonPersonSex" class="three" style="width:110px"  value="<%= PrpLpersonDto1.getPersonSex() %>">   
                               <option value="1" <%= PrpLpersonDto1.getPersonSex().trim().equals("1")? "selected":"" %>><s:text name="certainLoss.male" /></option><%--男--%>
                               <option value="2" <%= PrpLpersonDto1.getPersonSex().trim().equals("2")? "selected":"" %>><s:text name="certainLoss.female" /></option><%--女--%>
                            </select>   
                           </td>
                           <td class="title" style="width:15%"><s:text name="db.prpLperson.personAge" />:</td><%--年龄--%>
                           <td class="input" style="width:35%">
                         ...
                         <tr>
                           ...
                           <td class="input" align="center" style="width:35%"><input type="button" name="button_Person_Collect"   class="bigbutton" value="<s:text name='button.lossTotal.value' />" onclick="alert('损失合计');"></td>  <%--损失合计--%>
                        </tr>  
                        <tr>  
                        <td colspan="4">
                          <span  id="spanPersonFeeLoss" >
...
%>                   
            <tr>   
              <td class="input">  
                ...
                <input type="input" name="prpLpersonKindCode" class="codecode" style="width:40px" value="<%= PrpLpersonDto2.getKindCode() %>"
                      ondblclick= "code_CodeSelect(this,'PolicyKindCode');"
                      onkeyup= "code_CodeSelect(this,'PolicyKindCode');">         
              </td>
              <td class="input">   
              ...
              <td class="input">  
                <input type="input" name="prpLpersonItemCode" class="codecode" style="width:40px" value="<%= PrpLpersonDto2.getItemCode() %>"
                      ondblclick= "code_CodeSelect(this,'PolicyKindCode');"
                      onkeyup= "code_CodeSelect(this,'PolicyKindCode');">         
              ...
              <td class="input">  
                <input type="input" name="prpLpersonFeeTypeCode" class="codecode" style="width:40px" value="<%= PrpLpersonDto2.getFeeTypeCode() %>"
                      ondblclick= "code_CodeSelect(this,'FeeTypeCode');"
                      onkeyup= "code_CodeSelect(this,'FeeTypeCode');">         
              ...
              <td class="input">  
                <input type="input" name="prpLpersonCurrency" class="codecode" style="width:30px" value="<%= PrpLpersonDto2.getCurrency() %>"
                      ondblclick= "code_CodeSelect(this,'Currency');"
                      onkeyup= "code_CodeSelect(this,'Currency');">         
...
%>                    
            <tr>   
              ...
              <td class="input">  
                <input type="input" name="prpLpersonFeeTypeCode" class="codecode" style="width:60px" value="<%= PrpLpersonDto2.getFeeTypeCode() %>"
                      ondblclick= "code_CodeSelect(this,'FeeTypeCode');"
                      onkeyup= "code_CodeSelect(this,'FeeTypeCode');">         
              </td>
              <td class="input">   
