...
--%> 
  <table border="0" align="center" cellpadding="0" cellspacing="0" class="common">
    <tr>
      <td width="30%">
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr> 
            ...
            <td class="formtitle"><s:text name="certainLoss.lossOfRegistration" /><%--定损登记--%></td>
            <td width ="11"><img src="/claim/images/bgBarRight.gif" width="11" height="19"></td>
          </tr>
        </table> 
      </td>
      <td><input type="button" name="message" value="<s:text name='button.composeMessage.value' />" class="bigbutton" onclick="openWinSave()"></td><%--撰写留言--%>
        <td><input type="button" name="messageView" value="<s:text name='button.viewMessage.value' />  class="bigbutton" onclick="openWinQuery()"></td><%--查看留言--%>
      ...
      <s:text name="scheduleObject.note3" /><%--为双击选择项--%>。</font>
      </td>
    </tr>
  </table> 
  ...
  <table border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#2D8EE1" class="title" style="width:100%">
    <tr>
      <td class="title" colspan="4" style="width:100%"><s:text name="certainLoss.lossOfRegistration" /><%--定损登记--%>
    ...
    <tr>
      <td class="title" style="width:15%"><s:text name="prpLregist.registNo " />:</td><%--报案号--%>
      ...
      <td class="title" style="width:15%" style="valign:bottom" ><s:text name="db.view_larrearage.policyNo" />：</td><%--保单号--%>
      <td class="input" style="width:35%">
