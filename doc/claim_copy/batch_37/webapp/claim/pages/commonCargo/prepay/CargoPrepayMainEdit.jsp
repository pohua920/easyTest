...
<%@ include file="/common/taglibs.jsp"%>
    ...
    <tr>
       ...
       <td><input type="button" name="message" value="<s:text name='button.claimsProcessingRecords.value'/>" class="bigbutton" onclick="openwinSave()"></td><td width="70%" align="right"><font color="#666666">　<s:text name="scheduleObject.note1"/>“<font color="#FF0000">*</font>”<s:text name="scheduleObject.note2"/>，“<img src="${ctx}/images/bgDoubleClick2.gif" width="13" height="13" align="absbottom">”<%-- 赔案处理记录 --%><%-- 注: --%><%-- 为必选项 --%>
...
<table  border="0" align="center" cellpadding="4" cellspacing="1"  class="title" width="100%">
  <tr> 
    <td class="title" colspan="4" ><s:text name="prepay.paymentRegistration"/><%-- 预付赔款登记 --%>
      ...
      <!--modify by wangliguang 2008-05-25 begin -->
