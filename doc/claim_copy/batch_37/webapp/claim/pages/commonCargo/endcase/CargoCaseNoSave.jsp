...
<body  onload="initPage();">
      ...
      <td width="184" height="26" valign="bottom">
        <table width="184" height="19" border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="161" class="formtitle"><s:text name="commonAcci.endcase.generateFinalNo"/></td> <%-- 生成结案号 --%>
  ...
  <table border="0" align="center" cellpadding="0" cellspacing="0" class="common">
    <tr>
      <td class="centertitle"><s:text name="certainLoss.claims"/>：</td> <%-- 赔案号 --%>
      <td class="centertitle">${prpLcaseNo.claimNo}</td>
      <td class="centertitle"><s:text name="db.prpLlawsuit.policyNo"/>：</td> <%-- 保单号 --%>
  ...
  <table  class="common" cellpadding="4" cellspacing="1">
     <tr>
        <td class="centertitle" colspan="3" align="left"><s:text name="endcase.claimsInformation"/></td><%--  赔案信息  --%>
     </tr>
     <tr>
        <td class="centertitle"><s:text name="db.prpLpersonloss.compensateNo"/></td><%--赔款计算书号  --%>
        <td class="centertitle"><s:text name="db.prpLcompensate.caseNo"/></td> <%-- 结案号 --%>
        <td class="centertitle"><s:text name="compensate.compel.paymentAmount"/></td><%-- 赔款金额 --%>
     </tr>
  ...
  <table class="common" align="center">
    <tr>
      <td class="button" colspan="2">
        <input type="button" name="buttonSave" value="<s:text name='button.save.value'/>  " class="button" onclick="submitForm();"> <%--  保 存--%>
      </td>
      <td class="button" colspan="2">
        <input type="button" name="buttonCancel" class="button" value=" <s:text name='button.cancel.value'/> "><%-- 取 消 --%>
      </td>
    </tr>
  </table>
  </form>
