	...
	<tr class=mline>
		<td class="subformtitle" colspan="4" style="text-align: left">
			<img style="cursor: hand;" src="/claim/images/butCollapseBlue.gif"
				name="LimitImg" onclick="showPage(this,spanLimit)">
			...
			<span style="display: none">
						...
						<tr>
							<td>
								<input class=readonly readonly
									style='display: none; width: 12px' name=Limit_Flag>
								<input class=readonly readonly name=LimitGrade>
							</td>
							<td>
								<input class=readonly readonly name=LimitNo>
							</td>
							<td>
								<input class=readonly readonly name=LimitType>
							</td>
							<td>
								<input class=readonly readonly name=PrpLimitCurrency>
							</td>
							<td>
								<input class=readonly readonly name=LimitFee>
							</td>
						</tr>
					</tbody>
				</table>
				...
				<table class="sub" style='width: 100%' id="Limit">
					...
					<tbody>
						<c:if test="${not empty prpClimitList}">
							<c:forEach var="limitList" items="${prpClimitList}" >
								<tr class=oddrow>
									<td class="centertitle">
										${limitList.limitGrade}
									</td>
									<td class="centertitle">
										${limitList.limitNo}
									</td>
									<td class="centertitle">
										${limitList.limitTypeName}
									</td>
									<td class="centertitle">
										${limitList.currencyName}
									</td>
									<td class="centertitle">
