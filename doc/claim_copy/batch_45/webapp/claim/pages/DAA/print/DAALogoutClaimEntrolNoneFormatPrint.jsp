...
<body bgcolor="#FFFFFF">
	...
	<table border=1 width="97%" align="center" cellspacing="0" cellpadding="2" style="border-collapse: collapse" bordercolor="#111111" style="font-family:宋体; font-size:10pt;">
		<tr>
			<td width="1%" rowspan="2">序 号</td>
			<td width="6%">立案编号</td>
			<td width="6%">被保险人</td>
			<td width="6%">厂牌型号</td>
			<td colspan="2">出险地点</td>
			<td width="7%" rowspan="2">车辆损失险 估损金额</td>
			<td width="11%" rowspan="2">第三者责任险估损金额</td>
			<td width="7%" rowspan="2">附加险估损金额</td>
			<td width="10%" rowspan="2">合计估损金额</td>
			<td width="6%" rowspan="2">註銷原因</td>
			<td width="6%" rowspan="2">註銷日期</td>
