...
<%
	...
	// int intMarks=0;
	// String strFontSize = "";
	// intMarks = StringUtils.timesOf(strMarks,"<br>");
	// if(intMarks <= 10)
	// {
	//strFormatMarks = strMarks;

	//strFormatItemAmout = strItemAmout; 
	//}
	// else if(intMarks > 10 && intMarks < 16)
	// {
	//  strFormatMarks = strMarks;

	//strFontSize = "font-size:6pt;";    
	//}
	//else if (intMarks >= 16)
	//{
	// strFormatMarks = "";
