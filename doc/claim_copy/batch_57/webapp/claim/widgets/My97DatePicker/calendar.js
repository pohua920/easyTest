...
My97DP.prototype = {
    ...
    _makeDateInRange: function () {
        ...
        if (_ != 0) {
            var $;
            if (_ > 0) $ = this.maxDate;
            else $ = this.minDate; if ($dp.has.sd) {
                $dt.y = $.y;
                $dt.M = $.M;
                $dt.d = $.d
            }
        ...
        for (E = 1, C = A; E < 7; E++) {
            ...
            for (D = 0; D < 7; D++) {
                ...
                if (_.M == B) {
                    ...
                    I = "WotherDay";
                    $ = "WotherDayOn"
                } else K = false; if ($dp.isShowWeek && D == 0 && (E < 4 || K)) H.a("<td class=Wweek>" + getWeek(_, $dp.firstDayOfWeek == 0 ? 1 : 0) + "</td>");
                H.a("<td ");
                if (K) {
        ...
        for (var i = 0; i < r; i++) {
            ...
            for (var j = 0; j < c; j++) {
                ...
                if (($dp.opposite && this.checkRange($dt, p) == 0) || this.checkValid($dt, p)) {
                    ...
                    if(p=="y"){
                    	s.a("hide($d." + p + "D);$d." + fp + "I.realValue=" + $dt[p] + ";$d." + fp + "I.blur();\"")
                    }else{
                ...
                s.a(">");
                if(p=="M"){
                	s.a($lang.aMonStr[$dt[p] - 1]) 
                }else if(p=="y"){
                	s.a($dt[p]-$dp.yearOffset);
                }else{
                	s.a($dt[p]);
                }
                s.a("</td>");
    ...
    draw: function () {
        ...
        if ($dp.doubleCalendar) {
            ...
            $d.ryI.value = $dt.y- $dp.yearOffset;
            $d.ryI["realValue"] = $dt.y;
...
function sv(_, $) {
    if ($ == null) $ = $dt[_];
    $sdt[_] = $dt[_] = $;
    if ("Hms".indexOf(_) >= 0) $d[_ + "I"].value = $;
    if (_ == "y") {
        $d.yI["realValue"] = $;
        $d.yI.value = $ - $dp.yearOffset
    }
    if (_ == "M") {
        $d.MI["realValue"] = $;
