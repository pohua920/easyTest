...
KindEditor.lang({
	...
	invalidRows : '欄數是必須輸入專案，只允許輸入大於0的數字。',
	invalidCols : '列數是必須輸入專案，只允許輸入大於0的數字。',
	invalidPadding : '內距必須是數字。',
	invalidSpacing : '間距必須是數字。',
	invalidBorder : '边框必须为数字。',
	pleaseInput : "請輸入內容。",
	invalidJson : '伺服器發生故障。',
	cutError : '您的瀏覽器安全設定不允許使用剪下操作，請使用快捷鍵(Ctrl+X)完成。',
	copyError : '您的瀏覽器安全設定不允許使用剪下操作，請使用快捷鍵(Ctrl+C)完成。',
	pasteError : '您的瀏覽器安全設定不允許使用剪下操作，請使用快捷鍵(Ctrl+V)完成。',
	ajaxLoading : '加載中，請稍候 ...',
	uploadLoading : '上傳中，請稍候 ...',
	uploadError : '上傳錯誤',
	'plainpaste.comment' : '請使用快捷鍵(Ctrl+V)把內容貼到下方欄位裡。',
	'wordpaste.comment' : '請使用快捷鍵(Ctrl+V)把內容貼到下方欄位裡。',
	'link.url' : 'URL',
	'link.linkType' : '打開類型',
	'link.newWindow' : '新視窗',
