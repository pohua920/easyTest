...
<script src="${ctx}/pages/common/replevy/js/replevyChargeEdit.js"></script>
<script type="text/javascript">
    function afterDeleteCharge(){
        calSumFeeAll();
    }
</script>
<!--建立显示的輸入条，可以收缩显示的-->
<table class="common" cellspacing="1" cellpadding="0" style="display: none" id="Charge_Data">
    <tbody>
        <tr>
            <td class="input" style="width: 8%">
                <input type="hidden" name="prpLchargeFlag">
                <input type="hidden" name="prpLchargeSerialNo" description="序號">
                <input name="prpLchargeKindCode" class="codecode" style="width: 100%" maxlength="3"
                    ondblclick="clearPaymentNew(this);code_CodeSelect(this, 'PolicyKindCodeForReplevy','0,1,2','Y','Y',fm.policyno.value+'|'+fm.prpLcompensateClaimNo.value+'|'+fm.familyNo.value);"
                    onchange="clearPaymentNew(this);code_CodeChange(this, 'PolicyKindCodeForReplevy','0,1,2','Y','Y',fm.policyno.value+'|'+fm.prpLcompensateClaimNo.value+'|'+fm.familyNo.value);"
                    onkeyup="clearPaymentNew(this);code_CodeSelect(this, 'PolicyKindCodeForReplevy','0,1,2','Y','Y',fm.policyno.value+'|'+fm.prpLcompensateClaimNo.value+'|'+fm.familyNo.value);">
            </td>
            <td class="input" style="width: 25%">
                <input name="prpLchargeKindName" class="codename" style="width: 242px;"
                    ondblclick="clearPaymentNew(this);code_CodeSelect(this, 'PolicyKindCodeForReplevy','-1,0,1','Y','N',fm.policyno.value+'|'+fm.prpLcompensateClaimNo.value+'|'+fm.familyNo.value);"
                    onchange="clearPaymentNew(this);code_CodeChange(this, 'PolicyKindCodeForReplevy','-1,0,1','Y','N',fm.policyno.value+'|'+fm.prpLcompensateClaimNo.value+'|'+fm.familyNo.value);"
                    onkeyup="clearPaymentNew(this);code_CodeSelect(this, 'PolicyKindCodeForReplevy','-1,0,1','Y','N',fm.policyno.value+'|'+fm.prpLcompensateClaimNo.value+'|'+fm.familyNo.value);">
                <input type="hidden" name="prpLchargeItemKindNo" value="0">
            </td>
            <td class="input" style="width: 15%">
                <input type="hidden" name="prpLchargeChargeCode" class="readonly" style="width: 100%" ondblclick="clearPaymentNew(this);code_CodeSelect(this, 'ReplevyChargeCode','-1,0','Y','N','Repl');"
                    onchange="clearPaymentNew(this);code_CodeChange(this, 'ReplevyChargeCode','0,1','Y'); " onkeyup="clearPaymentNew(this);code_CodeSelect(this, 'ReplevyChargeCode','-1,0','Y','N','Repl'); ">
                <input name="prpLchargeChargeName" class="codename" style="width: 100%" ondblclick="clearPaymentNew(this);code_CodeSelect(this, 'ReplevyChargeCode','-1,0','Y','N','Repl');"
                    onchange="clearPaymentNew(this);code_CodeChange(this, 'ReplevyChargeCode','-1,0','Y','N','Repl');" onkeyup="clearPaymentNew(this);code_CodeSelect(this, 'ReplevyChargeCode','-1,0','Y','N','Repl');">
            </td>
            ...
            <td class="input" style="width: 15%">
                <input name="prpLchargePayObjectName" class="codename" style="width: 100%" value="" ondblclick="getPayObject(this);clearPaymentNew(this);"
                    onchange="getPayObject(this);clearPaymentNew(this);" onkeyup="getPayObject(this);clearPaymentNew(this);">
            </td>
            <td class="input" style="width: 15%">
                <input type="hidden" name="prpLchargeCurrency" class="readonly" style="width: 100%" value="<%=ConstantCodes.LOCAL_CURRENCY%>">
                <input name="prpLchargeChargeReport" class="input" style="width: 100%" onfocus="cacheData(this);" onchange="validateMoney(this);setRealPayNew(this);" title="費用金額" value="0">
            </td>
            <td class="input" style="width: 10%">
                <input name="prpLchargeChargeAmount" class="input" style="width: 100%" onfocus="cacheData(this);" onchange="validateMoney(this);setRealPayNew(this);" title="實際費用" value="0">
        ...
        <tr>
            <td colspan="8">
                <table class="common" style="width: 100%" >
                    ...
                    <tr>
                        <td class="input" style="width: 15%"><s:text name="compensate.paymentObject" />：<%-- 賠付對象 --%></td>
                        <td class="input" style="width: 18%">
                            <!-- mantis： CLM0017，處理人員：Sam，需求單編號：CLM0017，原住名姓名調整作業_車 -->
                            <input name="prpLchargeOwnerName" maxlength="100"class="input">
                            <img src="${ctx}/images/bgMarkMustInput.jpg" complete="complete" />
                        </td>
                        <td class="input" style="width: 15%">證件號碼：</td>
                        <td class="input" style="width: 18%">
                    ...
                    <!-- \claim\webapp\claim\pages\common\replevy\ReplevyCharge.jsp -->
...
<table class="common" align="center" id="tableCharge">
    <tr>
        <td class="common" colspan="4" style="text-align: left">
            <img style="cursor: hand;" src="/claim/images/butCollapseBlue.gif" name="ChargeImg" onclick="showPage(this,spanCharge);"> <b>費用資訊</b><br>
                    ...
                    <c:forEach items="${requestScope.prpLcharge.prpLchargeList}" var="chargedtox">
                        <tr>
                            <td class="input" style="width: 8%">
                                ...
                                <input type="hidden" name="prpLchargeSerialNo" description="序號" value="<c:out value='${chargedtox.id.serialNo}'/>">
                            ...
                            <td class="input" style="width: 25%">
                                <input name="prpLchargeKindName" class="codename" value="<c:out value='${chargedtox.kindName}'/>" style="width: 242px;"
                                    ondblclick="clearPaymentNew(this);code_CodeSelect(this, 'PolicyKindCodeForReplevy','-1,0,1','Y','N',fm.policyno.value+'|'+fm.prpLcompensateClaimNo.value+'|'+fm.familyNo.value);"
                                    onchange="clearPaymentNew(this);code_CodeChange(this, 'PolicyKindCodeForReplevy','-1,0,1','Y','N',fm.policyno.value+'|'+fm.prpLcompensateClaimNo.value+'|'+fm.familyNo.value);"
                                    onkeyup="clearPaymentNew(this);code_CodeSelect(this, 'PolicyKindCodeForReplevy','-1,0,1','Y','N',fm.policyno.value+'|'+fm.prpLcompensateClaimNo.value+'|'+fm.familyNo.value);">
                            ...
                            <td class="input" style="width: 15%;">
                                <input type="hidden" name="prpLchargeChargeCode" class="readonly" style="width: 100%" value="<c:out value='${chargedtox.chargeCode}'/>"
                                    ondblclick="clearPaymentNew(this);code_CodeSelect(this, 'ReplevyChargeCode','0,1','Y','Repl');" onchange="clearPaymentNew(this);code_CodeChange(this, 'ReplevyChargeCode','-1,0','Y','N','Repl');"
                                    onkeyup="clearPaymentNew(this);code_CodeSelect(this, 'ReplevyChargeCode','0,1','Y','Repl');">
                                <input name="prpLchargeChargeName" class="codename" style="width: 100%" value="<c:out value='${chargedtox.chargeName}'/>"
                                    ondblclick="clearPaymentNew(this);code_CodeSelect(this, 'ReplevyChargeCode','-1,0','Y','N','Repl');" onchange="clearPaymentNew(this);code_CodeChange(this, 'ReplevyChargeCode','-1,0','Y','N','Repl');"
                                    onkeyup="clearPaymentNew(this);code_CodeSelect(this,'ReplevyChargeCode','-1,0','Y','N','Repl');">
                            </td>
                            <td class="input" style="width: 11%">
                            ...
                            <td class="input" style="width: 15%">
                                ...
                                <input name="prpLchargePayObjectName" class="codename" style="width: 100%" value="<c:out value='${chargedtox.payObjectName}'/>"
                                    ondblclick="getPayObject(this);clearPaymentNew(this);" onchange="getPayObject(this);clearPaymentNew(this);" onkeyup="getPayObject(this);clearPaymentNew(this);">
                            </td>
                            <td class="input" style="width: 15%">
                                <input type="hidden" name="prpLchargeCurrency" class="readonly" style="width: 100%" value="<%=ConstantCodes.LOCAL_CURRENCY%>">
                            ...
                            <td class="input" style='width: 4%' align="center">
                                <div>
                                    <input type=button name="" class=smallbutton onclick="deleteRow(this,'Charge','prpLchargeSerialNo');" value="-" style="cursor: hand">
                                    <input type="hidden" name="prpLchargeFlag">
                                </div>
                            </td>
                        </tr>
                                ...
                                <table class="common" style="width: 100%">
                                    ...
                                    <tr>
                                        ...
                                        <td class="right" style="width: 18%">
                                            <!-- mantis： CLM0017，處理人員：Sam，需求單編號：CLM0017，原住名姓名調整作業_車 -->
                                            <input type="text" class='input' name="prpLchargeOwnerName" maxlength="100" value="<c:out value='${chargedtox.prpLpayObjectInfo.ownerName}'/>">
                                            <img src="${ctx}/images/bgMarkMustInput.jpg" complete="complete" />
                                        </td>
                                        <td class="input" style="width: 15%">證件號碼：</td>
                                        <td class="right" style="width: 18%">
                                    ...
                                    <tr>
                                    <!-- mantis：CLM0145，處理人員：DP0713，需求單編號：CLM0145，.新核心-理算任務處理賠付對象郵遞區號長度檢核 -->
                                    <!-- \claim\webapp\claim\pages\common\replevy\ReplevyCharge.jsp 2-->
                                        <td class="input" style="width: 15%">郵遞區號：</td>
                                        <td class="right" style="width: 18%">
                                        	<!-- mantis：CLM0145，處理人員：DP0713，需求單編號：CLM0145，.新核心-理算任務處理賠付對象郵遞區號長度檢核 -->
