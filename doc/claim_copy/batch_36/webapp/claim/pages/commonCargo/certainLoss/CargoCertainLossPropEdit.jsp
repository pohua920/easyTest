...
--%> 
  ...
  <span  id="SpanProp">   
    ...
    <!--表示显示多行的-->  
      <tr> 
        <td class="subformtitle" colspan="4"><s:text name="certainLoss.damagePropertyList"/><br><%-- 财产损失清单信息 --%>
          <span  style="display:none">
            <table cellpadding="5" cellspacing="1" class="common"  id="Prop_Data" style="display:none">
              <tbody>  
                <tr class=common>
                  ...
                  <td >
                    <table  cellpadding="5" cellspacing="1" class="common">
                      <tr>
                        <td class="title" ><s:text name="undwrt.Risks"/>：</td> <%--险别  --%>
                        <td class="input" style='width:35%'>                          
                          <input type="input" name="prpLpropKindCode" class="codecode" 
                      ...
                      <tr>
                        <td class="title"><s:text name="db.prpLprop.unitPrice "/>：</td><%-- 单价 --%>
                        <td class="input">
                          <input class="input" s name="prpLpropUnitPrice">
                        </td>
                        <td class="title"><s:text name="certainLoss.numberDamaged"/>：</td><%-- 受损数量 --%>
                        <td class="input">
                          <input class="input" s name="prpLpropLossQuantity">
                        </td>
                      </tr>   
                      
                      <tr>
                        <td class="title"><s:text name="certainLoss.depreciationRate"/>：</td> <%-- 折旧率 --%>
                        <td class="input" colspan="3">
                      ...
                      <tr>
                        ...
                        <td class="input">
                          <input class="input" s name="prpLpropSumLoss">
                        </td>
                        <td class="title"><s:text name="db.prpLperson.sumReject"/>：</td> <%-- 剔除金额 --%>
                        <td class="input"><input class="input" s name="prpLpropSumReject"></td>
                      </tr>  
                      
                      <tr>
                        <td class="title"><s:text name="certainLoss.lossRatios"/>：</td> <%-- 损失率 --%>
                        <td class="input">
                          <input class="input" s name="prpLpropLossRate">%
                        </td>
                        <td class="title"><s:text name="certainLoss.standardLoss"/>：</td><%-- 核定标的损失 --%>
                        <td class="input"><input class="input" s name="prpLpropSumDefLoss"></td>
                      </tr>  
                      ...
                      <tr>
                        <td class="title"><s:text name="db.prpLperson.remark"/>：</td>  <%-- 备注 --%>
                        <td class="input" colspan="3">
          ...
          <span  id="spanProp">
          <%-- 多行输入展现域 --%>
          <table  class="common" id="Prop" align="center" cellspacing="1" cellpadding="5">
            <thead>
              <tr>
                <td class="title" style="width:4%"><s:text name="db.prpLperson.serialNo"/></td> <%-- 序号 --%>
                <td class="title" style="width:96%" colspan=2 ><s:text name="db.utiFile.text"/></td> <%-- 内容 --%>
              </tr>                        
            </thead>
            <tfoot> 
              <tr>
...
<logic:iterate id="prpLpropDto1" name="prpLpropDto" property="propList">
                <tr class=common>
                  ...
                  <td class="subformtitle"  >
                    <table  cellpadding="0" cellspacing="1" class="common">
                      <tr>
                        <td class="title" ><s:text name="undwrt.Risks"/>：</td> <%-- 险别 --%>
                        <td class="input" style='width:35%'>                           
                          <input type="input" name="prpLpropKindCode" class="codecode"   value="<bean:write name='prpLpropDto1' property='kindCode'/>"
                              ondblclick= "code_CodeSelect(this,'PolicyKindCode');"
                              onkeyup= "code_CodeSelect(this,'PolicyKindCode');">   
                          <input type="input" name="prpLpropKindName" class="codename"   value="<bean:write name='prpLpropDto1' property='kindName'/>"
          			             ondblclick="code_CodeSelect(this, 'PolicyKindCode','-1','always','none','post');"
          			             onkeyup= "code_CodeSelect(this, 'PolicyKindCode','-1','always','none','post');">  
                      ...
                      <tr>
                        <td class="title"><s:text name="compensate.lossDetail"/>：</td><%-- 损失明细 --%>
                        <td class="input">                       
                          <input type="input" name="feeTypeCode" class="codecode"   value="<bean:write name='prpLpropDto1' property='feeTypeCode'/>"
                              ondblclick= "code_CodeSelect(this,'ChargeCode');"
                              onkeyup= "code_CodeSelect(this,'ChargeCode');">   
                          <input type="input" name="prpLpropFeeTypeName" class="codename"   value="<bean:write name='prpLpropDto1' property='feeTypeName'/>"
          			             ondblclick="code_CodeSelect(this, 'ChargeCode','-1','always','none','post');"
          			             onkeyup= "code_CodeSelect(this, 'ChargeCode','-1','always','none','post');">  
                        ...
                        <td class="input">
                          <input type="input" style='width:30px' name="prpLpropCurrency"  value="<bean:write name='prpLpropDto1' property='currency'/>"  class="readonly" readonly
                            ondblclick= "code_CodeSelect(this,'Currency');"
                            onkeyup= "code_CodeSelect(this,'Currency');">      
                          <input type="input" s name="prpLpropCurrencyName"  value="<bean:write name='prpLpropDto1' property='currencyName'/>" class="readonly" readonly
          			             ondblclick="code_CodeSelect(this, 'Currency','-1','always','none','post');"
          			             onkeyup= "code_CodeSelect(this, 'Currency','-1','always','none','post');">  
                          </td> 
                      </tr>  
                      ...
                      <tr>
                        <td class="title"><s:text name="db.prpLprop.unitPrice"/>：</td> <%--  单价--%>
                        <td class="input">
                          <input class="input" s name="prpLpropUnitPrice" value="<bean:write name='prpLpropDto1' property='unitPrice'/>">
                        </td>
                        <td class="title"><s:text name="certainLoss.numberDamaged"/>：</td><%-- 受损数量 --%>
                        <td class="input">
                          <input class="input" s name="prpLpropLossQuantity" value="<bean:write name='prpLpropDto1' property='lossQuantity'/>">
                        </td>
                      </tr>   
                      <tr>
                        <td class="title"><s:text name="certainLoss.depreciationRate"/>：</td> <%-- 折旧率 --%>
                      ...
                      <tr>
                        <td class="title"><s:text name="compensate.approvedLoss"/>：</td> <%-- 核定损失 --%>
                        <td class="input">
                          <input class="input" s name="prpLpropSumLoss" value="<bean:write name='prpLpropDto1' property='sumLoss'/>">
                        </td>
                        <td class="title"><s:text name="db.prpLperson.sumReject"/>：</td> <%-- 剔除金额 --%>
                        <td class="input"><input class="input" s name="prpLpropSumReject" value="<bean:write name='prpLpropDto1' property='sumReject'/>"></td>
                      </tr>  
                      
                      <tr>
                        <td class="title"><s:text name="certainLoss.lossRatios"/>：</td> <%-- 损失率 --%>
                        <td class="input">
                          <input class="input" s name="prpLpropLossRate" value="<bean:write name='prpLpropDto1' property='lossRate'/>">%
                        </td>
                        <td class="title"><s:text name="certainLoss.standardLoss"/>：</td> <%-- 核定标的损失 --%>
                        <td class="input"><input class="input" s name="prpLpropSumDefLoss" value="<bean:write name='prpLpropDto1' property='sumDefLoss'/>"></td>
                      </tr>  
                      ...
                      <tr>
                        <td class="title"><s:text name="db.prpLprop.remark"/>：</td> <%-- 备注 --%>
                        <td class="input" colspan="3">
                  ...
                  <td class="input" style='width:4%'>
                    <div align="center">
                      <input type=button name="buttonPropDelete" class=smallbutto  onclick="deleteRow(this,'Prop')" value="-" style="cursor: hand">
                    </div>
                  </td>   
                </tr>
