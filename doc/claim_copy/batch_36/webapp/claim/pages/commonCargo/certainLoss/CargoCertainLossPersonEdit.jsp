    ...
    <span style="display:" id="SpanPerson" cellspacing="1" cellpadding="0">  
      ...
      <!--表示显示多行的-->    
        <tr>
          <td class="subformtitle" colspan="4" align="center">
            <s:text name="certainLoss.personnelList"/> <%-- 人员核定损清单 --%>
          </td>
        </tr>
        <tr>
                     ...
                     <td class="subformtitle">
                       <table  cellpadding="0" cellspacing="1" class="common">
                         ...
                         <tr>
                           ...
                           <td class="title" ><s:text name="db.prpLpersonloss.age"/>:</td>  <%-- 年龄 --%>
                           <td class="input" >
                         ...
                         <tr>   
                           <td class="title" ><s:text name="certainLoss.equivalentCoins"/>:</td> <%-- 折合币别 --%>
                           <td class="input" >
                             <input name="prpLpersonCurrency2" type="text" class="readonly" readonly style="width:50px" value="CNY">
                             <input name="prpLpersonCurrency2Name" class="readonly" readonly  value="<s:text name='certainLoss.rmb'/>"><%-- 人民币 --%>
                           </td>
                         ...
                         <tr>
                           ...
                           <td class="input" align="center" ><input type="button" class=bigbutton name="button_Person_Collect" value="<s:text name='button.lossesTotal.value'/>" onclick="alert('损失合计');"></td> <%-- 损失合计 --%>
                         </tr>  
                        <tr> 
                        <td colspan="4">
                          ...
                          <table id="PersonFeeLoss" name="PersonFeeLoss" class="common" align="center" cellspacing="1" cellpadding="0">
                            <thead>
                              ...
                              <tr> 
                                ...
                                <td class="centertitle" style="width:20%"><s:text name="certainLoss.responsibleClass"/></td>  <%-- 责任分类 --%>
                                <td class="centertitle" style="width:18%"><s:text name="certainLoss.responsibilityDetail"/></td>  <%-- 责任明细 --%>
                                <td class="centertitle" ><s:text name="db.prpLlawsuit.currency"/></td> <%-- 币别 --%>
                                <td class="centertitle" style="width:10%"><s:text name="certainLoss.prpLscheduleMainWF.LossSum"/></td>  <%-- 报损金额 --%>
     ...
     <span  id="spanPerson">
       ...
       <table id="person" class="common" align="center" cellspacing="1" cellpadding="5">
         <thead>
           <tr>
             <td class="title" style="width:4%"><s:text name="db.prpLassureDetail.serialNo"/></td> <%-- 序号 --%>
