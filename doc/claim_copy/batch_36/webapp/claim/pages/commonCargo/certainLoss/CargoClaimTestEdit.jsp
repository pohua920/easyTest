      ...
      <tr> 
        <td class="subformtitle" colspan="4"><s:text name="certainLoss.damagePropertyList"/><br><%-- 财产损失清单信息 --%>
                  ...
                  <td class="subformtitle"  >
                    <table  cellpadding="0" cellspacing="1" class="common">
                      ...
                      <tr>
                        ...
                        <td class="input">                       
                          <input type="input" name="prpLpropFeeTypeCode" class="codecode" 
                        ...
                        <td class="input">
                          ...
                          <input class="input" s name="prpLpropCurrencyName" value="<s:text name='certainLoss.rmb'/>"> <%-- 人民币 --%>
                          </td>
                      </tr> 
          ...
          <table  class="common" id="Prop" align="center" cellspacing="1" cellpadding="0">
            ...
            <tfoot> 
              <tr>
                <td class="title" colspan=2 style="width:96%"><s:text name="prompt.certainLoss.addDelete"/></td><%-- (按"+"号键增加驾驶员信息，按"-"号键删除信息) --%>
            ...
            <tbody>
              <tr>
                <td colspan="3">
                    <table  cellpadding="0" cellspacing="1" class="common" cellpadding="5" cellspacing="1">
                      <tr>
                        <td class="title" ><s:text name="claim.name"/></td> <%--姓名   --%>
                        <td class="input" >
                          <!-- mantis： CLM0017，處理人員：Sam，需求單編號：CLM0017，原住名姓名調整作業_車 -->
                          <input name="prpLdriverDriverName" class="input"  maxlength="100" description="驾驶员姓名">
                        </td>
                        <td class="title" ><s:text name="db.prpDDriver.drivingCarType"/></td> <%-- 准驾车型 --%>
                        <td class="input">
                          <select name="prpLdriverDrivingCarType" class=common >
                            <option value="" selected ><s:text name="certainLoss.unspecified"/> <%-- 未指明 --%>
                        ...
                        <td class="title" ><s:text name="db.prpCCarDriver.awardLicenseOrgan"/></td> <%-- 颁证机关 --%>
                        <td class="input" >
                          <input name="prpLdriverAwardLicenseOrgan" class="common"  maxlength=20 description="颁证机关"> 
                        </td>        
                        <td class="title"><s:text name="db.prpCCarDriver.drivinglicenseno"/></td> <%-- 驾驶证号码 --%>
                        <td class="input" >
                          <input name="prpLdriverDrivingLicenseNo" class="common"   maxlength=10 description="驾驶证号码">
                        </td>          
                      </tr> 
                    </table>
		              </td> 
