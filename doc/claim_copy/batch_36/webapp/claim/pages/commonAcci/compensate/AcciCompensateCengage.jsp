					...
					<tbody>
						<logic:notEmpty name="prpCengageDto" property="prpCengageList">
							<logic:iterate id="cengage" name="prpCengageDto" property="prpCengageList">
								<tr class=oddrow>
									<td class="centertitle">
										<bean:write name='cengage' property='serialNo' />
									</td>
									<td class="centertitle">
										<bean:write name='cengage' property='clauseCode' />
									</td>
									<td class="centertitle">
										<bean:write name='cengage' property='clauses' />
									</td>
									<td class="centertitle">
										<input type=button ACCESSKEY="." value='...' name='button_Engage_Open_Context' onclick="buttonOnClick(this,'ClauseCodeSpeContext',-2,1,'span_Engage_Context');">
										<span id="span_Engage_Context" style='width: 520; display: none; position: absolute; background-color: FFFFFF;'>
											<table class=sub>
												<tr>
													<td class=title>
														<textarea name=ClausesContext rows=20 cols=80 class=readonly readonly><bean:write name='cengage' property='context' /></textarea>
													</td>
												</tr>
												<tr>
													<td colspan=2 align=center>
														<input type=button name='button_Engage_Close_Context' value="<s:text name='button.determine.value' />" ACCESSKEY="O" onclick="hideSubPage(this,'span_Engage_Context')">
													</td>
												</tr>
											</table>
										</span>
