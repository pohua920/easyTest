...
<c:forEach var="prpDclauseKindTemp" items="${prpDclauseKindList}" varStatus="prpDclauseKind_status">
<span style="display: none" name="span_prpDclauseKind">
	<input type="hidden" name="init_data_ck_payType" value="${prpDclauseKindTemp.payType }"> 
	<input type="hidden" name="init_data_ck_accident" value="${prpDclauseKindTemp.accident }"> 
	<input type="hidden" name="init_data_ck_kindCode" value="${prpDclauseKindTemp.kindCode }"> 
	<input type="hidden" name="init_data_ck_kindCName" value="${prpDclauseKindTemp.kindCName }"> 
</span>
</c:forEach>
