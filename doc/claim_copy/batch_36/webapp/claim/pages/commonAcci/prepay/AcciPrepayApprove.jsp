...
<body class=interface onload="initPage();InitDocument();initShow();" class="interface">
	<form name=fm action="${ctx}/prepayApprove.do" method="post" onsubmit="return validateForm(this);">
		<!-- 1.预赔主信息 -->
		<%@include file="/pages/commonProp/prepay/PropPrepayMainShow.jsp"%>
		<!-- 4.预赔备注信息 -->
		<%@include file="/pages/commonProp/prepay/PropPrepayTextShow.jsp"%>
		<!-- 保存通用按钮 -->
		<table cellpadding="0" cellspacing="0" width="80%" style="display:">
			<tr>
				<td align="center">
					<input type="button" name="buttonApprove" value="<s:text name='button.nuclear.value' />" onClick="approveSubmit();">
				</td>
			</tr>
		</table>
	</form>
