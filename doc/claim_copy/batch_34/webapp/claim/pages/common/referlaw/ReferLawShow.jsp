...
<head>
<title><s:text name="title.referlawBeforeEdit.relatedInfoInput" /></title>
<%--涉诉信息录入--%>
<%-- 页面样式  --%>
	...
	<form name=fm action="/claim/referlaw.do?actionType=editSave" method="post" onsubmit="">
		...
		<span style="display: none" id="Lawyerspan">
			<table width="100%" cellpadding="0" cellspacing="1" class="common" id="Lawyer_Data" style="display: none">
				<tbody>
					<tr>
						<td>
							<input name="LawyerName" class="input" value="">
						</td>
						<td>
							<input name="Lawoffice" class="input" value="">
						</td>
						<td>
							<input name="Phone" class="input" value="">
						</td>
						<td>
							<input name="Email" class="input" value="">
						</td>
						<td>
							<input name="Place" class="input" value="">
						</td>
						<td>
							<input name="PostCode" class="input" value="">
						</td>
						<td>
						...
						<td class="input" style='width: 4%'>
							<div align="center">
								<input type=button name="buttonPropDelete" class=smallbutton onclick="deleteRow(this,'Lawyer')" value="-" style="cursor: hand" disabled="true">
							</div>
						</td>
					</tr>
				</tbody>
		...
		<table class="common" cellpadding="5" cellspacing="1">
			...
			<tr>
				...
				<td class="input">
					<input type=text name="SumReferlaw" title="訴訟金額" readonly value="<bean:write name='prplreferlawDto' property="sumreferlaw"/>">
				</td>
				<td class="title">
				...
				<td class="title">
					<input type=text name="Currency" class="codecode" style="width: 27%" readonly title="幣別" value="<bean:write name="prplreferlawDto" property="currency"/>">
					<input type=text name="CurrencyName" class="codecode" readonly style="width: 27%" title="幣別" value="<bean:write name="prplreferlawDto" property="currencyname"/>">
				</td>
			</tr>
			<tr>
				<td class="title">
				...
				<td class="input">
					<input type=text name="SumReferlawFee" title="訴訟費用" readonly value="<bean:write name='prplreferlawDto' property="sumreferlawfee"/>">
				</td>
				<td class="title">
				...
				<td class="input">
					<input type=text name="CurrencyFee" class="codecode" readonly style="width: 27%" title="費用幣別" value="<bean:write name="prplreferlawDto" property="currencyfee"/>">
					<input type=text name="CurrencyFeeName" class="codecode" style="width: 27%" title="費用幣別" readonly value="<bean:write name="prplreferlawDto" property="currencyfeename"/>">
				</td>
			</tr>
			<tr>
				<td class="title">
			...
			<tr>
				...
				<td class="input">
					<html:select property="successflag" style="width:204px" name="prplreferlawDto" disabled="true">
						<html:option value="0">
			...
			<tr>
				<td class="input" colspan="4">
					<textarea class="text" style="wrap: hard" rows="5" cols="80" readonly name="referlawreason"><bean:write name="prplreferlawDto" property="referlawreason" /></textarea>
				</td>
			</tr>
			<tr>
				<td class=formtitle colspan="4">
						...
						<table width="100%" class="common" cellpadding="1" id="Lawyer">
							...
							<tbody>
								<logic:iterate id="prpllawyerDto" name="prplreferlawDto" property="prpllawyerDtoList">
									<tr>
										<td>
											<bean:write name="prpllawyerDto" property="name" />
										</td>
										<td>
											<bean:write name="prpllawyerDto" property="lawoffice" />
										</td>
										<td>
											<bean:write name="prpllawyerDto" property="phone" />
										</td>
										<td>
											<bean:write name="prpllawyerDto" property="email" />
										</td>
										<td>
											<bean:write name="prpllawyerDto" property="place" />
										</td>
										<td>
											<bean:write name="prpllawyerDto" property="postcode" />
										</td>
										<td>
											<html:select name="prpllawyerDto" property="validstatus" style="width:50%" disabled="true">
												<html:option value="1">
													<s:text name="common.status.effective" />
												</html:option>
												<%--有效--%>
			...
			<tr>
				<td class="input" colspan="4">
					<textarea class="text" style="wrap: hard" rows="5" cols="80" readonly name="adjudgmentOne"><bean:write name="prplreferlawDto" property="adjudgmentone" /></textarea>
				</td>
			</tr>
			<tr>
				<td class="input" colspan="4">
			...
			<tr>
				<td class="input" colspan="4">
					<textarea class="text" style="wrap: hard" rows="5" cols="80" readonly name="adjudgmentTwo"><bean:write name="prplreferlawDto" property="adjudgmenttwo" /></textarea>
				</td>
			</tr>
			<tr>
				<td class="input" colspan="4">
			...
			<tr>
				<td class="input" colspan="4">
					<textarea class="text" style="wrap: hard" rows="5" cols="80" readonly name="adjudgmentThree"><bean:write name="prplreferlawDto" property="adjudgmentthree" /></textarea>
				</td>
			</tr>
		</table>
		...
		<table class="common" align="center">
			<tr>
				<td class="button">
					<%--					<input type="button" name="buttonSave" value=" 儲存 " class="button"--%>
					<%--						onclick="submitForm();">--%>
				</td>
				<td class="button"></td>
			</tr>
