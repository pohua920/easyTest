...
<body onload="">
	<form name="fm" action="/claim/referlaw.do?actionType=search" method="post">
		...
		<table width="100%">
			<tr>
				...
				<td align="center" width="10%" class="centertitle">
					<s:text name="db.view_larrearage.insuredname" />
					<%--被保险人名称--%>
				</td>
				<td align="center" class="centertitle">
			...
			<logic:iterate id="prpLclaimDto" name="claimList">
				<tr class=listodd>
					...
					<td align="center">
						<a href="/claim/referlaw.do?actionType=add&prpLReferLawClaimNo=<bean:write name='prpLclaimDto' property="claimNo"/>"><bean:write name='prpLclaimDto' property="claimNo" /> </a>
					</td>
					<td align="center">
					...
					<td align="center">
						<logic:equal name="prpLclaimDto" property="referLawFlag" value="1">
