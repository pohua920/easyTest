...
<table border="0" cellspacing="0" cellpadding="0">
	<s:if test="#parameters.editType[0].endsWith('add')||#parameters.editType[0].endsWith('edit')">
		<tr align="center">
			<td>&nbsp</td>
			...
			<td class=button align="center">
				<input type=button name=buttonCancel class='button' value="<s:text name="prompt.back" />" onclick="history.go(-1);" />
				&nbsp;&nbsp;
				<%--返回 --%>
			</td>
		</tr>
	</s:if>
	<s:elseif test="#parameters.editType[0].endsWith('undwrt')">
		<tr align="center">
			<td>&nbsp</td>
			<td class=button align="center">
			...
			<c:if test="${not empty requestScope.swfLog && submitSuperior}">
            <td class=button align="center">
