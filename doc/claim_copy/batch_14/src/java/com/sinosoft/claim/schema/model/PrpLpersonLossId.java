...
/**
 * POJO类PrpLpersonLossId
 */
@Embeddable
public class PrpLpersonLossId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof PrpLpersonLossId)) {
			return false;
		}
		PrpLpersonLossId castOther = (PrpLpersonLossId) other;
