...
/**
 * POJO类PrpLpersonTraceId
 */
@Embeddable
public class PrpLpersonTraceId implements java.io.Serializable {
	...
	/**
	 * 类PrpLpersonTraceId的默认构造方法
	 */
	public PrpLpersonTraceId() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof PrpLpersonTraceId)) {
			return false;
		}
		PrpLpersonTraceId castOther = (PrpLpersonTraceId) other;
