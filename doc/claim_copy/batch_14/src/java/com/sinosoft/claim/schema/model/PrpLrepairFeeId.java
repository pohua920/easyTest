...
/**
 * POJO类PrpLrepairFeeId
 */
@Embeddable
public class PrpLrepairFeeId implements java.io.Serializable {
	...
	/**
	 * 类PrpLrepairFeeId的默认构造方法
	 */
	public PrpLrepairFeeId() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof PrpLrepairFeeId)) {
			return false;
		}
		PrpLrepairFeeId castOther = (PrpLrepairFeeId) other;
