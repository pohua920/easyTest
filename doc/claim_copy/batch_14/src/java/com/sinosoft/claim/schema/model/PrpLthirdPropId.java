...
/**
 * POJO类PrpLthirdPropId
 */
@Embeddable
public class PrpLthirdPropId implements java.io.Serializable {
	...
	/**
	 * 类PrpLthirdPropId的默认构造方法
	 */
	public PrpLthirdPropId() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof PrpLthirdPropId)) {
			return false;
		}
		PrpLthirdPropId castOther = (PrpLthirdPropId) other;
