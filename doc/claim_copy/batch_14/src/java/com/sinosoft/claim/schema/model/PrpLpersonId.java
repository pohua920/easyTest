 ...
 */
@Embeddable
public class PrpLpersonId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof PrpLpersonId)) {
			return false;
		}
		PrpLpersonId castOther = (PrpLpersonId) other;
