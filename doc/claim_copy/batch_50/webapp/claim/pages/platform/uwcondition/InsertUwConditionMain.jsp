...
<link rel="stylesheet" type="text/css" href="/claim/platform/behaviors/2k3OlBar.css">
</head>
	...
	<tr>
		<td style="width: 145px;">
			<div style="border: solid 1px #000080; width:140px; height:458px; overflow:auto;">
				<table class="common" cellpadding="3" cellspacing="1" align="center">
						...
						<td class="page">
							<center>
								<input type="button" name="n1" value="<s:text name='button.Factor.value'/>" class="button3"<%-- 因子值 --%>
								       onclick="prepareUpdate('prepareInsertUtiUwCondition');">
								<input type="button" name="n2" value="<s:text name='button.Personnel.value'/>"  class="button3"<%-- 人员 --%>
								       onclick="prepareUpdate('prepareInsertUtiUwLevel');" disabled="disabled">
							</center>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td class="page"><s:text name="uwcondition.TypeAuditing"/>：<bean:write name="UtiUwConditionDto" property="uwTypeName"/></td> <%-- 审核类型 --%>
					</tr>
					<tr>
						<td class="page"><s:text name="uwcondition.AuditDepartment"/>：<br/><bean:write name="UtiUwConditionDto" property="comCode"/>-<bean:write name="UtiUwConditionDto" property="comName"/></td> <%-- 审核部门 --%>
						<INPUT type="hidden" name="comCode" value='<bean:write name="UtiUwConditionDto" property="comCode"/>'>
					</tr>
					<tr>
						<td class="page"><s:text name="archive.riskClass"/>：<br/><bean:write name="UtiUwConditionDto" property="classCode"/>-<bean:write name="UtiUwConditionDto" property="className"/></td> <%--  险类--%>
					</tr>
					<tr>
						<td class="page"><s:text name="regist.prpLregist.riskCodeName"/>：<br/><bean:write name="UtiUwConditionDto" property="riskCode"/></td> <%-- 险种 --%>
					</tr>
					<tr>
						<td class="page"><s:text name="uwcondition.Template"/>：<br/><bean:write name="UtiUwConditionDto" property="modelName"/></td> <%--  模板--%>
					</tr>
				</table>
			</div>
		</td>
		...
		<td rowspan="2">
			<div style="border: solid 1px #000080; width:630px; height:485px;">
				<iframe src='/claim/platform/uwcondition/InsertUwConditionRight.jsp' 
		...
		<td style="width: 145px;">
			<div style="height: 30px; width: 140px;">
				<center>
					<table>
						<tr>
							<td><input type="button" name="btnBack" value="<s:text name='button.ReturnNewPage.value'/>" class="longbutton"  <%-- 返回到新增页面 --%>
							    onclick="backOverview();"></td>
						</tr>
					</table>
				</center>
			</div>
...
<script language="javascript">
	...
	{
			fm.action = "/claim/processUwCondition.do?actionType=prepareInsert";
			fm.submit();
	}
</script>
</body>
