...
<HTML xmlns:mpc>
    ...
    <BODY BGCOLOR="#D7E1F6" ONLOAD="oMPC.style.visibility='visible'"
        style="scroll: no; overflow: hidden;">
        <form name="fm" action="" method="POST">
            ...
            <div id="Layer1" style="position: absolute; width: 70px; height: 22px; z-index: 1; left: 550px; top: 2px;">
                <table border="0" cellpadding="0" cellspacing="1" class="common">
                    <tr>
                        <td>
                            <input type="button" name="save" value="<s:text name='button.save.value'/>Insert" class="button" onclick="doInsert();" ><%-- ±£ ¥Ê --%>
                        </td>
                    </tr>
                </table>
            </div>
        ...
        <script language="javascript">
            ...
            function doInsert(){
                    ...
                    if(confirm("¥_åç“™É¶¥ÊÜ·£ø")){
                        fm.action = "/claim/processUwCondition.do?actionType=insertUtiUwLevel";
                        fm.submit();
                    }
            }
        </script>
