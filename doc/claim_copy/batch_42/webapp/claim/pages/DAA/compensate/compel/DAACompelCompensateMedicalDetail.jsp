			...
			<table class="common" style="display: none" id="PrpLcompelMedical_Data" cellspacing="1" cellpadding="0">
				<tbody>
						<tr class="content" bgcolor="#F7F7F7" name="prpLcompelMedicalObject">
							...
							<input type="hidden" name="HideMAXMEDICALPAY" value="${requestScope.hideMAXMEDICALPAY}">
							<input type="hidden" name="HideMAXCRIPPLEDPAY" value="${requestScope.hideMAXCRIPPLEDPAY}">
							<input type="hidden" name="HideMAXDEATHPAY" value="${requestScope.hideMAXDEATHPAY}">
							<input type="hidden" name="HideFeeA024" value="${requestScope.hideFeeA024}">
							<input type="hidden" name="HideFeeA026" value="${requestScope.hideFeeA026}">
							<input type="hidden" name="HideFeeA03" value="${requestScope.hideFeeA03}">
							<input type="hidden" name="HideFeeA04" value="${requestScope.hideFeeA04}">
							<input type="hidden" name="HideFeeA00" value="${requestScope.hideFeeA00}">
