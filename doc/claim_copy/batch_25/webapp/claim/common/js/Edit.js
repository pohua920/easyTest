...
function validateMode() {
	...
	alert(i18n.js.systemEdit); //请取消“使用 HTML 语法书写”选项再使用系统编辑功能!
	Composition.focus();
	return false;
}
...
function fortable() {
	if (!validateMode()) return;
	var arr = showModalDialog("table.html", "", "dialogWidth:18.5em; dialogHeight:11.5em; status:0");
...
function help() {
	var helpmess;
	helpmess = i18n.js.rightHelp + //---------------填写帮助---------------\r\n\r\n
	i18n.js.registered + //1.已注册的用户请先输入正确的昵称和密码\r\n\r\n
	i18n.js.newPeople + //2.新用户请去注册\r\n\r\n
	i18n.js.titleNoLength + //3.标题不能超过128个字符,若超过则自动截断.\r\n\r\n
	i18n.js.autoTruncated; //4.出处不能超过128个字符,若超过则自动截断.
	alert(helpmess);
