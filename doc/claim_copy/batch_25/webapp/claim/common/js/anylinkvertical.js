...
if(currentRootLableName!=null){
	currentRootLableName=obj.innerHTML;
}
...
var currentRootLableName = "root";
function setCurrentPosition(nodeList) {
	var currentPositionStr = "";
	for (var k = 0; k < nodeList.length; k++) {
		currentPositionStr = " \u2192 " + nodeList[k].label + currentPositionStr;
	}
	currentPositionStr = currentRootLableName + currentPositionStr;
	try {
		parent.frames.head.CurrentPositionSpan.innerHTML = currentPositionStr;
	}
	catch (E) {
	}
}
