...
/**
 * PrpCshipDriverId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCshipDriverId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String policyNo;
	private Integer serialNo;

	public PrpCshipDriverId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCshipDriverId))
			return false;
		PrpCshipDriverId castOther = (PrpCshipDriverId) other;
