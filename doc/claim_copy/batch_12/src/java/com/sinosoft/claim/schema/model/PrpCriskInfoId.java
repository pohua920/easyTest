...
/**
 * PrpCriskInfoId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCriskInfoId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String proposalNo;
	private String riskCode;

	public PrpCriskInfoId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCriskInfoId))
			return false;
		PrpCriskInfoId castOther = (PrpCriskInfoId) other;
