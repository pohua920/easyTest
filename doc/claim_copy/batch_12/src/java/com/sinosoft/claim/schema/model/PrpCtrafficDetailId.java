...
/**
 * PrpCtrafficDetailId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCtrafficDetailId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCtrafficDetailId))
			return false;
		PrpCtrafficDetailId castOther = (PrpCtrafficDetailId) other;
