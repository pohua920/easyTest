...
<script type="text/javascript">
	function query(field){
		var $replevyStatus = $(":checked[name='replevyStatus']");
		if($replevyStatus.length == 0 ){
			$("#replevyStatusMsg").show();
			return;
		}else{
			$("#replevyStatusMsg").hide();
		}
		fm.submit();
	}
</script>
...
<body >
	<form name="fm" action="${ctx }/claimRepleviedQuery.do" method="post" target="_blank" autocomplete="off">
		<input type="hidden" name="pageNo" value="1">
		<input type="hidden" name="pageSize" value="20">
		<table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" class="common">
			<tr>
				<td colspan="2" class="formtitle">已追償明細查詢</td>
			</tr>
			<tr>
			...
			<tr>
				<td class="title" align="right">追償狀態：&nbsp;&nbsp;</td>
				<td class="input" align="left">&nbsp;
					<input type="checkbox" name="replevyStatus" value="4"><label>&nbsp;分期追償&nbsp;</label>
					<input type="checkbox" name="replevyStatus" value="3"><label>&nbsp;追償完畢&nbsp;</label>
					<input type="checkbox" name="replevyStatus" value="6"><label>&nbsp;免追償&nbsp;</label>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<label id="replevyStatusMsg" style="color: red;display: none">至少選擇一個追償狀態</label>
				</td>
			</tr>
			<tr>
