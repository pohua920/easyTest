...
<body >
	<form name="fm" action="${ctx }/claimSettledQuery.do" method="post" target="_blank">
		<input type="hidden" name="pageNo" value="1">
		<input type="hidden" name="pageSize" value="20">
		<table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" class="common">
			<tr>
				<td colspan="2" class="formtitle">已決賠案明細查詢</td>
			</tr>
			<tr>
				...
				<td class="input" align="left">
					<div >
						...
						<input type="text" name="MakeComName" value="" class="codename" style="width: 180px"
							ondblclick="code_CodeSelect(this, 'prpdcompany2','-1,0','Y','N',fm.MakeCom.value);" 
							onchange="code_CodeChange(this, 'prpdcompany2','-1,0','Y','N',fm.MakeCom.value);" 
							onkeyup="code_CodeSelect(this, 'prpdcompany2','-1,0','Y','N',fm.MakeCom.value);">
					</div>
					<div>
