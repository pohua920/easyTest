...
public final class ConstantCodes {
	...
	public static final String KINDCODE_A01_H1 = "H1"; // 營業用汽車保險約定折舊率附加條款_車體(A式)
	public static final String KINDCODE_A01_H2 = "H2"; // 營業用汽車保險約定折舊率附加條款_車體(B式)
	public static final String KINDCODE_A01_H3 = "H3"; // 營業用汽車保險約定折舊率附加條款_車體(C式)
	public static final String KINDCODE_A01_H4 = "H4"; // 營業用汽車保險約定折舊率附加條款_竊盜(A式)
	public static final String KINDCODE_A01_H5 = "H5"; // 營業用汽車保險約定折舊率附加條款_竊盜(B式)
	public static final String KINDCODE_A01_H6 = "H6"; // 營業用汽車保險約定折舊率附加條款_竊盜(C式)
