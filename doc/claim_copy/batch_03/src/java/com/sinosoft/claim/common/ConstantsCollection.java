...
//		thirdPartyRelationshipList.put("6", "其          他");
	...
	static {
		...
		MainCarLoss.add(ConstantCodes.KINDCODE_A01_H1);
		MainCarLoss.add(ConstantCodes.KINDCODE_A01_H2);
		MainCarLoss.add(ConstantCodes.KINDCODE_A01_H3);
		MainCarLoss.add(ConstantCodes.KINDCODE_A01_H4);
		MainCarLoss.add(ConstantCodes.KINDCODE_A01_H5);
		MainCarLoss.add(ConstantCodes.KINDCODE_A01_H6);
