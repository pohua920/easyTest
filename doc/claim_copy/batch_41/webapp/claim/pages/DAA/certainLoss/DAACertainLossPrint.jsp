...
<table cellpadding="4" cellspacing="1" class="common">
	<tr>
		<td class="common" align="left" style="width: 20%">
			<input type=button value="<s:text name='button.projectsList.value'/>" menu.claimPrint.partChange class='bigbutton' onclick="submitForm1('ComponentList');">
			<!--零部件更换项目清单-->
		</td>
		<td class="common" align="center" style="width: 20%">
			<input type=button value="<s:text name='button.repairProjectsList.value'/>" class='bigbutton' onclick="submitForm1('RepairList');">
			<!--修理项目清单列印-->
		</td>
		<td class="common" align="center" style="width: 20%">
			<input type=button value="<s:text name='button.projectsListTable.value'/>" class='bigbutton' onclick="submitForm1('RepairAdd');">
			<!--修理项目清单附表-->
		</td>
		<td class="common" align="center" style="width: 20%">
			<input type=button value="<s:text name='button.damagePrint.value'/>" class='bigbutton' onclick="submitForm1('Loss');">
			<!--损失情况确认书列印-->
		</td>
		<td class="common" align="right" style="width: 20%">
			<input type=button value="<s:text name='button.testReport.value'/>" class='bigbutton' onclick="submitForm1('CheckCertainLoss');">
			<!--检验定损报告列印-->
		</td>
	</tr>
</table>
