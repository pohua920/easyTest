 ...
 */
@Embeddable
public class ClaimCompulsoryApplicantId  implements java.io.Serializable {
	 ...
	 * 类PrpTfeeId的默认构造方法
	 */
    public ClaimCompulsoryApplicantId() {
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof ClaimCompulsoryApplicantId) ) {return false;}
		 ClaimCompulsoryApplicantId castOther = ( ClaimCompulsoryApplicantId ) other; 
