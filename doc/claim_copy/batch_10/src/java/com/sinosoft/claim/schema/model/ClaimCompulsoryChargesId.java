 ...
 */
@Embeddable
public class ClaimCompulsoryChargesId  implements java.io.Serializable {
	 ...
	 * 类PrpTfeeId的默认构造方法
	 */
    public ClaimCompulsoryChargesId() {
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof ClaimCompulsoryChargesId) ) {return false;}
		 ClaimCompulsoryChargesId castOther = ( ClaimCompulsoryChargesId ) other; 
