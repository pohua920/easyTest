 ...
 */
@Embeddable
public class ClaimCompulsoryStatePricesId  implements java.io.Serializable {
	 ...
	 * 类PrpTfeeId的默认构造方法
	 */
    public ClaimCompulsoryStatePricesId() {
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof ClaimCompulsoryStatePricesId) ) {return false;}
		 ClaimCompulsoryStatePricesId castOther = ( ClaimCompulsoryStatePricesId ) other; 
