							...
							<table cellpadding="5" cellspacing="1" class="common">
								...
								<tr>
									...
									<td class="input" colspan="6" align="left">
										...
										<input type="hidden" name="prpLpersonTraceJobName" class="codename" style="width: 100px" ondblclick="code_CodeSelect(this,'BusinessSource','-1,0','Y','N');"
								...
								<tr>
                            		...
                            		<td class="title" style="width:15%" align=center></td><!-- 就診醫師 -->
	                                <td class="title" style="width:20%" colspan="3">
	                            	    <input type="hidden" name="prpLpersonTraceDoctor" style="width:30%" value="${personTrace.doctor}" class="input" description="就診醫師"/>
									</td>
	                              </tr>
	                              <tr>
									<td class="title" style="width: 15%">
									...
									<td class="input" colspan="5">
                              			<input name="prpLpersonTraceHospitalCode" style="display: none;" class="input" description="就診醫院代碼" />
                              			<input name="prpLpersonTraceHospital" style="width:300 px" class="input" description="就診醫院" />
										...
										<tr>
											...
											<td class="input" colspan="6" align="left">
												...
												<input type="text" name="prpLpersonTraceJobName1" class="codename" style="width: 100px" value="${personTrace.jobName1}" ondblclick="code_CodeSelect(this,'BusinessSource1','-1,0','Y','N',fm.riskcode.value);"
													onkeyup="code_CodeSelect(this,'BusinessSource1','-1,0','Y','N',fm.riskcode.value);" onchange="code_CodeChange(this,'BusinessSource1','-1,0','Y','N',fm.riskcode.value);">
												<input type="hidden" name="prpLpersonTraceJobCode2" value="${personTrace.jobCode}">
												<input type="text" name="prpLpersonTraceJobName2" class="codename" style="width: 100px" value="${personTrace.jobName}" ondblclick="code_CodeSelect(this,'BusinessSource2','-1,0','Y','N',fm.riskcode.value);"
													onkeyup="code_CodeSelect(this,'BusinessSource2','-1,0','Y','N',fm.riskcode.value);" onchange="code_CodeChange(this,'BusinessSource2','-1,0','Y','N',fm.riskcode.value);">
												<input type="hidden" name="prpLpersonTraceJobCode" value="${personTrace.jobCode}">
												<input type="hidden" name="prpLpersonTraceJobName" class="codename" style="width: 100px" value="${personTrace.jobName}" ondblclick="code_CodeSelect(this,'BusinessSource','-1,0','Y','N');"
													onchange="code_CodeChange(this,'BusinessSource','-1,0','Y','N');" onkeyup="code_CodeSelect(this,'BusinessSource','-1,0','Y','N');">
											</td>
										</tr>
										<tr>
										...
										<tr>
			                              ...
			                              <tr>
											...
											<td class="input" style="width:15%" colspan="5">
                             	   				<input name="prpLpersonTraceHospitalCode" style="display: none;" class="input" description="就診醫院代碼" value="${personTrace.hospitalCode }"/><%--onkeyup="getHospital(this,'codeCode','0,1');" onblur="isHospital(this,'codeCode');" --%>
	                               				<input name="prpLpersonTraceHospital" style="width:300 px" class="input" description="就診醫院" value="${personTrace.hospital }"><%-- onkeyup="getHospital(this,'codeName','-1,0');" --%>
