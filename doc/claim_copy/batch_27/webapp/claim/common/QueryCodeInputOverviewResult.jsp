...
<%
	...
	if (request.getParameter("codeMethod").equals("query")) {
		//modify by songjian 2011-11-15 10:41 暂不支持多选 
		//isQuery = true; 
		isQuery = false;
	}
...
<s:form name="fm" action="processCodeInputContinue" namespace="/common">
	<span id="cond" style="display:none">
		...
		<textarea name=totalCount><s:property value="totalCount" /></textarea>
		<textarea name=totalPage><s:property value="totalPage" /></textarea>
	...
	<table cellpadding="2" cellspacing="0" align="center"
		...
		<tr>
			<td width=50% align="center">
				<input class="btn1" type="button" name="SelectIt" value="<s:text name="button.determine.value"/>" <%--确定 --%>
					onclick='setFieldValue()' >
			--</td>
			<td width=50% align="center">
				<input name="CancelIt" class="btn1" type="button" value="<s:text name="button.cancel.value"/>" <%-- 取消--%>
...
function loadPage(){//pageNo页号 pageSize 一页数据条数 totalPage总共页数 totalCount总共数据条数
