					...
					<tbody>
						<tr>
							...
							<td class="input" style="width: 16%" style="align:center">
								<input type='input' name='prpLclaimLossItemCode' class="codecode" style="width: 30px" title="<s:text name='db.prpDlimit.itemCode'/>" ondblclick="claimLossItemCodeSelect(this,'policyItemKindCodeNoRisk','0,1,2,4,-2,-1','Y','Y',fm.policyno.value);"
								...
								<%--标的代码--%>
								<input type='input' name="prpLclaimLossItemName" class="codename" style="width: 150px" title="<s:text name='regist.prpLregist.itemName'/>"
					...
					<tbody>
						<c:forEach var="prpLclaimLoss" items="${claimDto.prpLclaimLossList}">
							<tr>
								...
								<td class="input" style="width: 16%" >
									<input readonly type="text" name="prpLclaimLossItemCode" class="codecode" style="width: 30px"  title="标的代码" value="${prpLclaimLoss.itemCode}">
									<input readonly type="text" name="prpLclaimLossItemName" class="codename" style="width: 150px" title="标的名称" value="${prpLclaimLoss.itemDetailName}">
