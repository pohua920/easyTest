					...
					<tbody>
						<tr>
							...
							<td class="input" style="width: 24%" >
								...
								<input type="text" name="prpLclaimLossKindCode" class="codecode" style="width: 50px" title="标的代码"
								...
								<input type="text" name="prpLclaimLossKindName" class="codename" style="width: 220px" title="标的名称"
							...
							<td class="input" style="width: 7%" align="center">
								<input type="text" class="input" name="prpLclaimLossKindRest" value="0">
							</td>
							<%-- 获得当前时间 --%>
							<td class="input" style="width: 10%" align="center">
				...
				<table class="common" style="width: 100%" id="ClaimLoss">
					<thead>
						...
						<tr>
							...
							<td class="centertitle" style="width: 24%">標的物</td>
							...
							<td class="centertitle" style="width: 7%">殘值</td>
						...
						<c:forEach var="prpLclaimLoss" items="${claimDto.prpLclaimLossList}">
							<tr>
								...
								<td class="input" style="width: 24%" >
									...
									<input type="hidden" name="prpLclaimLossItemName" value="${prpLclaimLoss.itemDetailName}">
									<input type="text" name="prpLclaimLossKindCode" class="codecode" style="width: 50px" title="标的代码" value="${prpLclaimLoss.kindCode}" > 
									<input type="text" name="prpLclaimLossKindName" class="codename" style="width: 220px" title="标的名称" value="${prpLclaimLoss.kindName}" >
								...
								<td class="input" style="width: 7%" align="center">
									<input readonly type="text" class="common" name="prpLclaimLossKindRest" value="<fmt:formatNumber value='${prpLclaimLoss.kindRest}' pattern='#'/>">
								</td>
								<td class="input" style="width: 10%" align="center">
