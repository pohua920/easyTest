...
<html lang="zh">
<head>
<title><s:text name="guarantee.sponsorshipPrintQuery" /></title>
<!-- 担保打印查询 -->
...
<body onload="">
	<form name="fm" action="/claim/guarantee.do?actionType=searchPrint" method="post">
		...
		<table>
			...
			<logic:iterate id="prpLclaimDto" name="claimList">
				<tr class=listodd>
					...
					<td align="center">
						<a href="/claim/guarantee.do?actionType=editPrint&prpLGuaranteeClaimNo=<bean:write name='prpLclaimDto' property="claimNo"/>"><bean:write name='prpLclaimDto' property="claimNo" /> </a>
					</td>
					<td align="center">
