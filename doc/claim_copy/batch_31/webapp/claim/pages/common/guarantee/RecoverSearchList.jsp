...
<html lang="zh">
<head>
<title><s:text name="guarantee.sponsorshipHandbackQuery" /></title>
<!-- 担保收回查询 -->
...
<body onload="">
	<form name="fm" action="/claim/guarantee.do?actionType=search" method="post">
		...
		<table>
			<tr>
				...
				<td align="center" class="centertitle" width="5%">
			...
			<logic:iterate id="prpLclaimDto" name="claimList">
				<tr class=listodd>
					...
					<td align="center">
						<a href="/claim/guarantee.do?actionType=recoverEdit&prpLGuaranteeClaimNo=<bean:write name='prpLclaimDto' property="claimNo"/>"><bean:write name='prpLclaimDto' property="claimNo" /> </a>
					</td>
					<td align="center">
					...
					<td align="center">
						<logic:equal name="prpLclaimDto" property="guaranteeFlag" value="1">
							<s:text name="guarantee.newDeal" />
						</logic:equal>
						<!-- 新处理 -->
						<logic:equal name="prpLclaimDto" property="guaranteeFlag" value="2">
							<s:text name="guarantee.waitChecked" />
						</logic:equal>
						<!-- 待审核 -->
						<logic:equal name="prpLclaimDto" property="guaranteeFlag" value="5">
							<s:text name="guarantee.return" />
						</logic:equal>
						<!-- 打回 -->
						<logic:equal name="prpLclaimDto" property="guaranteeFlag" value="4">
							<s:text name="guarantee.alreadyChecked" />
						</logic:equal>
						<!-- 已审核 -->
					</td>
				</tr>
