...
/**
 * POJO类PrpCmainCarGoSub
 */
@Entity
@Table(name = "PRPCMAINCARGOSUB")
public class PrpCmainCarGoSub implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 属性id */
	private PrpCmainCarGoSubId id;
	...
	/**
	 * 类PrpCmainCarGoSub的默认构造方法
	 */
	public PrpCmainCarGoSub() {
		this.id = new PrpCmainCarGoSubId();
	}

	public PrpCmainCarGoSub(String policyNo, Integer serialNo) {
		this.id = new PrpCmainCarGoSubId(policyNo, serialNo);
	}
	...
	public PrpCmainCarGoSubId getId() {
		return this.id;
	}
	 ...
	 * 属性id的setter方法
	 */
	public void setId(PrpCmainCarGoSubId id) {
		this.id = id;
	}
