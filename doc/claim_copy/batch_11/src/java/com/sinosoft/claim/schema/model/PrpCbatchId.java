...
/**
 * PrpcbatchId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCbatchId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCbatchId))
			return false;
		PrpCbatchId castOther = (PrpCbatchId) other;
