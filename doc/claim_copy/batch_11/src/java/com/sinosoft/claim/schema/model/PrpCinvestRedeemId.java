...
/**
 * PrpCinvestRedeemId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCinvestRedeemId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String policyNo;
	private Integer serialNo;

	public PrpCinvestRedeemId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCinvestRedeemId))
			return false;
		PrpCinvestRedeemId castOther = (PrpCinvestRedeemId) other;
