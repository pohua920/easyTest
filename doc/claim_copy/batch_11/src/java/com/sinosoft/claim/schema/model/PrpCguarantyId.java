...
/**
 * PrpCguarantyId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCguarantyId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String policyNo;
	private Integer serialNo;

	public PrpCguarantyId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCguarantyId))
			return false;
		PrpCguarantyId castOther = (PrpCguarantyId) other;
