...
/**
 * PrpCinsuredIdvListNatureId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCinsuredIdvListNatureId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String policyNo;
	private Integer serialNo;

	public PrpCinsuredIdvListNatureId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCinsuredIdvListNatureId))
			return false;
		PrpCinsuredIdvListNatureId castOther = (PrpCinsuredIdvListNatureId) other;
