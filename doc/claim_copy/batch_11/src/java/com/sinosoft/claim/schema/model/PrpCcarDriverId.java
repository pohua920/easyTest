 ...
 */
@Embeddable
public class PrpCcarDriverId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof PrpCcarDriverId)) {
			return false;
		}
		PrpCcarDriverId castOther = (PrpCcarDriverId) other;
