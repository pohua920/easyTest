...
public class PrpCitemKind implements java.io.Serializable {
	...
	/** 保額(amount)的選項-手動輸入/含於上項/不保 */
	private String perimeter;
	/** 保費(premium)的選項-手動輸入/含於上項/不保*/
	 ...
	 */
	@EmbeddedId
	@AttributeOverrides({ @AttributeOverride(name = "policyNo", column = @Column(name = "POLICYNO")), @AttributeOverride(name = "itemKindNo", column = @Column(name = "ITEMKINDNO")) })
	...
	public String getItemDetailName() {
		return DataUtils.nullToEmpty(this.itemDetailName);
	}
	...
	public void setDiscount(Double discount) {
		this.discount = discount == null ? 0d : discount;
	}
	...
	public void setAdjustRate(Double adjustRate) {
		this.adjustRate = adjustRate == null ? 0d : adjustRate;
	}
	...
	public void setPremium(Double premium) {
		this.premium = premium == null ? 0d : premium;
	}
