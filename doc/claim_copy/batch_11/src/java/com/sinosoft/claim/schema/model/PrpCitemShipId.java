...
/**
 * PrpCitemShipId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCitemShipId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String policyNo;
	private Integer itemNo;

	public PrpCitemShipId() {
	}

	public PrpCitemShipId(String policyNo, Integer itemNo) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCitemShipId))
			return false;
		PrpCitemShipId castOther = (PrpCitemShipId) other;
