 ...
 */
@Embeddable
public class PrpCmainLoanId implements java.io.Serializable {
	...
	/**
	 * 类PrpCmainLoanId的默认构造方法
	 */
	public PrpCmainLoanId() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof PrpCmainLoanId)) {
			return false;
		}
		PrpCmainLoanId castOther = (PrpCmainLoanId) other;
