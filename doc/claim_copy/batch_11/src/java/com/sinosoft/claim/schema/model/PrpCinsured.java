...
public class PrpCinsured implements java.io.Serializable {
	 ...
	 * 自然人信息
	 */
	private PrpCinsuredNature prpCinsuredNature;
	/** 是否不记名保单，1--不记名保单， */
	...
	@Transient
	public PrpCinsuredNature getPrpCinsuredNature() {
		return prpCinsuredNature;
	}

	public void setPrpCinsuredNature(PrpCinsuredNature prpCinsuredNature) {
		this.prpCinsuredNature = prpCinsuredNature;
	}
