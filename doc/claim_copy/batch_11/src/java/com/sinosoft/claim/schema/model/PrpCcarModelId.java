...
/**
 * PrpCcarModelId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCcarModelId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String policyNo;
	private Integer itemNo;

	public PrpCcarModelId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCcarModelId))
			return false;
		PrpCcarModelId castOther = (PrpCcarModelId) other;
