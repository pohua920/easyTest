 ...
 */
@Entity
@Table(name = "PRPCCARGOITEM")
public class PrpCCargoItem implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 属性id */
	private PrpCCargoItemId id;
	 ...
	 */
	@EmbeddedId
	@AttributeOverrides({ @AttributeOverride(name = "policyNo", column = @Column(name = "POLICYNO")), @AttributeOverride(name = "teamNo", column = @Column(name = "TEAMNO")), @AttributeOverride(name = "lineNo", column = @Column(name = "LINENO")) })
	public PrpCCargoItemId getId() {
		return this.id;
	}
	 ...
	 * 属性id的setter方法
	 */
	public void setId(PrpCCargoItemId id) {
		this.id = id;
	}
