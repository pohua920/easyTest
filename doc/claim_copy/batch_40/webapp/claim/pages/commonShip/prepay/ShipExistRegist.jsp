...
<span id="span_Peril_Context" style='width:800;display:none;position:absolute;background-color:FFFFFF;'> 
  <table class="prompt" style="width:400">
      <tr class="prompt">
        ...
        <td class="prompttitle"><s:text name="prpLregist.registNo" /></td><%--报案号--%>
        <!--原因：在界面上增加一些信息-->
        ...
        <td class="prompttitle"><s:text name="certainLoss.prpLcheck.prpLcheckDamageStartDate" /></td><%--出险时间--%>
        <!--
        <td class="prompttitle">联系人</td> 
        <td class="prompttitle">操作代码</td>
        <td class="prompttitle">操作人姓名</td> 
        -->
        <td class="prompttitle"><s:text name="certainLoss.prpLcheck.prpLcheckDamageAddress" /></td><%--出险地点--%>
        <td class="prompttitle"><s:text name="certainLoss.prpLcheck.prpLcheckDamageCase" /></td><%--出险原因--%>
