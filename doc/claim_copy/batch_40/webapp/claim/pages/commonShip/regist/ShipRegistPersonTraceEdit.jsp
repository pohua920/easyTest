							...
							<table cellpadding="5" cellspacing="1" class="common">
								...
								<tr>
									...
									<td class="input" colspan="5">
										<input type="hidden" name="prpLpersonTraceHospitalCode" style="width:150 px" class="input" description="就診醫院代碼"><%-- onkeyup="getHospital(this,'codeCode','0,1');" onblur="isHospital(this,'codeCode'); --%>
								...
								<table class="common" cellpadding="5" cellspacing="1">
									...
									<tr>
										...
										<td class="input" style="width:15%" colspan="5">
											<input type="hidden" name="prpLpersonTraceHospitalCode" style="width:150 px" class="input" description="就診醫院代碼" value="${personTrace.hospitalCode }">
