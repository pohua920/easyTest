...
<tr>
	<td class="subformtitle" colspan="6" cellspacing="1" cellpadding="0" style="text-align: left">
		...
		<s:text name="regist.IncreasesContact" /><%--增加联系人--%>
						...
						<td class="input" style='width: 4%' align="center">
							<div>
								<input type=button name="buttonThirdPropDelete"
									class="smallbutton" onclick="deleteRow(this,'ThirdProp')" value="-" style="cursor: hand">
							</div>
						</td>
					</tr>
				</tbody>
		...
		<span id="spanThirdProp" style="display: none" cellspacing="1" cellpadding="0"> <%-- 多行输入展现域 --%>
			<table class="common" style="width: 100%" id="ThirdProp">
				<thead>
					<tr>
						<td class="centertitle" style="width: 10%">
							<s:text name="db.prpLmedicine.serialNo" /> <%--序号--%>
						</td>
						<td class="centertitle" style="width: 15%">
							<s:text name="claim.name" /> <%--姓名--%>
						</td>
						<td class="centertitle" style="width: 15%">
							<s:text name="scheduleCompany.fixedTelephone" /><%--固定电话--%>
						</td>
						<td class="centertitle" style="width: 15%">
							<s:text name="regist.mobilePhones" />  <%--移动电话--%>
						</td>
				...
				<tfoot>
					<tr>
						<td class="title" colspan=5 style="width: 96%">
							<s:text name="prompt.schedule.addRename13" /><%--(按"+"号键增加联系人信息，按"-"号键删除信息)--%>
						</td>
						<td class="title" align="right" style="width: 4%">
							<div align="center">
								<input type="button" value="+" class="smallbutton"
									onclick="insertRow('ThirdProp')" name="buttonDriverInsert"
									style="cursor: hand">
							</div>
						</td>
					</tr>
				...
				<tbody>
					<c:if test="${prpLrelatePersonList!=null}">
						<c:forEach items="${prpLrelatePersonList}" var="prpLrelatePerson">
							<tr>
								<td class="input" style="width: 10%">
									<input name="prpLrelatePersonSeriaNo" class="readonly"
										readonly style="width: 75%" maxlength=3
										value="${prpLrelatePerson.id.serialNo}">
								</td>
								<td class="input" style="width: 15%">
								...
								<td class="input" style='width: 4%' align="center">
									<div>
										<input type=button name="buttonThirdPropDelete"
											class="smallbutton" onclick="deleteRow(this,'ThirdProp')"
