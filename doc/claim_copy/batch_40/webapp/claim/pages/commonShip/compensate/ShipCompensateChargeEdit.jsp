        ...
        <tr>
            ...
            <td class="input" style="width: 11%">
                <input type="text" name="prpLchargeKindName" class="codename" ondblclick="code_CodeSelect(this, 'PolicyKindCode','-1,0','Y','N',fm.policyno.value+'|'+fm.damageStartDate.value+'|'+fm.damageStartHour.value);"
                    ...
                    onkeyup="code_CodeSelect(this, 'PolicyKindCode','-1,0','Y','N',fm.policyno.value+'|'+fm.damageStartDate.value+'|'+fm.damageStartHour.value);" onblur="setChargeInput(this);">
            </td>
            ...
            <td class="input" style="width: 10%">
                <input type="text" name="prpLchargePayObjectName" class="codename" value="" ondblclick="clearPayment(this);getPayObject(this);" onchange="clearPayment(this);getPayObject(this);" onkeyup="clearPayment(this);getPayObject(this);" onblur="">
            </td>
            <td class="input" style="width: 8%">
                <input type="text" name="prpLchargeChargeReport" value="0" class="input" type="text">
            </td>
            <td class="input" align="center" style="width: 8%">
                <input type="text" name="prpLchargeChargeAmount" value="0" class="input" onchange="setChargeAmountNTD(this);">
            </td>
            <td class="input" align="center" style="width: 5%">
                <select name="prpLchargeCurrency" class="input" onchange="getPrpLchargeExchRate(this);">
            ...
            <td class="input" align="center" style="width: 8%">
                <input type="text" name="prpLchargeExchRate" readonly="readonly" value="1" class="input" onchange="setChargeAmountNTD(this);">
            </td>
            <td class="input" align="center" style="width: 8%">
            ...
            <td class="input" align="center" style="width: 3%">
                <input type="text" name="prpLchargeFeeSerialNo" class="input" maxlength="2" >
            </td>
            <td class="input" align="center" style="width: 3%">
            ...
            <td colspan="16" >
                <table class="common" style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td class="input" style="width: 18%" ><input type="text" name="prpLchargeBeneficiaryPhone" class="input" value="" style="width: 120px"/></td>
                        <td class="title" style="width: 15%" ></td>
                        <td class="input" style="width: 18%" ></td>
                    </tr>
                    <tr>
                    ...
                    <tr name="bankInfo">
                        ...
                        <td class="input" style="width: 18%">
                            <input type="text" name="prpLchargeBankCode" readOnly="readonly" class="readonly" value="">
                        </td>
                        <td class="title" style="width: 15%">总行名稱：</td>
                        <td class="input" style="width: 18%">
                            <input type="text" name="prpLchargeBankName" readOnly="readonly" class="readonly" value="">
                        </td>
                        <td class="title" style="width: 15%">匯款帳號：</td>
                        <td class="input" style="width: 18%">
                            <input type="text" name="prpLchargeAccountCode" readOnly="readonly" class="readonly" value="">
                        </td>
                    </tr>
                    <tr name="bankInfo">
                        <td class="title" style="width: 15%">分行代號：</td>
                        <td class="input" style="width: 18%">
                            <input type="text" name="prpLchargeCustomBankCode" readOnly="readonly" class="readonly" value="">
                        </td>
                        <td class="title" style="width: 15%">分行名稱：</td>
                        <td class="input" style="width: 18%">
                            <input type="text" name="prpLchargeCustomBankName" readOnly="readonly" class="readonly" value="">
                        </td>
                    ...
                    <!--  \claim\webapp\claim\pages\commonShip\compensate\ShipCompensateChargeEdit.jsp -->
                        <td class="title" style="width: 15%">郵遞區號：</td>
                        <td class="input" style="width: 18%">
                        	<!-- mantis：CLM0145，處理人員：DP0713，需求單編號：CLM0145，.新核心-理算任務處理賠付對象郵遞區號長度檢核 -->
                            <input type="text" class="input" name="prpLchargeAreaCode" maxlength="3" value="">
                            <img src="${ctx}/images/bgMarkMustInput.jpg" complete="complete" />
                        </td>
                ...
                <table class="common" style="width: 100%" id="Charge">
                    <thead>
                        <tr>
                            ...
                            <td class="centertitle" width="11%"><s:text name="certainLoss.prpLacciCheck.riskCName" /><%-- 险种名称 --%></td>
                    ...
                    <tbody>
                        <c:forEach var="chargedtox" items="${requestScope.prpLcharge.prpLchargeList}" varStatus="status">
                            <tr>
                                ...
                                <td class="input" style="width: 3%;">
                                    <input type="text" name="prpLchargeDangerNo" class="codecode" onClick="viewDangerUnitCompensateCharge(this);" onkeyup="viewDangerUnitCompensateCharge(this);" onchange="viewDangerUnitCompensateCharge(this);" value="${chargedtox.dangerNo}" style="width: 30px">
                                </td>
                                <td class="input" style="width: 5%">
                                    <input type="text" name="prpLchargeKindCode" class="codecode" ondblclick="code_CodeSelect(this, 'PolicyKindCode','0,1','Y','Y',fm.policyno.value+'|'+fm.damageStartDate.value+'|'+fm.damageStartHour.value);" style="width: 40px"
                                        onchange="code_CodeSelect(this, 'PolicyKindCode','0,1','Y','Y',fm.policyno.value+'|'+fm.damageStartDate.value+'|'+fm.damageStartHour.value);clearPrpLctextContextInnerHTML();"
                                        onkeyup="code_CodeSelect(this, 'PolicyKindCode','0,1','Y','Y',fm.policyno.value+'|'+fm.damageStartDate.value+'|'+fm.damageStartHour.value);" value="${chargedtox.kindCode}">
                                </td>
                                <td class="input" style="width: 11%">
                                    <input type="text" name="prpLchargeKindName" class="codename" ondblclick="code_CodeSelect(this, 'PolicyKindCode','-1,0','Y','N',fm.policyno.value+'|'+fm.damageStartDate.value+'|'+fm.damageStartHour.value);" style="width: 105px"
                                        onchange="code_CodeSelect(this, 'PolicyKindCode','-1,0','Y','N',fm.policyno.value+'|'+fm.damageStartDate.value+'|'+fm.damageStartHour.value);clearPrpLctextContextInnerHTML();"
                                        onkeyup="code_CodeSelect(this, 'PolicyKindCode','-1,0','Y','N',fm.policyno.value+'|'+fm.damageStartDate.value+'|'+fm.damageStartHour.value);" onblur="setChargeInput(this);" value="${chargedtox.kindName}">
                                </td>
                                <td class="input" align="center" style="width: 4%">
                                    <input type="text" name="prpLchargeChargeCode" class="codecode" ondblclick="clearPayObject(this);clearPayment(this);code_CodeSelect(this, 'ChargeCode','0,1','Y','N',fm.prpLcompensateRiskCode.value);" style="width: 40px"
                                        onkeyup="clearPayObject(this);clearPayment(this);code_CodeSelect(this, 'ChargeCode','0,1','Y','N',fm.prpLcompensateRiskCode.value);"
                                ...
                                <td class="input" align="center" style="width: 10%">
                                    <input type="text" name="prpLchargeChargeName" class="codename" ondblclick="clearPayObject(this);clearPayment(this);code_CodeSelect(this, 'ChargeCode','-1,0','Y','N',fm.prpLcompensateRiskCode.value);" style="width: 105px"
                                ...
                                <td class="input" style="width: 5%">
                                    ...
                                    <s:select name="prpLchargePayObjectType" value="#attr.tempSelectedValue" listKey="key" listValue="value" list="#request.payObjectTypeList" cssStyle="width: 55px"/>
                                </td>
                                <td class="input" style="width: 6%">
                                    <input type="text" name="prpLchargePayObjectCode" class="readonly" readonly value="${chargedtox.payObjectCode}" style="width: 50px">
                                </td>
                                <td class="input" style="width: 10%">
                                    <input type="text" name="prpLchargePayObjectName" class="codename" value="${chargedtox.payObjectName}" ondblclick="clearPayment(this);getPayObject(this);" onchange="clearPayment(this);getPayObject(this);" onkeyup="clearPayment(this);getPayObject(this);" style="width: 100px" >
                                </td>
                                <td class="input" style="width: 8%">
                                    <input type="text" name="prpLchargeChargeReport" value="<fmt:formatNumber value='${chargedtox.chargeReport}' pattern='#0.##'/>" class="input" style="width: 70px">
                                </td>
                                <td class="input" align="center" style="width: 8%">
                                    <input type="text" name="prpLchargeChargeAmount" value="<fmt:formatNumber value='${chargedtox.chargeAmount}' pattern='#0.##'/>" class="input" style="width: 70px" onchange="setChargeAmountNTD(this);">
                                </td>
                                <td class="input" align="center" style="width: 5%;">
                                ...
                                <td class="input" align="center" style="width: 8%">
                                    <input type="text" name="prpLchargeExchRate" readonly="readonly" value="${chargedtox.exchRate}" style="width: 70px" class="input" onchange="setChargeAmountNTD(this);">
                                </td>
                                <td class="input" align="center" style="width: 8%">
                                    <input type="text" name="prpLchargeChargeAmountNTD" class="common" readonly="readonly" value="0" style="width: 70px">
                                </td>
                                <td class="input" align="center" style="width: 3%;">
                                ...
                                <td colspan="16">
                                    <table class="common" style="width: 100%">
                                        ...
                                        <tr>
                                            ...
                                            <td class="title" style="width: 15%" ><s:text name="common.compensate.payeePhone"/>：</td>
                                            <td class="input" style="width: 18%" ><input type="text" name="prpLchargeBeneficiaryPhone" class="input" value="${prpLpayObject.beneficiaryPhone}" style="width: 120px"/></td>
                                            <td class="title" style="width: 15%" ></td>
                                            <td class="input" style="width: 18%" ></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <!-- mantis：CLM0145，處理人員：DP0713，需求單編號：CLM0145，.新核心-理算任務處理賠付對象郵遞區號長度檢核 -->
                                        <!--  \claim\webapp\claim\pages\commonShip\compensate\ShipCompensateChargeEdit.jsp 2-->
