            ...
            <td class="subformtitle" style="width: 96%">
                <table class="common" style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td class="input" style="width: 18%">
                            <input type="text"name="prpLpayObjectInfoPayAmount" class="readonly" readonly value="0" title="<s:text name='common.compensate.payAmount'/>" style="width: 80px;" />
                        </td>
                        <td class="title" style="width: 15%">支付幣別：</td>
                        <td class="input" style="width: 18%">
                            <select name="prpLpayObjectInfoAccountCurrency" class="common" style="width: 160px" onchange="getPrpLpayObjectInfoExchRate(this);">
                    ...
                    <tr>
                        ...
                        <td class="input" style="width: 18%">
                            <input type="text"name="prpLpayObjectInfoOwnerName" class="input" maxlength="120" value="${requestScope.prpLpayObjectInfo.ownerName}" style="width: 120px">
                            <img src="${ctx}/images/bgMarkMustInput.jpg">
                        </td>
                        <td class="title" style="width: 15%">賠付類型：</td>
                        <td class="input" style="width: 18%">
                            <s:select name="prpLpayObjectInfoPaymentKind" list="#request.shipPaymentKindList" listKey="key" listValue="value" headerKey="" headerValue=""></s:select>
                        ...
                        <td class="input" style="width: 18%">
                            <input type="text"name="prpLpayObjectInfoBeneficiaryPhone" class="input" value="" style="width: 120px"/>
                    ...
                    <tr>
                        ...
                        <td class="input" style="width: 18%">
                            <input type="text"name="prpLpayObjectInfoUniformNo" class="input" value="" style="width: 120px"/>
                        </td>
                        <td class="title" style="width: 15%">
                    ...
                    <tr name="bankInfo">
                        ...
                        <td class="input" style="width: 18%">
                            <input type="text"name="prpLpayObjectInfoBankCode" value="" readOnly="readonly" class="readonly" />
                        </td>
                        <td class="title" style="width: 15%">
                        ...
                        <td class="input" style="width: 18%">
                            <input type="text"name="prpLpayObjectInfoBankName" value="" readOnly="readonly" class="readonly">
                        </td>
                        <td class="title" style="width: 15%">
                            <s:text name="common.compensate.accountCode" />：<%--汇款账号--%>
                        </td>
                        <td class="input" style="width: 18%">
                            <input type="text"name="prpLpayObjectInfoAccountCode" value="" readOnly="readonly" class="readonly">
                        </td>
                    </tr>
                    <tr name="bankInfo">
                        <td class="title" style="width: 15%">
                        ...
                        <td class="input" style="width: 18%">
                            <input type="text"name="prpLpayObjectInfoCustomBankCode" value="" readOnly="readonly" class="readonly">
                        </td>
                        <td class="title" style="width: 15%">
                            <s:text name="common.compensate.customBankName" />：<%--分行名称--%>
                        </td>
                        <td class="input" style="width: 18%">
                            <input type="text"name="prpLpayObjectInfoCustomBankName" value="" readOnly="readonly" class="readonly">
                        </td>
                    ...
                    <tr name="AreaInfo">
                    	...
                    	<!--  \webapp\claim\pages\commonShip\compensate\EditPrpdpaymentaccountPage.jsp -->
                        <td class="title" style="width: 15%">
                            <s:text name="common.compensate.areaCode" />：<%--邮递区号--%>
                        </td>
                        <td class="input" style="width: 18%">
                        	<!-- mantis：CLM0145，處理人員：DP0713，需求單編號：CLM0145，.新核心-理算任務處理賠付對象郵遞區號長度檢核 -->
                            <input type="text"name="prpLpayObjectInfoAreaCode" class="input" style="width: 120px" maxlength="3">
                            <img src="${ctx}/images/bgMarkMustInput.jpg" complete="complete" />
                        </td>
                        <td class="title" style="width: 15%">
                        ...
                        <td class="input" style="width: 50%" colspan="3">
                            <input type="text"name="prpLpayObjectInfoCourierAddress" class="input" style="width: 80%">
                            <img src="${ctx}/images/bgMarkMustInput.jpg" complete="complete" />
                        </td>
                    </tr>
                    <tr name="PayDate" style="display: none">
                        ...
                        <td class="input" style="width: 18%">
                            <input type="text"name="prpLpayObjectInfoMobilePhoneNo" class="input">
                        </td>
                                ...
                                <td class="subformtitle" style="width: 96%">
                                    <table class="common" style="width: 100%">
                                        ...
                                        <tr>
                                            ...
                                            <td class="input" style="width: 18%">
                                                <input type="text"name="prpLpayObjectInfoPayAmount" class="readonly" readonly value="<fmt:formatNumber value="${prpLpayObject.payAmount}" pattern="#.##"/>" 
                                        ...
                                        <tr>
                                            ...
                                            <td class="input" style="width: 18%">
                                                <input type="text"name="prpLpayObjectInfoOwnerName" class="input" maxlength="120" value="${prpLpayObject.ownerName}" style="width: 120px">
                                                <img src="${ctx}/images/bgMarkMustInput.jpg">
                                            </td>
                                            <td class="title" style="width: 15%">賠付類型：</td>
                                            <td class="input" style="width: 18%">
                                            ...
                                            <td class="input" style="width: 18%">
                                                <input type="text"name="prpLpayObjectInfoBeneficiaryPhone" class="input" value="${prpLpayObject.beneficiaryPhone}" style="width: 120px"/>
                                                <img src="${ctx}/images/bgMarkMustInput.jpg" complete="complete" name="BeneficiaryPhoneIMG" />
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="title" style="width: 15%">證件號碼：</td>
                                            <td class="input" style="width: 18%">
                                                <input type="text"name="prpLpayObjectInfoUniformNo" class="input" value="${prpLpayObject.uniformNo}" style="width: 120px"/>
                                            </td>
                                            <td class="title" style="width: 15%">
                                        ...
                                        <tr name="bankInfo" <c:if test="${prpLpayObject.ownerShip!='B'}">style="display:none;"</c:if>>
                                            ...
                                            <td class="input" style="width: 18%">
                                                <input type="text"name="prpLpayObjectInfoBankCode" readOnly="readonly" class="readonly" value="${prpLpayObject.bankCode}" />
                                            </td>
                                            <td class="title" style="width: 15%">
                                                <s:text name="common.compensate.bankName" />：<%--总行名称--%>
                                            </td>
                                            <td class="input" style="width: 18%">
                                                <input type="text"name="prpLpayObjectInfoBankName" readOnly="readonly" class="readonly" value="${prpLpayObject.bankName}">
                                            </td>
                                            <td class="title" style="width: 15%">
                                                <s:text name="common.compensate.accountCode" />：<%--汇款账号--%>
                                            </td>
                                            <td class="input" style="width: 18%">
                                                <input type="text"name="prpLpayObjectInfoAccountCode" readOnly="readonly" class="readonly" value="${prpLpayObject.accountCode}">
                                            </td>
                                        </tr>
                                        <tr name="bankInfo" <c:if test="${prpLpayObject.ownerShip!='B'}">style="display:none;"</c:if>>
                                            <td class="title" style="width: 15%">
                                            ...
                                            <td class="input" style="width: 18%">
                                                <input type="text"name="prpLpayObjectInfoCustomBankCode" readOnly="readonly" class="readonly" value="${prpLpayObject.customBankCode}">
                                            </td>
                                            <td class="title" style="width: 15%">
                                                <s:text name="common.compensate.customBankName" />：<%--分行名称--%>
                                            </td>
                                            <td class="input" style="width: 18%">
                                                <input type="text"name="prpLpayObjectInfoCustomBankName" readOnly="readonly" class="readonly" value="${prpLpayObject.customBankName}">
                                            </td>
                                            <td class="title" style="width: 33%" colspan="2" align="center">
                                                <!-- 录入赔款支付帳户信息 -->
                                                <input class='bigbutton' type='button' name='buttonAccCompensate' style="width: 180px;" value='<s:text name="button.inputPaymentInformation.value" />' onclick="queryUserCompensate(this);">
                                        ...
                                        <tr name="AreaInfo" <c:if test="${prpLpayObject.ownerShip=='C'}">style="display:none"</c:if>>
                                           	<!-- mantis：CLM0145，處理人員：DP0713，需求單編號：CLM0145，.新核心-理算任務處理賠付對象郵遞區號長度檢核 -->
                                            <!--  \webapp\claim\pages\commonShip\compensate\EditPrpdpaymentaccountPage.jsp 2-->
                                            <td class="title" style="width: 15%">
                                                <s:text name="common.compensate.areaCode" />：<%--邮递区号--%>
                                            </td>
                                            <td class="input" style="width: 18%">
                                            	<!-- mantis：CLM0145，處理人員：DP0713，需求單編號：CLM0145，.新核心-理算任務處理賠付對象郵遞區號長度檢核 -->
                                                <input type="text"name="prpLpayObjectInfoAreaCode" class="input" value="${prpLpayObject.areaCode}" style="width: 120px" maxlength="3"/>
                                                <img src="${ctx}/images/bgMarkMustInput.jpg" complete="complete" />
                                            </td>
                                            <td class="title" style="width: 15%">
                                                <s:text name="common.compensate.courierAddress" />：<%--邮递地址--%>
                                            ...
                                            <td class="input" style="width: 50%" colspan="3">
                                                <input type="text"name="prpLpayObjectInfoCourierAddress" class="input" value="${prpLpayObject.courierAddress}" style="width: 80%">
                                                <img src="${ctx}/images/bgMarkMustInput.jpg" complete="complete" />
                                            </td>
                                        </tr>
                                        <tr name="PayDate" <c:if test="${prpLpayObject.ownerShip!='C'}">style="display:none"</c:if>>
                                            ...
                                            <td class="input" style="width: 18%">
                                                <input type="text"name="prpLpayObjectInfoMobilePhoneNo" class="input" value="${prpLpayObject.mobilePhoneNo}" style="width: 120px">
                                            </td>
                                            <td class="title" style="width: 15%"></td>
                                            <td class="input" style="width: 18%"></td>
                                        </tr>
