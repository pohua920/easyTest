...
<script language="javascript">
    ...
    function prpLlossItemCodeSelect(field, codeType, codeRelation, isClear, isQueryCode, otherCondition){
        ...
        otherCondition += '|'+fm.damageStartDate.value+'|'+fm.damageStartHour.value+'|'+fm.prpLclaimEndorseNo.value;
        code_CodeSelect(field, codeType, codeRelation, isClear, isQueryCode, otherCondition);
    }
</script>
                ...
                <table class="common" cellpadding="0" cellspacing="1" style="width: 100%">
                    <tbody>
                        <tr>
                            ...
                            <td class="input">
                                <input type="text" name="prpLlossDtoKindCode" class="codecode" style="width: 50px" 
                                    ondblclick="prpLlossKindCodeSelect(this, 'PolicyKindCode','0,1,2','Y','Y',fm.policyno.value+'|'+fm.damageStartDate.value+'|'+fm.damageStartHour.value+'|'+fm.prpLclaimEndorseNo.value);" 
                                    onchange="prpLlossKindCodeSelect(this, 'PolicyKindCode','0,1,2','Y','Y',fm.policyno.value+'|'+fm.damageStartDate.value+'|'+fm.damageStartHour.value+'|'+fm.prpLclaimEndorseNo.value);" 
                                    onkeyup="prpLlossKindCodeSelect(this, 'PolicyKindCode','0,1,2','Y','Y',fm.policyno.value+'|'+fm.damageStartDate.value+'|'+fm.damageStartHour.value+'|'+fm.prpLclaimEndorseNo.value);"/>
                                <input type="text" name=prpLlossDtoKindName class="codename" style="width: 150px"
                                    ondblclick="prpLlossKindCodeSelect(this, 'PolicyKindCode','-1,0,1','Y','N',fm.policyno.value+'|'+fm.damageStartDate.value+'|'+fm.damageStartHour.value+'|'+fm.prpLclaimEndorseNo.value);" 
                                    onkeyup="prpLlossKindCodeSelect(this, 'PolicyKindCode','-1,0,1','Y','N',fm.policyno.value+'|'+fm.damageStartDate.value+'|'+fm.damageStartHour.value+'|'+fm.prpLclaimEndorseNo.value);" 
                                    onchange="prpLlossKindCodeSelect(this, 'PolicyKindCode','-1,0,1','Y','N',fm.policyno.value+'|'+fm.damageStartDate.value+'|'+fm.damageStartHour.value+'|'+fm.prpLclaimEndorseNo.value);">
                        ...
                        <tr>
                            ...
                            <td class="input">
                                <input type="text" name="prpLlossDtoAmount" value="0" class='readonly' readonly style="width: 120px">
                            </td>
                            <td class="title">保險價值：</td>
                            <td class="input">
                                <input name="prpLlossDtoItemValue" type="text" class="common" style="width: 120px" value="0" >
                            </td>
                        </tr>
                        <tr>
                            <td class="title">核定幣別：</td>
                            <td class="input">
                                <input type="text" name="Currency" class="readonly" readonly="readonly" value="<%=ConstantCodes.LOCAL_CURRENCY%>" style="width: 40px">
                        ...
                        <tr>
                            <td class="title"><s:text name="claim.salvage" />：<%-- 残值 --%></td>
                            <td class="input">
                                <input type="text" name="prpLlossDtoSumRest" class="input" value="0" onchange="calRealpay(this);" style="width: 120px">
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="input"><input type="text" readonly="readonly" name="prpLlossDtoExchRate" value="1" class='input' style="width: 120px" onchange="calRealpay(this);"></td>
                        ...
                        <tr>
                            ...
                            <td class="input"><input type="text" name="prpLlossDtoSumRealPayNTD" class="common" value="0" style="width: 120px" readonly="readonly"></td>
...
<table class="common" align="center">
    <tr>
        <td class="common" style="text-align: left">
            ...
            <b><s:text name="compensate.dubang.payMarkInfo" /></b><br><%-- 赔付标的信息 --%>
            <span id="spanlLoss" style="display: none">
                <table id="lLoss" class="common" align="center" cellspacing="1" cellpadding="3">
                    <thead>
                        <tr>
                            <td class="centertitle" style="width: 4%" align="center">序號</td>
                            <td class="centertitle" style="width: 92%" align="center">內容</td>
                            <td class="centertitle" style="width: 4%" align="center">操作</td>
                            
                        </tr>
                    </thead>
                    <tfoot>
                        <tr>
                            <td class="common" colspan="2" style="width: 96%">（按“+”號鍵增加賠付標的訊息，按“-”號刪除訊息）</td>
                            <td class="common" align="right" style="width: 4%">
                                <div align="center">
                                    ...
                                    <table cellpadding="0" cellspacing="1" class="common" style="width: 100%">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="title"><s:text name="undwrt.Risks" />：<%-- 险别 --%></td>
                                                <td class="input">
                                                    <input type="text" name="prpLlossDtoKindCode" class="codecode" value="${tempPrpLloss.kindCode}" style="width: 50px" 
                                                        ondblclick="prpLlossKindCodeSelect(this, 'PolicyKindCode','0,1,2','Y','Y',fm.policyno.value+'|'+fm.damageStartDate.value+'|'+fm.damageStartHour.value+'|'+fm.prpLclaimEndorseNo.value);" 
                                                        onchange="prpLlossKindCodeSelect(this, 'PolicyKindCode','0,1,2','Y','Y',fm.policyno.value+'|'+fm.damageStartDate.value+'|'+fm.damageStartHour.value+'|'+fm.prpLclaimEndorseNo.value);" 
                                                        onkeyup="prpLlossKindCodeSelect(this, 'PolicyKindCode','0,1,2','Y','Y',fm.policyno.value+'|'+fm.damageStartDate.value+'|'+fm.damageStartHour.value+'|'+fm.prpLclaimEndorseNo.value);"/>
                                                    <input type="text" name=prpLlossDtoKindName class="codename" style="width: 120px" value="${tempPrpLloss.kindName}" style="width: 150px" 
                                                        ondblclick="prpLlossKindCodeSelect(this, 'PolicyKindCode','-1,0,1','Y','N',fm.policyno.value+'|'+fm.damageStartDate.value+'|'+fm.damageStartHour.value+'|'+fm.prpLclaimEndorseNo.value);" 
                                                        onkeyup="prpLlossKindCodeSelect(this, 'PolicyKindCode','-1,0,1','Y','N',fm.policyno.value+'|'+fm.damageStartDate.value+'|'+fm.damageStartHour.value+'|'+fm.prpLclaimEndorseNo.value);" 
                                                        onchange="prpLlossKindCodeSelect(this, 'PolicyKindCode','-1,0,1','Y','N',fm.policyno.value+'|'+fm.damageStartDate.value+'|'+fm.damageStartHour.value+'|'+fm.prpLclaimEndorseNo.value);" >
                                            ...
                                            <tr>
                                                ...
                                                <td class="title">保險價值：</td>
                                                <td class="input">
                                                    <input name="prpLlossDtoItemValue" type="text" class="common" value="<fmt:formatNumber value='${tempPrpLloss.itemValue}' pattern='#'/>" style="width: 120px">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="title">核定幣別：</td>
                                                <td class="input">
                                                    <input type="text" name="Currency" class="readonly" value="<%=ConstantCodes.LOCAL_CURRENCY%>" style="width: 40px">
                                                    <input type="text" name="CurrencyName" class="readonly" readonly value="<%=ConstantCodes.LOCAL_CURRENCYNAME%>" style="width: 80px">
                                                </td>
                                                <td class="title"></td>
                                                <td class="input"></td>
                                            ...
                                            <tr>
                                                <td class="title"><s:text name="claim.salvage" />：<%-- 残值 --%></td>
                                                <td class="input">
                                                    <input type="text" name="prpLlossDtoSumRest" class="input" value="<fmt:formatNumber value='${tempPrpLloss.sumRest}' pattern='#0.##'/>" onchange="calRealpay(this);" style="width: 120px">
                                                </td>
                                                <td class="title">賠付幣別：</td>
                                                <td class="input">
                                                    <select name="prpLlossDtoCurrency" class="input" style="width: 180px" onchange="getPrpLlossDtoExchRate(this);">
                                            ...
                                            <tr>
                                                <td class="title">匯率：</td>
                                                <td class="input"><input type="text" readonly="readonly" name="prpLlossDtoExchRate" value="${tempPrpLloss.exchRate}" style="width: 120px" class="input" onchange="calRealpay(this);"></td>
                                                <td class="title"><s:text name="db.prpLloss.sumRealpay" />：<%-- 賠償金額  赔付币别对应的赔偿金额，存在原核定赔偿字段 --%></td>
                                                <td class="input"><input type="text" name="prpLlossDtoSumRealPay" value="<fmt:formatNumber value='${tempPrpLloss.sumRealPay}' pattern='#0.##'/>" class="common" onchange="calRealpay(this);" style="width: 120px" readonly="readonly"></td>
                                            </tr>
                                            <tr>
                                                <td class="title"><s:text name="db.prpLloss.sumRealpay" />（NTD）：<%-- 賠償金額 --%></td>
