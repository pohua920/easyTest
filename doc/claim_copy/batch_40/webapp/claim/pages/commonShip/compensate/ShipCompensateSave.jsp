    ...
    <table id="buttonArea" cellpadding="0" cellspacing="0" width="80%" style="display:">
      ...
      <tr>
             ...
             */%>
              ...
              <%@include file="/common/sendUndwrt/SendUndwrtButton.jsp"%>
            </logic:notEqual>
             ...
             <td class=button  align="center">
              <!--放弃按钮style="width:33%"-->
             <input type=button name=buttonGiveup class='button' value="<s:text name='button.giveUpTask.value' />" onclick="taskGiveup();" ><%--放弃任务--%>
             </td>
             <%
             }
              %>       
