...
public class ValueStackDataSource implements JRDataSource {
	 ...
	 *            get the value of the field is either taken from the
	 *            description property or from the name of the field if the
	 ...
	 *         evaluates to an object that can be iterated over.
	 ...
	 * @throws JRException if there is a problem determining whether there is
	 *             more data
	 */
