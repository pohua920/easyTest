package com.tlg.commons.util.api.rest.blockChain;
...
import com.tlg.commons.util.api.rest.blockChain.util.ConfigUtil;
import com.tlg.commons.util.api.rest.blockChain.util.TokenUtil;
import com.tlg.commons.util.api.rest.blockChain.vo.CompulsoryCreateResultVo;
import com.tlg.commons.util.api.rest.blockChain.vo.CompulsoryUpdateResultVo;
import com.tlg.commons.util.api.rest.blockChain.vo.CompulsoryUpdateVo;

//mantis：CLM0277 ，處理人員： DP0713 ，需求單編號：理算任務串聯區塊鏈API3.10同業確認+API3.5建立理賠單
public class CompulsoryCaseApportions314 {
	
	private static final Logger log = LoggerFactory.getLogger(CompulsoryCaseApportions314.class);
	
	/**
	 * 
	 * /compulsory/cases/apportions/{apportion_id}/cancel [v1.0.13]開放讓個別非結案狀態攤次均可撤回，不限於只能撤回最後一筆
	 * 
	 ...
	 * @throws Exception
	 */
	public CompulsoryCreateResultVo compulsoryUpdate(CompulsoryUpdateVo compulsoryUpdateVo, String userCode) throws Exception{
		CompulsoryCreateResultVo compulsoryCreateResultVo = new CompulsoryCreateResultVo();

		final String ip = ConfigUtil.getIp();
		String httpURL = "http://" + ip + "/api/v1/compulsory/cases/apportions/" + compulsoryUpdateVo.getCaseId()+"/cancel";
...
//			String jsonInputString = "{\"applicant\":{\"applicant_id_number_type\":\"ID_NUMBER\",\"applicant_id_number\":\"A123456789\",\"applicant_birthday\":\"099-01-01\",\"applicant_name\":\"受害者\"},\"apportion\":{\"amount\":15986,\"health_insurance_apportion\":false,\"responsibility_type\":\"RT2\",\"loss_reason\":\"LR13\",\"loss_city\":\"LC11\",\"state_prices\":[{\"type\":\"MEDICAL\",\"amount\":120000,\"code\":\"C13\"}],\"vehicle_payload_capacity_unit\":\"PERSON\",\"vehicle_payload_capacity\":5,\"vehicle_type\":\"VT03\",\"recovery_item\":\"RI02\",\"driver_name\":\"駕駛人\",\"health_insurance\":false,\"other_responsibility_rate\":0,\"applicant_responsibility_rate\":0,\"responsibility_rate\":0,\"insurance_number\":\"180024AB123546789\",\"insurance_car_number\":\"TESE-123\"},\"case\":{\"applicant_role\":\"AR1\",\"police_name\":\"測試警察\",\"police_unit\":\"測試警察局\",\"hit_road\":\"測試路\",\"in_car_number\":\"TEST-123\",\"hit_time\":\"2024-01-01T21:41:31.000Z\",\"applicant_type\":\"PASSENGER\",\"case_number\":\"TEST123456789\"}}";
			...
			try(BufferedReader br = new BufferedReader(new InputStreamReader(con.getInputStream(), "utf-8"))) {
				...
				try{
					...
					throw new Exception("撤回攤回案件時發生錯誤：" + e.getMessage());
				}
			}
		}catch (Exception e) {
			e.printStackTrace();
