...
import com.tlg.commons.util.api.rest.blockChain.enums.EnumApplicantRole;
...
public class CompulsoryUpdateCaseVo {
	...
	public boolean equals(java.lang.Object o) {
		...
		CompulsoryUpdateCaseVo compulsoryUpdateCaseVo = (CompulsoryUpdateCaseVo) o;
		return Objects.equals(this.applicantRole, compulsoryUpdateCaseVo.applicantRole)
				&& Objects.equals(this.policeName, compulsoryUpdateCaseVo.policeName)
				&& Objects.equals(this.policeUnit, compulsoryUpdateCaseVo.policeUnit)
				&& Objects.equals(this.hitRoad, compulsoryUpdateCaseVo.hitRoad)
				&& Objects.equals(this.inCarNumber, compulsoryUpdateCaseVo.inCarNumber)
				&& Objects.equals(this.applicantType, compulsoryUpdateCaseVo.applicantType)
				&& Objects.equals(this.caseNumber, compulsoryUpdateCaseVo.caseNumber);
	}

	@Override
	public int hashCode() {
		return Objects.hash(applicantRole, policeName, policeUnit, hitRoad,
				inCarNumber, applicantType, caseNumber);
	}

	@Override
	public String toString() {
		StringBuilder sb = new StringBuilder();
		sb.append("class CompulsoryUpdateCaseVo {\n");
