...
* MODIFYLIST ：财产定损节点的工作流任务查询 (用于显示待处理、正处理、已处理、退回财产定损、注销拒赔任务 查询介面的查询结果)
*          ------------------------------------------------------
****************************************************************************/
--%>
...
<table class="common" cellpadding="5" cellspacing="1">
    <tr>
        <td colspan=12 class="formtitle">${pageScope.strTitle}<s:text name="prompt.CertainLoss.enterLeast" /><%-- 財產定損訊息--%></td>
    </tr>
    <tr>
