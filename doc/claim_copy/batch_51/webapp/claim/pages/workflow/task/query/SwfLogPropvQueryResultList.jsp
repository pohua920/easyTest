...
* MODIFYLIST ：财产核损节点的工作流任务查询 (用于显示待处理、正处理、已处理核损任务、注销拒赔任务 查询介面的查询结果)
*          ------------------------------------------------------
****************************************************************************/
--%>
...
<table class="common" cellpadding="5" cellspacing="1">
    <tr>
        <td colspan=12 class="formtitle">${pageScope.strTitle}<s:text name="prompt.verifyLoss.enterLeast" /><%-- 財產核損訊息--%></td>
    </tr>
    <tr>
