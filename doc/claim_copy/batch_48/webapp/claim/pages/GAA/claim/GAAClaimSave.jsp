<script language='javascript'>
	...
	function printWindow(registNo, strWindowName) {
		...
		alert(i18n.prompt.noDevelopment);
		return false;
...
<table id="buttonArea" cellpadding="0" cellspacing="0" width="80%" style="display:">
	...
	<tr>
		<td>
			<input type="hidden" name="print" class='bigbutton' value="<s:text name='button.printInsClaimInfo.value'/>" onclick="printWindow('${prpLclaimDto.registNo}', '<s:text name='common.check.print'/>');"><%--列印1--%>
			<%-- 列印承保理赔信息 --%>
		</td>
