...
<script src="/claim/commonprop/certainLoss/js/PropCertainLossEdit.js"></script>
<script src="/claim/commonprop/certainLoss/js/PropCertainLossPersonEdit.js"></script>
...
<body class="interface" onload="initPage();initSet();">
	...
	<form name="fm" action="/claim/certainLossSave.do" method="post" onsubmit="return validateForm(this);">
		...
		<%-- 2.人员伤亡清单页面 --%>
		<%
			//@include file="/commonProp/certainLoss/PropCertainLossPersonEdit.jsp"
		%>
		<%-- 3.财产损失清单页面 --%>
		...
		<%@include file="/commonProp/certainLoss/PropCertainLossPrint.jsp"%>
