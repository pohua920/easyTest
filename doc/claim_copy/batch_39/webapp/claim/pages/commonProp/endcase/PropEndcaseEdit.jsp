...
<script src="${ctx}/pages/commonProp/endcase/js/PropEndcaseEdit.js"></script>
		...
		<mpc:container ID="oMPC">
			<mpc:page ID="tabMain" TABTITLE="<s:text name='regist.prpLregist.registMain'/>" TABTEXT="<s:text name='regist.prpLregist.registMain'/> "><%--基本讯息--%>
				<CENTER>
					<DIV name="tabMain" class="tabMain">
						<!-- 1.结案主信息 -->
						<%@include file="/pages/commonProp/endcase/PropEndcaseMainEdit.jsp"%>
					</DIV>
				</CENTER>
			</mpc:page>
			<mpc:page ID="tabMain" TABTITLE="<s:text name='db.prpLltext.text2'/>" TABTEXT="<s:text name='db.prpLltext.text2'/>"><%--结案报告--%>
				<CENTER>
					<DIV name="tabMain" class="tabMain">
						<!-- 4.结案文本信息 -->
						<%@include file="/pages/commonProp/endcase/PropEndcaseTextEdit.jsp"%>
					</DIV>
				</CENTER>
			</mpc:page>
		</mpc:container>
		<TABLE id="btnCommon" class="common">
			<TR>
				<TD align="center">
					<c:if test="${param.editTypeOther!='SHOWTASK'}">
						<!-- 保存通用按钮 -->
						<%@include file="/pages/commonProp/endcase/PropEndcaseSave.jsp"%>
					</c:if>
				</TD>
			</TR>
		</TABLE>
