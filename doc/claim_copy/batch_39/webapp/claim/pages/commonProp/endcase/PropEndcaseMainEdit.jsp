			...
			<table class=common cellpadding="0" cellspacing="1" width="100%">
				...
				<tr>
					...
					<td class="right" colspan="2">
						...
						<%--- 日 0 时 至 --%>
						<%--- 日 24 时止 --%>
						<rc:rcDate name="prpLendcaseStartDate" class="readonly" readonly="true" wdatePicker="false" style="width:80px" value="${prpLclaim.startDate}" />${startHour}
						<rc:rcDate name="endDate" class="readonly" readonly="true" wdatePicker="false" style="width:80px" value="${prpLclaim.endDate}" />${endHour}
					</td>
					<td class="left">
