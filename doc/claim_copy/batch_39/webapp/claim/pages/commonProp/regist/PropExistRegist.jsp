...
<input title="點選此處可獲得已出險相關信息" type=button ACCESSKEY="." value='...' class="smallbutton" name='button_Peril_Open_Context' onclick="buttonOnClick('perilInfoShow',fm.policyno.value,fm.registno.value);">
	...
	<table class="prompt" style="width: 400">
		...
		<tr>
			<td colspan=14 class="prompttitle">
				<input type=button name='button_Peril_Close_Context' value="<s:text name='button.close.value' />" class="button" ACCESSKEY="O" onclick="hideSubPage(this,'span_Peril_Context')">
			</td>
		</tr>
	</table>
</span>
