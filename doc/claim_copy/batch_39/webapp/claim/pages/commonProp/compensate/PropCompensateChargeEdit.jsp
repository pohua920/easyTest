...
<script language='javascript'>
	...
	function setPrpLchargeSerialNo() {
		$(":input[name='prpLchargeSerialNo']").each(function(i,n){
			n.value = i;
		});
	}
</script>
					...
					<tr>
						<td>
							<table class=common style="display: none" id="Charge_Data" cellpadding="0" cellspacing="1" width="100%" name="chargeObject">
								<tbody>
									<tr name="prpLchargeObject">
										<td class="input" style="width: 3%">
											<input type="text" name="prpLchargeSerialNo" description="<s:text name='regist.prpLregist.serialNo'/>" class="readonly" readonly><%--序号--%>
											<input type="hidden" name="prpLchargeSumRealPay" value="0">
										</td>
										<td class="input" style="width: 3%">
											<input type="text" name="prpLchargeDangerNo" class="codecode" value="1" onClick="viewDangerUnitCompensateCharge(this);" onkeyup="viewDangerUnitCompensateCharge(this);"
												onchange="viewDangerUnitCompensateCharge(this);">
										</td>
										<td class="input" style="width: 4.5%">
											<input type="text" name="prpLchargeKindCode" class="codecode" ondblclick="code_CodeSelect(this, 'PolicyKindCode','0,1','Y','Y',fm.policyno.value+'|'+fm.damageStartDate.value+'|'+fm.damageStartHour.value);"
										...
										<td class="input" style="width: 10%">
											<input type="text" name="prpLchargeKindName" class="codename" ondblclick="code_CodeSelect(this, 'PolicyKindCode','-1,0','Y','N',fm.policyno.value+'|'+fm.damageStartDate.value+'|'+fm.damageStartHour.value);"
												...
												onkeyup="code_CodeSelect(this, 'PolicyKindCode','-1,0','Y','N',fm.policyno.value+'|'+fm.damageStartDate.value+'|'+fm.damageStartHour.value);" onblur="calChargeAmount(this);">
										</td>
										<td class="input" align="center" style="width: 4.5%">
											<input type="text" name="prpLchargeChargeCode" class="codecode" style="width: 95%"
												...
												onchange="clearPayObject(this);clearPayment(this);code_CodeChange(this,'ChargeCode','0,1','Y','Y',fm.prpLcompensateRiskCode.value);" onblur="calChargeAmount(this);checkBeyondQuota(this);">
										</td>
										<td class="input" align="center" style="width: 10%">
											<input type="text" name="prpLchargeChargeName" class="codename" style="width: 95%"
												ondblclick="clearPayObject(this);clearPayment(this);code_CodeSelect(this, 'ChargeCode','-1,0','Y','N',fm.prpLcompensateRiskCode.value);"
												onkeyup="clearPayObject(this);clearPayment(this);calChargeAmount(this);checkBeyondQuota(this);code_CodeSelect(this, 'ChargeCode','-1,0','Y','N',fm.prpLcompensateRiskCode.value);"
												onchange="clearPayObject(this);clearPayment(this);code_CodeChange(this, 'ChargeCode','-1,0','Y','N',fm.prpLcompensateRiskCode.value);" onblur="calChargeAmount(this);checkBeyondQuota(this);">
										</td>
										<td class="input" style="width: 5.5%">
										...
										<td class="input" style="width: 6%">
											<input type="text" name="prpLchargePayObjectCode" class="readonly" readonly style="width: 100%" value="">
										</td>
										<td class="input" style="width: 10%">
											<input type="text" name="prpLchargePayObjectName" class="codename" style="width: 100%" value="" ondblclick="clearPayment(this);getPayObject(this);" onchange="clearPayment(this);getPayObject(this);"
												onkeyup="clearPayment(this);getPayObject(this);" onblur="">
										</td>
										<td class="input" style="width: 8%">
											<input type="text" name="prpLchargeChargeReport" class="input" onchange="calChargeAmount(this);checkBeyondQuota(this);">
										</td>
										<td class="input" align="center" style="width: 8%">
											<input type="text" name="prpLchargeChargeAmount" class="input"  style="width: 95%" onchange="calChargeAmount(this);checkBeyondQuota(this);" onblur="isSameKindCode()">
										</td>
										<td class="input" align="center" style="width: 5.5%">
											<select name="prpLchargeCurrency" class="input" style="width: 100%" onchange="getPrpLchargeExchRate(this);">
												<c:forEach items="${requestScope.prpLpayObjectInfoCurrencyList}" var="tempMap">
													<option value="${tempMap.key}" <c:if test="${tempMap.key==LOCAL_CURRENCY}">selected="selected"</c:if>><c:out value="${tempMap.key}" /></option>
												</c:forEach>
											</select>
										</td>
										<td class="input" align="center" style="width: 7%">
											<input type="text" name="prpLchargeExchRate" class="input" readonly style="width: 95%" value="1">
										</td>
										<td class="input" align="center" style="width: 8%">
											<input type="text" name="prpLchargeChargeAmountNTD" class="readonly" readonly style="width: 95%" value="0">
										</td>
										<td class="input" align="center" style="width: 3%">
											<input type="text" name="prpLchargeFeeSerialNo" class="input"  style="width: 95%" value="">
										</td>
										<td class="input" style='width: 4%' align="center">
											<div>
												<input type=button name="buttonChargeDelete" class="smallbutton" onclick="directDeleteRow(this,'Charge',1,3),calFund();afterDeleteCharge(this);" value="-" style="cursor: hand">
												<input type="hidden" name="prpLchargeFlag">
											</div>
										</td>
									</tr>
									<tr name="prpLchargePayInfoObject" >
										<td colspan="15" style='width: 96%'>
											<table class="common" style="width: 100%">
												<tr>
													...
													<td class="input" style="width: 10%">受款人電話：</td>
													<td class="input" style="width: 25%">
														<input name="prpLchargeBeneficiaryPhone" class="input" value="" />
													</td>
												...
												<tr>
													...
													<td class="input" style="width: 20%">
														<input type="text" name="prpLchargeOwnerName" class="input">
													...
													<td class="input" style="width: 25%">
														<input type="text" name="prpLchargeUniformNo" class="input">
														<img src="${ctx}/images/bgMarkMustInput.jpg" complete="complete" />
													</td>
													<td class="input" style="width: 10%">
												...
												<tr name="bankInfo">
													...
													<td class="input" style="width: 20%">
														<input type="text" name="prpLchargeBankCode" readOnly="readonly" class="readonly">
													</td>
													<td class="input" style="width: 10%"><s:text name='common.compensate.bankName'/>：</td><%--总行名称--%>
													<td class="input" style="width: 25%">
														<input type="text" name="prpLchargeBankName" readOnly="readonly" class="readonly">
													</td>
													<td class="input" style="width: 10%"><s:text name='common.compensate.accountCode'/>：</td><%--汇款账号--%>
													<td class="input" style="width: 25%">
														<input type="text" name="prpLchargeAccountCode" readOnly="readonly" class="readonly">
													</td>
												</tr>
												<tr name="bankInfo">
													<td class="input" style="width: 10%"><s:text name="common.compensate.customBankCode"/>：</td><%--分行代号--%>
													<td class="input" style="width: 20%">
														<input type="text" name="prpLchargeCustomBankCode" readOnly="readonly" class="readonly">
													</td>
													<td class="input" style="width: 10%"><s:text name='common.compensate.customBankName'/>：</td><%--分行名称--%>
													<td class="input" style="width: 25%">
														<input type="text" name="prpLchargeCustomBankName" readOnly="readonly" class="readonly">
													</td>
												...
												<!--  \claim\webapp\claim\pages\commonProp\compensate\PropCompensateChargeEdit.jsp -->
													<td class="input" style="width: 10%"><s:text name='common.compensate.areaCode'/>：</td><%--邮递区号--%>
													<td class="input" style="width: 20%">
														<!-- mantis：CLM0145，處理人員：DP0713，需求單編號：CLM0145，.新核心-理算任務處理賠付對象郵遞區號長度檢核 -->
														<input type="text" name="prpLchargeAreaCode" class="input" maxlength="3">
														<img src="${ctx}/images/bgMarkMustInput.jpg" complete="complete" />
													</td>
													<td class="input" style="width: 10%"><s:text name='common.compensate.courierAddress'/>：</td><%--邮递地址--%>
													<td class="input" colspan="3">
														<input type="text" name="prpLchargeCourierAddress" class="input">
														<img src="${ctx}/images/bgMarkMustInput.jpg" complete="complete" />
													</td>
												</tr>
											</table>
				...
				<table class="common" style="width: 100%" id="Charge" name="chargeObject">
					<thead>
						<tr>
                            ...
                            <td class="centertitle" width="4.5%">險種代碼</td>
                            <td class="centertitle" width="10%"><s:text name="certainLoss.prpLacciCheck.riskCName" /><%-- 险种名称 --%></td>
                            <td class="centertitle" width="4.5%"><s:text name="compensate.costCode" /><%--费用代码  --%></td>
                            <td class="centertitle" width="10%"><s:text name="compensate.costName" /><%--费用名称  --%></td>
                            <td class="centertitle" width="5.5%"><s:text name="compensate.paymentType" /><%-- 支付类别 --%></td>
                            ...
                            <td class="centertitle" width="8%">支付費用金額</td>
                            <td class="centertitle" width="5.5%">賠償幣別</td>
                            <td class="centertitle" width="7%">匯率</td>
                            <td class="centertitle" width="8%">費用金額（NTD）</td>
                            <td class="centertitle" width="3%">代扣費用序號</td>
                            <td class="centertitle" width="4%">操作</td>
						</tr>
					</thead>
					<tfoot>
						<tr>
							...
							<c:forEach var="chargedtox" items="${requestScope.prpLcharge.prpLchargeList}" varStatus="status">
								<tr name="prpLchargeObject">
									<td class="input" style="width: 3%">
										...
										<input type="hidden" name="prpLchargeSumRealPay" value="<fmt:formatNumber value='${chargedtox.sumRealPay}' pattern='#.##'/>" >
									</td>
									<td class="input" style="width: 3%">
									...
									<td class="input" style="width: 4.5%">
										<input type="text" name="prpLchargeKindCode" class="codecode" value="${chargedtox.kindCode}" ondblclick="code_CodeSelect(this, 'PolicyKindCode','0,1','Y','Y',fm.policyno.value+'|'+fm.damageStartDate.value+'|'+fm.damageStartHour.value);"
											onchange="code_CodeSelect(this, 'PolicyKindCode','0,1','Y','Y',fm.policyno.value+'|'+fm.damageStartDate.value+'|'+fm.damageStartHour.value);clearPrpLctextContextInnerHTML();"
											onkeyup="code_CodeSelect(this, 'PolicyKindCode','0,1','Y','Y',fm.policyno.value+'|'+fm.damageStartDate.value+'|'+fm.damageStartHour.value);">
									</td>
									<td class="input" style="width: 10%">
										<input type="text" name="prpLchargeKindName" class="codename" value="${chargedtox.kindName}" ondblclick="code_CodeSelect(this, 'PolicyKindCode','-1,0','Y','N',fm.policyno.value+'|'+fm.damageStartDate.value+'|'+fm.damageStartHour.value);"
											onchange="code_CodeSelect(this, 'PolicyKindCode','-1,0','Y','N',fm.policyno.value+'|'+fm.damageStartDate.value+'|'+fm.damageStartHour.value);" onkeyup="code_CodeSelect(this, 'PolicyKindCode','-1,0','Y','N',fm.policyno.value+'|'+fm.damageStartDate.value+'|'+fm.damageStartHour.value);"
											onblur="calChargeAmount(this);">
									</td>
									<td class="input" align="center" style="width: 4.5%">
										<input type="text" name="prpLchargeChargeCode" class="codecode" style="width: 95%" value="${chargedtox.chargeCode}"
											ondblclick="clearPayObject(this);clearPayment(this);code_CodeSelect(this, 'ChargeCode','0,1','Y','Y',fm.prpLcompensateRiskCode.value);"
											onkeyup="clearPayObject(this);clearPayment(this);calChargeAmount(this);checkBeyondQuota(this);code_CodeSelect(this, 'ChargeCode','0,1','Y','Y',fm.prpLcompensateRiskCode.value);"
											onchange="clearPayObject(this);clearPayment(this);code_CodeChange(this, 'ChargeCode','0,1','Y','Y',fm.prpLcompensateRiskCode.value);" onblur="calChargeAmount(this);checkBeyondQuota(this);">
									</td>
									<td class="input" align="center" style="width: 10%">
										<input type="text" name="prpLchargeChargeName" class="codename" style="width: 95%" value="${chargedtox.chargeName}"
											ondblclick="clearPayObject(this);clearPayment(this);code_CodeSelect(this, 'ChargeCode','-1,0','Y','N',fm.prpLcompensateRiskCode.value);"
											onkeyup="clearPayObject(this);clearPayment(this);calChargeAmount(this);checkBeyondQuota(this);code_CodeSelect(this, 'ChargeCode','-1,0','Y','N',fm.prpLcompensateRiskCode.value);"
											onchange="clearPayObject(this);clearPayment(this);code_CodeChange(this, 'ChargeCode','-1,0','Y','N',fm.prpLcompensateRiskCode.value);" onblur="calChargeAmount(this);checkBeyondQuota(this);">
									</td>
									...
									<td class="input" style="width: 6%">
										<input type="text" name="prpLchargePayObjectCode" class="readonly" readonly style="width: 100%" value="${chargedtox.payObjectCode}">
									</td>
									<td class="input" style="width: 10%">
										<input type="text" name="prpLchargePayObjectName" class="codename" style="width: 100%" value="${chargedtox.payObjectName}" ondblclick="clearPayment(this);getPayObject(this);"
											onchange="clearPayment(this);getPayObject(this);" onkeyup="clearPayment(this);getPayObject(this);" onblur="">
									</td>
									<td class="input" style="width: 8%">
										<input type="text" name="prpLchargeChargeReport" class="input" value="<fmt:formatNumber value='${chargedtox.chargeReport}' pattern='#.##'/>" onchange="calChargeAmount(this);checkBeyondQuota(this);">
									</td>
									<td class="input" style="width: 8%">
										<input type="text" name="prpLchargeChargeAmount"  class="input" value="<fmt:formatNumber value='${chargedtox.chargeAmount}' pattern='#.##'/>">
									</td>
									<td class="input" align="center" style="width: 5.5%">
										<select name="prpLchargeCurrency" class="input" style="width: 100%" onchange="getPrpLchargeExchRate(this);">
											<c:forEach items="${requestScope.prpLpayObjectInfoCurrencyList}" var="tempMap">
									...
									<td class="input" align="center" style="width: 7%">
										<input type="text" name="prpLchargeExchRate" class="input" readonly style="width: 95%" value="${chargedtox.exchRate}">
									</td>
									<td class="input" align="center" style="width: 8%">
										<input type="text" name="prpLchargeChargeAmountNTD" class="readonly" readonly style="width: 95%" value="<fmt:formatNumber value='${chargedtox.chargeAmount*chargedtox.exchRate}' pattern='#.##'/>">
									</td>
									<td class="input" align="center" style="width: 3%">
										<input type="text" name="prpLchargeFeeSerialNo" class="input"  style="width: 95%" value="${chargedtox.feeSerialNo}">
									</td>
									<td class="input" style='width: 4%' align="center">
										<div>
											<input type=button name="buttonChargeDelete" class="smallbutton" onclick="directDeleteRow(this,'Charge',1,3),calFund();afterDeleteCharge(this);" value="-" style="cursor: hand">
									...
									<td colspan="15" style="width: 100%">
										<table class="common" style="width: 100%">
											<tr>
												...
												<td class="input" style="width: 10%">受款人電話：</td>
												<td class="input" style="width: 25%">
													<input name="prpLchargeBeneficiaryPhone" class="input" value="${chargedtox.prpLpayObjectInfo.beneficiaryPhone }" />
												</td>
												<td class="input" style="width: 10%">證件類型：</td>
												<td class="input" style="width: 25%">
											...
											<tr name="bankInfo" <c:if test="${chargedtox.prpLpayObjectInfo.ownerShip!='B'}"> style="display:none" </c:if>>
												<td class="input" style="width: 10%"><s:text name='common.compensate.bankCode'/>：</td><%--总行代号--%>
												<td class="input" style="width: 20%">
													<input type="text" name="prpLchargeBankCode" readOnly="readonly" class="readonly" value="<c:out value='${chargedtox.prpLpayObjectInfo.bankCode}'/>">
												</td>
												<td class="input" style="width: 10%"><s:text name='common.compensate.bankName'/>：</td><%--总行名称--%>
												<td class="input" style="width: 25%">
													<input type="text" name="prpLchargeBankName" readOnly="readonly" class="readonly" value="<c:out value='${chargedtox.prpLpayObjectInfo.bankName}'/>">
												</td>
												<td class="input" style="width: 10%"><s:text name='common.compensate.accountCode'/>：</td><%--汇款账号--%>
												<td class="input" style="width: 25%">
													<input type="text" name="prpLchargeAccountCode" readOnly="readonly" class="readonly" value="<c:out value='${chargedtox.prpLpayObjectInfo.accountCode}'/>">
												</td>
											</tr>
											<tr name="bankInfo" <c:if test="${chargedtox.prpLpayObjectInfo.ownerShip!='B'}"> style="display:none" </c:if>>
												<td class="input" style="width: 10%"><s:text name="common.compensate.customBankCode"/>：</td><%--分行代号--%>
												<td class="input" style="width: 20%">
													<input type="text" name="prpLchargeCustomBankCode" readOnly="readonly" class="readonly" value="<c:out value='${chargedtox.prpLpayObjectInfo.customBankCode}'/>">
												</td>
												<td class="input" style="width: 10%"><s:text name='common.compensate.customBankName'/>：</td><%--分行名称--%>
												<td class="input" style="width: 25%">
													<input type="text" name="prpLchargeCustomBankName" readOnly="readonly" class="readonly" value="<c:out value='${chargedtox.prpLpayObjectInfo.customBankName}'/>">
												</td>
												<td class="input" colspan="2" align="center">
													<input  class='bigbutton' type='button' name='buttonAddAcc' value='<s:text name='button.entryPaymentInfo.value' />' onclick="queryUser(this);" style="width: 180px;">
													<%--輸入费用支付帳户信息 --%>
											...
											<tr>
											<!-- mantis：CLM0145，處理人員：DP0713，需求單編號：CLM0145，.新核心-理算任務處理賠付對象郵遞區號長度檢核 -->
											<!--  \claim\webapp\claim\pages\commonProp\compensate\PropCompensateChargeEdit.jsp 2-->
												<td class="input" style="width: 10%"><s:text name='common.compensate.areaCode'/>：</td><%--邮递区号--%>
												<td class="right" style="width: 20%">
													<!-- mantis：CLM0145，處理人員：DP0713，需求單編號：CLM0145，.新核心-理算任務處理賠付對象郵遞區號長度檢核 -->
