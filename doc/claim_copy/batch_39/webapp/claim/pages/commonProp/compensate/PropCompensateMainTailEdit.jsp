		...
		<td>
			<table class=common cellpadding="0" cellspacing="1" width="100%">
				<tr>
					...
					<td class="left">
						<input class='readonly' readonly type='text' value='<s:text name="db.prpLafterward.chargeAmount"/>(NTD)' title='<s:text name='prompt.compensate.addmessage3'/>'><%--费用金额之和，不包括赔款金额！ --%>
					</td>
					<%-- 费用金额 --%>
					<td class="right">
				...
				<tr>
					...
					<%--本案合计  --%>
					<td class="right">
						<input class="readonly" type=text name="lossSumPaid" readonly="true" style="width: 150px" value="0">
					</td>
					<td class="left">
						人傷賠款金額(NTD)
					</td>
					<%-- 已预付赔款金额 --%>
					<td class="right">
						<input type=text name="personLossSumPaid" class="readonly" readonly="true" style="width: 140px" value="0">
					</td>
					<td class="left" style="width: 13%">
						合計賠款金額(NTD)
					</td>
					<%--本次标的损失赔款  --%>
					<td class="right">
						<input class="readonly" type=text name="allSumPaid" readonly="true" style="width: 150px" value="0">
					</td>
				</tr>
