        ...
        <tbody>
            <tr name="prpLpersonLossObject">
                <td class="input" style="width: 15%">
                    ...
                    <input type="text" name="prpLpersonLossKindCode" class="codecode" style="width: 30px" 
                        ...
                        onblur="clearPrpLpersonLoss(this);"/>
                    <input type="text" name=prpLpersonLossKindName class="codename" style="width: 120px"
                ...
                <td class="input" style="width: 15%">
                    <input type="text" name="prpLpersonLossLiabDetailCode" class="codecode" style="width: 30px" 
                    ...
                    <input type="text" name="prpLpersonLossLiabDetailName" class="codename" style="width: 120px"
                ...
                <td class="input" style="width: 8%">
                    <input type="text" name="prpLpersonLossSumDefPay" class="input" style="width: 75px" value="0" title="核定賠償" onchange="calRealpayForPerson(this);">
                </td>
                <td class="input" style="width: 8%">
                    <input type="text" name="prpLpersonLossDeductible" class="input" style="width: 70px" value="0" title="自負額" onchange="calRealpayForPerson(this);">
                </td>
                <td class="input" style="width: 8%">
                    <input type="text" name="prpLpersonLossSumRealPay" class="common" style="width: 75px" readonly="readonly" value="0" >
                </td>
                ...
                <td class="input" style="width: 8%">
                    <input type="text" name="prpLpersonLossExchRate" readonly="readonly" class="input" style="width: 70px" value="1" onchange="calRealpayForPerson(this);">
                </td>
                <td class="input" style="width: 8%">
                    <input type="text" name="prpLpersonLossSumRealPayNTD" class="common" readonly="readonly" style="width: 75px" value="0">
                </td>
                <td class="input" style="width: 13%">
                    <input type="text" name="prpLpersonLossPayObjectSerialNo" class="common" readonly="readonly" style="width: 100px" onclick="setPayObjectSerialNo(this);">
                ...
                <td class="input" style="width: 8%" align="ceter">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="input" style="width: 32%">
                                    <input type="text" class="input" style="width: 160px" name="prpLpersonLossPersonName" maxlength=20 description="<s:text name='db.prpLperson.personName' />">
                            ...
                            <tr>
                                ...
                                <td class="input" style="width: 18%">
                                    <input type="text" name="prpLpersonLossAddPremium" value="" class="input" style="width: 110px" >
                                </td>
                            </tr>
                            <tr>
                                <td class="title" style="width: 18%" >賠償金額（NTD）：</td>
                                <td class="input" style="width: 32%" >
                                ...
                                <td colspan="4">
                                    <span id="spanPersonFeeLoss">
                                        ...
                                        <table id="PersonFeeLoss" name="PersonFeeLoss" class="common" align="center" cellspacing="1" cellpadding="0">
                                            <thead>
                                                <tr>
                                                    <td class="subformtitle" colspan="11">賠款費用訊息</td>
                                                </tr>
                                                <tr>
                                                    <td class="centertitle" style="width: 15%">險別名稱</td>
                                                    <td class="centertitle" style="width: 15%">費用類型</td>
                                                    ...
                                                    <td class="centertitle" style="width: 13%">賠付對象訊息</td>
                                                    <td class="centertitle" style="width: 8%">保留預估</td>
...
<table class="common" align="center">
    ...
    <tr>
        <td class="common" colspan="4">
            <img style="cursor: hand;" src="/claim/images/butCollapseBlue.gif" name="PersonImg" onclick="showPage(this,spanPerson)"> <b>人員傷亡賠付訊息</b><br>
                                        ...
                                        <table cellpadding="0" cellspacing="1" class="common">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="input" style="width: 32%">
                                                        <input type="text" class="input" style="width: 160px" name="prpLpersonLossPersonName"  maxlength=20 description="<s:text name='db.prpLperson.personName' />" value="${tempPerson.personName}">
                                                        <img src="/claim/images/bgMarkMustInput.jpg">
                                                    </td>
                                                    <td class="title" style="width: 18%">
                                                        <s:text name="db.prpCCarDriver.sex" />：<%-- 性别 --%>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="input" style="width: 32%" >
                                                        ...
                                                        <s:select name="prpLpersonLossCertificateCode" value="#attr.tempSelectedValue" cssClass="input" listKey="key" listValue="value" list="#request.prpdpaymentaccountCertificateTypeList" onchange="resetSumRealPay(this);"/>
                                                        <img src="${ctx}/images/bgMarkMustInput.jpg">
                                                    </td>
                                                    <td class="title" style="width: 18%" >是否以健保身份就診：</td>
                                                    <td class="input" style="width: 32%" >
                                                ...
                                                <tr>
                                                    <td class="title" style="width: 18%" >證件號碼：</td>
                                                    <td class="input" style="width: 32%" >
                                                        <input type="text" name="prpLpersonLossIdentifyNumber" class="input" value="${tempPerson.identifyNumber}" onchange="resetSumRealPay(this);" style="width: 160px"/>
                                                    </td>
                                                    <td class="title" style="width: 18%" >受害人電話：</td>
                                                    <td class="input" style="width: 32%" >
                                                ...
                                                <tr>
                                                    <td class="title" style="width: 18%" >醫院名稱：</td>
                                                    <td class="input" style="width: 32%">
                                                        <input type="text" class="input" name="prpLpersonHospitalHospitalCode" onkeyup="getHospital(this,'codeCode','0,1')" onblur="isHospital(this,'codeCode');" style="width: 100px" title="醫院代碼" value="${tempPerson.hospitalCode}">
                                                        <input type="text" class="input" name="prpLpersonHospitalHospitalName" onkeyup="getHospital(this,'codeName','-1,0')" style="width: 180px" title="醫院名稱" value="${tempPerson.hospitalName}">
                                                    </td>
                                                    <td class="title" style="width: 18%" >醫師姓名：</td>
                                                    <td class="input" style="width: 32%" >
                                                ...
                                                <tr>
                                                    <td class="title" style="width: 18%" >憲警單位：</td>
                                                    <td class="input" style="width: 32%">
                                                        <input type="text" name="prpLpersonLossPoliceUnits" value="${tempPerson.policeUnits}" class="input">
                                                    </td>
                                                    <td class="title" style="width: 15%">補充保費：</td>
                                                    <td class="input" style="width: 18%">
                                                        <input type="text" name="prpLpersonLossAddPremium" value="${tempPerson.addPremium}" class="input" style="width: 110px" >
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="title" style="width: 18%" >賠償金額（NTD）：</td>
                                                    <td class="input" style="width: 32%" >
                                                        <input type="text" name="prpLpersonLossSumRealPay1NTD" class="common"  style="width: 120px" readonly="readonly"/>
                                                    </td>
                                                    <td class="title" style="width: 18%" ></td>
                                                    <td class="input" style="width: 32%" ></td>
                                                </tr>
                                                                        ...
                                                                        <c:if test="${tempPrpLpersonLosss.personNo == tempPerson.personNo}">
                                                                            ...
                                                                            <tr name="prpLpersonLossObject">
                                                                                <td class="input" style="width: 15%">
                                                                                    ...
                                                                                    <input type="text" name="prpLpersonLossKindCode" class="codecode" value="${tempPrpLpersonLosss.kindCode}" style="width: 30px" 
                                                                                        ondblclick="code_CodeSelect(this, 'PolicyKindCode','0,1,2','Y','Y',fm.policyno.value+'|'+fm.damageStartDate.value+'|'+fm.damageStartHour.value);setPersonLossAmount(this);" 
                                                                                        onchange="code_CodeSelect(this, 'PolicyKindCode','0,1,2','Y','Y',fm.policyno.value+'|'+fm.damageStartDate.value+'|'+fm.damageStartHour.value);setPersonLossAmount(this);" 
                                                                                        onkeyup="code_CodeSelect(this, 'PolicyKindCode','0,1,2','Y','Y',fm.policyno.value+'|'+fm.damageStartDate.value+'|'+fm.damageStartHour.value);setPersonLossAmount(this);"
                                                                                        onblur="clearPrpLpersonLoss(this);" />
                                                                                    <input type="text" name=prpLpersonLossKindName class="codename" style="width: 120px" value="${tempPrpLpersonLosss.kindName}" style="width: 100px" 
                                                                                        ondblclick="code_CodeSelect(this, 'PolicyKindCode','-1,0,1','Y','N',fm.policyno.value+'|'+fm.damageStartDate.value+'|'+fm.damageStartHour.value);setPersonLossAmount(this);" 
                                                                                        onkeyup="code_CodeSelect(this, 'PolicyKindCode','-1,0,1','Y','N',fm.policyno.value+'|'+fm.damageStartDate.value+'|'+fm.damageStartHour.value);setPersonLossAmount(this);" 
                                                                                        onchange="code_CodeSelect(this, 'PolicyKindCode','-1,0,1','Y','N',fm.policyno.value+'|'+fm.damageStartDate.value+'|'+fm.damageStartHour.value);setPersonLossAmount(this);" 
                                                                                        onblur="clearPrpLpersonLoss(this);" />
                                                                                ...
                                                                                <td class="input" style="width: 15%">
                                                                                    <input type="text" name="prpLpersonLossLiabDetailCode" class="codecode" style="width: 30px" value="<c:out value='${tempPrpLpersonLosss.liabDetailCode}' />"
                                                                                        ondblclick="code_CodeSelect(this,'PersonFeeTypeFlag','0,1,2','Y','Y',fm.prpLcompensateRiskCode.value);"
                                                                                        onchange="code_CodeChange(this, 'PersonFeeTypeFlag','0,1,2','Y','Y',fm.prpLcompensateRiskCode.value);"
                                                                                        onkeyup="code_CodeSelect(this,'PersonFeeTypeFlag','0,1,2','Y','Y',fm.prpLcompensateRiskCode.value);" readonly="readonly">
                                                                                    <input type="text" name="prpLpersonLossLiabDetailName" class="codename" style="width: 120px" value="<c:out value='${tempPrpLpersonLosss.liabDetailName}' />"
                                                                                        ondblclick="code_CodeSelect(this,'PersonFeeTypeFlag','-1,0,1','Y','N',fm.prpLcompensateRiskCode.value);"
                                                                                        onchange="code_CodeChange(this, 'PersonFeeTypeFlag','-1,0,1','Y','N',fm.prpLcompensateRiskCode.value);"
                                                                                        onkeyup="code_CodeSelect(this,'PersonFeeTypeFlag','-1,0,1','Y','N',fm.prpLcompensateRiskCode.value);" readonly="readonly">
                                                                                ...
                                                                                <td class="input" style="width: 8%">
                                                                                    <input type="text" name="prpLpersonLossSumDefPay" class="input" style="width: 75px" title="核定賠償" value="<fmt:formatNumber value='${tempPrpLpersonLosss.sumDefPay}' pattern='#0.##'/>" onchange="calRealpayForPerson(this);">
                                                                                </td>
                                                                                <td class="input" style="width: 8%">
                                                                                    <input type="text" name="prpLpersonLossDeductible" class="input" style="width: 70px" title="自負額" value="<fmt:formatNumber value='${tempPrpLpersonLosss.deductible}' pattern='#0.##'/>" onchange="calRealpayForPerson(this);">
                                                                                </td>
                                                                                <td class="input" style="width: 8%">
                                                                                    <input type="text" name="prpLpersonLossSumRealPay" class="common" style="width: 75px" readonly="readonly" value="<fmt:formatNumber value='${tempPrpLpersonLosss.sumRealPay}' pattern='#.##'/>">
                                                                                </td>
                                                                                <td class="input" style="width: 6%">
                                                                                    <select name="prpLpersonLossCurrency" class="input" style="width: 50px" onchange="getPrpLpersonLossExchRate(this);">
                                                                                        <c:forEach items="${requestScope.prpLpayObjectInfoCurrencyList}" var="tempMap">
                                                                                ...
                                                                                <td class="input" style="width: 8%">
                                                                                    <input type="text" name="prpLpersonLossExchRate" readonly="readonly" class="input" style="width: 70px" value="${tempPrpLpersonLosss.exchRate}" onchange="calRealpayForPerson(this);">
                                                                                </td>
                                                                                <td class="input" style="width: 8%">
                                                                                    <input type="text" name="prpLpersonLossSumRealPayNTD" value="<fmt:formatNumber value='${tempPrpLpersonLosss.sumRealPay*tempPrpLpersonLosss.exchRate}' pattern='#'/>" class="common" readonly="readonly" style="width: 75px">
                                                                                </td>
                                                                                <td class="input" style="width: 13%">
                                                                                    <input type="text"  name="prpLpersonLossPayObjectSerialNo" class="common" readonly="readonly" style="width: 100px" onclick="setPayObjectSerialNo(this);" value="${tempPrpLpersonLosss.payObjectSerialNo}">
                                                                                    ...
                                                                                    <input type="hidden" name="prpLpersonLossInjuryGrade" value="${tempPrpLpersonLosss.injuryGrade}">
                                                                                </td>
                                                                                <td class="input" style="width: 8%" align="ceter">
