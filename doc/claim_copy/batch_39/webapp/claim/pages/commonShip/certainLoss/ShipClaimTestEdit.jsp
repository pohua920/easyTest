                    ...
                    <table  cellpadding="0" cellspacing="1" class="common">
                      ...
                      <tr>
                        ...
                        <td class="input">
                          ...
                          <input class="input" s name="prpLpropCurrencyName" value="人民币">
                          </td>
                      </tr> 
                ...
                <td colspan="3">
                    <table  cellpadding="0" cellspacing="1" class="common" cellpadding="5" cellspacing="1">
                      <tr>
                        ...
                        <td class="input" >
                          <input name="prpLdriverDriverName" class="input"  maxlength=20 description="驾驶员姓名">
                        </td>
                        <td class="title" ><s:text name="db.prpCCarDriver.drivingCarType" /></td><%--准驾车型--%>
                        <td class="input">
                        ...
                        <td class="title" ><s:text name="db.prpLdriver.awardLicenseOrgan" /></td><%--颁证机关--%>
                        <td class="input" >
