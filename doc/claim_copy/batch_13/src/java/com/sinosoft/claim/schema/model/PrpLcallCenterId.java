...
/**
 * POJO类PrpLcallCenterId
 */
@Embeddable
public class PrpLcallCenterId implements java.io.Serializable {
	...
	/**
	 * 类PrpLcallCenterId的默认构造方法
	 */
	public PrpLcallCenterId() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof PrpLcallCenterId)) {
			return false;
		}
		PrpLcallCenterId castOther = (PrpLcallCenterId) other;
