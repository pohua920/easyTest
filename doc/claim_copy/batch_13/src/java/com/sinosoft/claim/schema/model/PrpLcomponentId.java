...
/**
 * POJO类PrpLcomponentId
 */
@Embeddable
public class PrpLcomponentId implements java.io.Serializable {
	...
	/**
	 * 类PrpLcomponentId的默认构造方法
	 */
	public PrpLcomponentId() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof PrpLcomponentId)) {
			return false;
		}
		PrpLcomponentId castOther = (PrpLcomponentId) other;
