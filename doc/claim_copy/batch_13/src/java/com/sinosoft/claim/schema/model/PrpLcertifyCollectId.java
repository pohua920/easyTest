...
/**
 * POJO类PrpLcertifyCollectId
 */
@Embeddable
public class PrpLcertifyCollectId implements java.io.Serializable {
	...
	/**
	 * 类PrpLcertifyCollectId的默认构造方法
	 */
	public PrpLcertifyCollectId() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof PrpLcertifyCollectId)) {
			return false;
		}
		PrpLcertifyCollectId castOther = (PrpLcertifyCollectId) other;
