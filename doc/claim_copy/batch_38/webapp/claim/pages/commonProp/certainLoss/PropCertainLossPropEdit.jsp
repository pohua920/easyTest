							...
							<tr>
								...
								<td class="subformtitle">
									<table cellpadding="0" cellspacing="1" class="common">
										<tr>
											...
											<td class="input" style='width: 35%'>
												<input type="input" name="prpLpropKindCode" class="codecode" style='width: 60px' ondblclick="code_CodeSelect(this,'PolicyKindCode');" onkeyup="code_CodeSelect(this,'PolicyKindCode');">
												<input type="input" name="prpLpropKindName" class="codename" style='width: 120px' ondblclick="code_CodeSelect(this, 'PolicyKindCode','-1','always','none','post');"
										...
										<tr>
											...
											<%--损失明细  --%>
											<td class="input">
												<input type="input" name="feeTypeCode" class="codecode" style='width: 60px' ondblclick="code_CodeSelect(this,'ChargeCode');" onkeyup="code_CodeSelect(this,'ChargeCode');">
												<input type="input" name="prpLpropFeeTypeName" class="codename" style='width: 120px' ondblclick="code_CodeSelect(this, 'ChargeCode','-1','always','none','post');"
											...
											<%-- 币别 --%>
											<td class="input">
												<input class="input" style='width: 30px' name="prpLpropCurrency" value="CNY" class="readonly" readonly ondblclick="code_CodeSelect(this,'Currency');"
													onkeyup="code_CodeSelect(this,'Currency');">
												<input class="input" style='width: 90px' name="prpLpropCurrencyName" value="<s:text name='certainLoss.rmb'/>" class="readonly"
													readonly<%-- 人民币 --%>
        			             ondblclick="code_CodeSelect(this, 'Currency','-1','always','none','post');"
										...
										<tr>
											<td class="title">
												<s:text name="certainLoss.depreciationRate" />
												：
											</td>
											<%-- 折旧率 --%>
											<td class="input" colspan="3">
										...
										<tr>
											...
											<%--剔除金额  --%>
											<td class="input">
												<input class="input" style='width: 90px' name="prpLpropSumReject">
											</td>
										</tr>
										<tr>
											<td class="title">
												<s:text name="certainLoss.lossRatios" />
												：
											</td>
											<%--损失率  --%>
											<td class="input">
										...
										<td class="subformtitle">
											<table cellpadding="0" cellspacing="1" class="common">
												...
												<tr>
													...
													<td class="input">
														<input type="input" name="feeTypeCode" class="codecode" style='width: 60px' value="<bean:write name='prpLpropDto1' property='feeTypeCode'/>"
															ondblclick="code_CodeSelect(this,'ChargeCode');" onkeyup="code_CodeSelect(this,'ChargeCode');">
														<input type="input" name="prpLpropFeeTypeName" class="codename" style='width: 120px' value="<bean:write name='prpLpropDto1' property='feeTypeName'/>"
															ondblclick="code_CodeSelect(this, 'ChargeCode','-1','always','none','post');" onkeyup="code_CodeSelect(this, 'ChargeCode','-1','always','none','post');">
													</td>
													<td class="title">
														<s:text name="db.prpLreplevynew.currency" />
														：
													...
													<td class="input">
														<input type="input" style='width: 30px' name="prpLpropCurrency" value="<bean:write name='prpLpropDto1' property='currency'/>" class="readonly" readonly
															ondblclick="code_CodeSelect(this,'Currency');" onkeyup="code_CodeSelect(this,'Currency');">
												...
												<tr>
													...
													<%--剔除金额  --%>
													<td class="input">
														<input class="input" style='width: 90px' name="prpLpropSumReject" value="<bean:write name='prpLpropDto1' property='sumReject'/>">
													</td>
												</tr>
												<tr>
													<td class="title">
													...
													<%-- 核定标的损失 --%>
													<td class="input">
														<input class="input" style='width: 90px' name="prpLpropSumDefLoss" value="<bean:write name='prpLpropDto1' property='sumDefLoss'/>">
													</td>
												</tr>
												<tr>
													<td class="title">
														<s:text name="title.checkBeforeEdit.editCheck" />
														<s:text name="db.prpLmedicine.rejectReason" />
														：
													</td>
													<%-- 剔除原因 --%>
