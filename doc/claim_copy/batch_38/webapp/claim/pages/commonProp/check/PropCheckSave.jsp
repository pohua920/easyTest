<script language='javascript'>
	...
	function printWindow(registNo, strWindowName) {
		strUrl = "/claim/JRPropPropPrpinsClaimInformation.do?registNo="+ registNo;
...
<table id="buttonArea" cellpadding="0" cellspacing="0" width="80%" style="display:">
	...
	<tr>
		<td>
			<%--<input type="button" name="print" class='bigbutton' value="<s:text name='button.printInsClaimInfo.value'/>" onclick="printWindow('${prpLcheck.id.registNo}','<s:text name='common.check.print'/>');">--%><%-- 列印1 --%>
			<%-- 列印承保理赔信息 --%>
		</td>
