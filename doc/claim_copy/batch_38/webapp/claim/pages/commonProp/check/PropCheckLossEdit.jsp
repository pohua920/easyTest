					...
					<tbody>
						<tr>
							...
							<td class="input" style="width: 7%" align="center"><%--保险金额 --%>
								<input type=text name="prpLclaimLossAmount" class="readonly" readonly style="" title="<s:text name="db.prpLpersonloss.amount" />" value="<fmt:formatNumber value='${prpLcheck.sumAmount}' pattern='#'/>">
							</td>
							...
							<td class="input" style="width: 8%" >
								<s:select name="prpLclaimLossLossFeeType" listKey="key" listValue="value" list="#request.lossLossFeeTypeList" onchange="calculateSumClaim(this);"/>
							</td>
							<td class="input" style="width: 10%" align="center">
								<input type="text" name="prpLclaimLossCurrency" class="readonly" readonly style="width: 30%" title="<s:text name='db.prpDrate.currency'/>" value="${prpLcheck.currency}">
								<%--币别--%>
						...
						<c:forEach var="prpLclaimLossForProp" items="${prpLclaimLoss.claimLossList}">
							<tr>
								...
								<td class="input" style="width: 8%">
									...
									<s:select name="prpLclaimLossLossFeeType" value="#attr.tempSelectedValue" listKey="key" listValue="value" list="#request.lossLossFeeTypeList" onchange="calculateSumClaim(this);"/>
								</td>
								<td class="input" style="width: 10%" align="center">
