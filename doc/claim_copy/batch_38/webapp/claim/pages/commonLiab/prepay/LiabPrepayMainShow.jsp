...
<%@ include file="/common/taglibs.jsp"%>
    ...
    <tr>
       ...
       <td><input type="button" name="message" value="<s:text name='button.disMessage.value' />"  class="bigbutton" onclick="openWinSave()"></td><%--讨论留言--%>
        <td><input type="button" name="messageView" class="bigbutton" value="<s:text name='button.viewMessage.value' />" onclick="openWinQuery()"></td><%--查看留言--%>
...
<table  border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#2D8EE1" class="title" width="100%">
  <tr> 
    <td class="title" colspan="4" style="width:100%"><s:text name="prepay.paymentRegistration" /><%--预付赔款登记--%>
  ...
  <tr> 
    <td class="title"  style="width:15%"><s:text name="prepay.paidAdvance" />:</td><%--预付赔款号--%>
    <td class="input"  style="width:35%"> <input type=text name="prpLprepayPreCompensateNo" title="预付赔款号" maxlength="22" class="readonly" readonly="true" value="${prpLprepay.preCompensateNo}"> 
    </td>
    <td class="title"  style="width:15%"> <s:text name="certainLoss.claims" />:</td><%--赔案号--%>
    <td class="input"  style="width:35%"> <input type=text name="prpLprepayClaimNo" title="赔案号" maxlength="22" class="readonly" readonly="true"  value="${prpLprepay.claimNo}"> 
    </td>
  </tr>
  <tr> 
