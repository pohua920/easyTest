							...
							<table cellpadding="5" cellspacing="1" class="common">
								...
								<tr>
									...
									<td class="input" colspan="5">
										<input type="text" name="prpLpersonTraceHospitalCode" style="display: none;" class="input" description="就診醫院代碼"><%-- onkeyup="getHospital(this,'codeCode','0,1');" onblur="isHospital(this,'codeCode'); --%>
										<input type="text" name="prpLpersonTraceHospital" style="width:300 px" class="input" description="就診醫院" ><%-- onkeyup="getHospital(this,'codeName','-1,0');" --%>
