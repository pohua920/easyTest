...
<head>
    <!--对title处理-->
    <title>
    	<s:text name="title.registBeforeEdit.editRegist" />
    </title>
  <app:css />
  <%-- 页面样式  --%>
...
<body  onload="initPage();">
    ...
    <%-- 保存通用按钮 --%>
        <table cellpadding="0" cellspacing="0" width="80%" style="display:">
          <tr>
            <td align="center"><input type="button"   class="button" name="buttonApprove" value="<s:text name='button.nuclear.value' />" onClick="approveSubmit();"></td><%--复  核--%>
          </tr>
        </table>
     </form>
</body>
