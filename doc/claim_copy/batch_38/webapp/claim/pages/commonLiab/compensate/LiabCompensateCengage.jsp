      ...
      <td class="subformtitle" colspan="4" style="text-align:left">
        ...
        <span id="spanEngage" style="display:none">
          <table class="sub" style='width:100%' id="Engage">
            <thead>
              <tr>
                <td class="centertitle"><s:text name="db.prpLmedicine.serialNo" /></td><%--序号--%>
                    ...
                    <table class=sub>
                      ...
                      <tr> 
                        <td colspan=2 align=center>
                          <input type=button name = 'button_Engage_Close_Context' class="button" value="<s:text name='button.determine.value' />"
                            ACCESSKEY="O"
