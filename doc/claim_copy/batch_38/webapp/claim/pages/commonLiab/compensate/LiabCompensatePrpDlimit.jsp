    ...
    <tr class=mline>
      <td class="subformtitle" colspan="4" style="text-align:left">
        <img style="cursor:hand;" src="/claim/images/butCollapseBlue.gif"
          name="LimitImg" onclick="showPage(this,spanLimit)"><s:text name="db.prpClimit.limitFee" /><br><%--赔偿限额/免赔额--%>
        ...
        <span id="spanLimit" style="display:none">
          <table class="sub" style='width:100%' id="Limit">
            <thead>
              <tr>
                <td class="centertitle" style="width:15%"><s:text name="commonAcci.compensate.allSinglePart" /></td><%--全单/部分--%>
               <!-- <td class="centertitle" style="width:15%">标的险别序号</td>-->
                <td class="centertitle" style="width:40%"><s:text name="commonAcci.compensate.limitFranchiseType" /></td><%--限额/免赔额类型--%>
                <td class="centertitle" style="width:15%"><s:text name="db.prpLperson.currency" /></td><%--币别--%>
                <td class="centertitle" style="width:15%"><s:text name="commonAcci.compensate.limitFranchiseCompensation" /></td><%--赔偿限额/免赔--%>
              </tr> 
            </thead> 
            <tbody>
