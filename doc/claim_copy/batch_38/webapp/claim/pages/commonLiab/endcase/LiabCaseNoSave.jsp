...
<body class="interface" onload="initPage();">
  ...
  <table border="0" align="center" cellpadding="0" cellspacing="0" class="common">
    <tr>
      ...
      <td class="centertitle"><s:text name="db.view_larrearage.policyNo" />：</td><%--保单号--%>
  ...
  <table class="common" align="center">
    <tr>
      ...
      <td class="button" colspan="2">
        <input type="button" name="buttonCancel" value="<s:text name='button.cancel.value' />"  class="button">
      </td>
    </tr>
  </table>
  </form>
