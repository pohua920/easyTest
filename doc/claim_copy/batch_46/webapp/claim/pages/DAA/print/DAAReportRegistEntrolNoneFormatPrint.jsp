...
<html>
<head>
<title>机动车辆保险报案、立案登记簿清单列印</title>
...
<body bgcolor="#FFFFFF">
	...
	<table border=1 width="97%" align="center" cellspacing="0" cellpadding="2" style="border-collapse: collapse" bordercolor="#111111" style="font-family:宋体; font-size:10pt;">
		<tr>
			...
			<td width="6%" rowspan="2">报案编号</td>
			<td width="9%">被保险人</td>
			<td width="9%">厂牌型号</td>
			<td width="8%">驾驶员姓名</td>
			<td colspan="2">出险地点</td>
			<td width="6%" w>报案方式</td>
			<td width="7%">受理人</td>
			<td width="6%">查勘人员</td>
			<td width="6%">查勘时间</td>
			<td width="6%">应否立案</td>
			<td width="9%">保户联系电话</td>
			<td width="8%" rowspan="2">立案人签字</td>
