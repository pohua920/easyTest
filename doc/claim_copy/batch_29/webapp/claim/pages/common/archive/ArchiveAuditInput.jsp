...
<head>
<title><s:text name="archive.dataReadTheReview" /></title>
<!-- 资料调阅审核 -->
<%-- 页面样式  --%>
...
<script type="text/javascript">
    ...
    function submitPass(value) {
    	fm.button1.disabled = "disabled";
    	fm.button2.disabled = "disabled";
    	fm.button3.disabled = "disabled";
    	fm.editType.value = value;
    	fm.action = "/claim/archive/archiveAudit.do";
    	fm.submit();
    }
    </script>
</head>
<body class="interface" onload="initPage();">
	<form name=fm action="/claim/archive/archiveApply.do" method="post" onsubmit="return validateForm(this);">
		<table class="common" cellpadding="5" cellspacing="1">
			<tr>
				<td class=formtitle colspan="4">
					<s:text name="archive.readTheAuditTasks" />
				</td>
				<!-- 处理调阅审核任务 -->
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="title">
					<s:text name="archive.applyPersonName" />
				</td>
				<!-- 申请人姓名： -->
				<td class="input">
			...
			<tr>
				...
				<td class="title">
					<s:text name="archive.archivingPeriodExpected" />
				</td>
				<!-- 预计归档周期： -->
		...
		<table class="common" align="center">
			<tr>
				<td class="button">
					<input type="button" class="button" name="button1" value="<s:text name="button.checkPass.value"/>" onclick="submitPass('pass');">
					<!-- 审核通过 -->
				</td>
				<td class="button">
					<input type="button" class="button" name="button2" value="<s:text name="button.submitUp.value"/>" onclick="submitPass('submit');">
					<!-- 提交上级 -->
				</td>
				<td class="button">
					<input type="button" class="button" name="button3" value="<s:text name="button.noPass.value"/>" onclick="submitPass('nopass');">
					<!-- 不通过 -->
				</td>
			</tr>
		</table>
		...
		<input type="hidden" name="modelNo" value="${prpLDocArchiveLogDto.modelNo}">
		<input type="hidden" name="nodeNo" value="${prpLDocArchiveLogDto.nodeNo}">
