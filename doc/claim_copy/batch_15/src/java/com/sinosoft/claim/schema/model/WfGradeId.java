...
public class WfGradeId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		return ((this.getFlowId() == castOther.getFlowId()) || (this.getFlowId() != null && castOther.getFlowId() != null && this.getFlowId().equals(castOther.getFlowId())))
				...
				&& ((this.getGradeMode() == castOther.getGradeMode()) || (this.getGradeMode() != null && castOther.getGradeMode() != null && this.getGradeMode() == (castOther.getGradeMode())));
	}
	...
	public int hashCode() {
		...
		result = 37 * result + (this.getLogNo());
		result = 37 * result + (getGradeMode() == null ? 0 : this.getGradeMode().hashCode());
		return result;
	}
