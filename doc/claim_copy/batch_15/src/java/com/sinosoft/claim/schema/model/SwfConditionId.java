...
public class SwfConditionId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		return ((this.getModelNo() == castOther.getModelNo()) || (this.getModelNo() != null && castOther.getModelNo() != null && this.getModelNo().equals(castOther.getModelNo())))
				...
				&& ((this.getConditionNo() == castOther.getConditionNo()) || (this.getConditionNo() != null && castOther.getConditionNo() != null && this.getConditionNo().equals(castOther.getConditionNo())))
	...
	public int hashCode() {
		...
		result = 37 * result + (getConditionNo() == null ? 0 : this.getConditionNo().hashCode());
