 ...
 * @author 理赔组
 */
public class UndwrtTaskInfoDto {
	...
	/** 賠付金額 */
	private Object sumThisPaid = 0;
	/** 理賠費用 */
	private Object sumNoDutyFee = 0;
	/** 業務經辦 */
	...
	public UndwrtTaskInfoDto(Map<String, Object> map) {
		CommonUtils.initMapToBean(this, FieldMap, map);
	}

	public UndwrtTaskInfoDto() {
	}
	...
	public Object getSumThisPaid() {
		return sumThisPaid;
	}

	public void setSumThisPaid(Object sumThisPaid) {
		this.sumThisPaid = df.format(((BigDecimal) sumThisPaid).doubleValue());
	}

	public Object getSumNoDutyFee() {
		return sumNoDutyFee;
	}

	public void setSumNoDutyFee(Object sumNoDutyFee) {
		this.sumNoDutyFee = df.format(((BigDecimal) sumNoDutyFee).doubleValue());
	}
	...
	static {
		Field[] fields = UndwrtTaskInfoDto.class.getDeclaredFields();
		for (Field f : fields) {
	...
	public static String[] getDisPlayClumName() {
		return new String[] { "序號", "處理單位", "立案日期", "核賠通過日期", "理算書號碼", "保單號碼", "被保險人", "出險日期", "險種", "賠付金額", "理賠費用", "理賠員", "業務經辦", "業務來源", "賠付日期", "備註" };
	}

	/** 需要展示的列属性名称 */
	public static String[] getDisPlayField() {
		return new String[] { "serialNo", "underWriteDeptName", "claimDate", "underWriteEndDate", "compensateNo", "policyNo", "insuredName", "damageStartDate", "riskCode", "sumThisPaid", "sumNoDutyFee", "handler1Name", "handlerName",
