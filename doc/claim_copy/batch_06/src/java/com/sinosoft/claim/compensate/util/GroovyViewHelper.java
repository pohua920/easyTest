...
public class GroovyViewHelper {
	...
	private static Map<String, Double> initPrpLpersonLossValue(PrpLpersonLoss prpLpersonLoss) {
		...
		//mantis：CLM0295 ，處理人員： DP0713 ，需求單編號：新核心-配合車險新商品G1~G4調整理賠系統 .
		map.put(PrpLpersonLoss_indemnityDutyRate, prpLpersonLoss.getIndemnityDutyRate() / 100);// 責任比率
		return map;
	}

	/** 任意險車財理算公式 计算因子：核定赔偿 */
	private static final String PrpLloss_sumDefPay = "P001";//核定賠償
	/** 任意險車財理算公式 计算因子：折旧率 */
	private static final String PrpLloss_depreRate = "P002";//折舊率
	/** 任意險車財理算公式 计算因子 ：免赔率/自负额比例*/
	private static final String PrpLloss_deductibleRate = "P003";//自負額比率
	/** 任意險車財理算公式 计算因子 ：免赔额/自负额*/
	private static final String PrpLloss_deductible = "P004";//自負額
	/** 任意險車財理算公式 计算因子：属性剔除金额/残值/损余 */
	private static final String PrpLloss_sumRest = "P005";//殘值
	/** 任意險車財理算公式 计算因子：肇事責任比率 */
	private static final String PrpLloss_indemnityDutyRate = "P006";//肇事責任比率
	/** 任意險人傷理赔金计算因子：核定赔偿 */
	private static final String PrpLpersonLoss_sumDefPay = "P101"; // 核定賠償
	/** 任意險人傷理赔金计算因子：自负额 */
	private static final String PrpLpersonLoss_deductible = "P102";//自負額
	/** 任意險人傷理赔金计算因子：強制險給付金額 */
	private static final String PrpLpersonLoss_compelPay = "P103";//強制險給付金額
	//mantis：CLM0295 ，處理人員： DP0713 ，需求單編號：新核心-配合車險新商品G1~G4調整理賠系統 START
	/** 任意險車財理算公式 计算因子：肇事責任比率 */
	private static final String PrpLpersonLoss_indemnityDutyRate = "P106";//肇事責任比率
	...
	static {
		...
		//mantis：CLM0295 ，處理人員： DP0713 ，需求單編號：新核心-配合車險新商品G1~G4調整理賠系統 
		FAC_CN.put(PrpLpersonLoss_indemnityDutyRate, "肇事責任比率");
	}
	...
	static {
		...
		//mantis：CLM0297 ，處理人員： DP0713 ，需求單編號：新核心-配合車險新商品H1~H6調整理賠系統 START
		//H1營業用汽車保險約定折舊率附加條款_車體(A式) 核定賠償*折舊率 ＝理賠金
		//1.	H1、H2、H3(OL、OM)：賠償金額 = 核定賠償 × 折舊率
		PRPLLOSS_MAP.put("H1", "P001*P002");
		PRPLLOSS_MAP.put("H2", "P001*P002");
		PRPLLOSS_MAP.put("H3", "P001*P002");
		//2.	H3、H4、H5(1B、1C) ：賠償金額 = 核定賠償 × 折舊率 × (1-自負額比率) /Doc錯誤
		PRPLLOSS_MAP.put("H4", "P001*P002*(1-P003)");
		PRPLLOSS_MAP.put("H5", "P001*P002*(1-P003)");
		PRPLLOSS_MAP.put("H6", "P001*P002*(1-P003)");
		//mantis：CLM0297 ，處理人員： DP0713 ，需求單編號：新核心-配合車險新商品H1~H6調整理賠系統 END
	...
	static {
		...
		// C3 計算式：賠償金額 = 核定賠償 × 肇事責任比率 - 強制險給付金額-自負額
		PRPLPERSONLOSS_MAP.put("C3", "P101*P106-P103-P102");
		//mantis：CLM0233，處理人員： DP0713 ，需求單編號：新核心-車險新商品增加險別D1F1C3C4 END
		//mantis：CLM0295 ，處理人員： DP0713 ，需求單編號：新核心-配合車險新商品G1~G4調整理賠系統 START
		// G1  核定賠償 × 肇事責任比率 - 強制險給付金額 - 自負額 
		PRPLPERSONLOSS_MAP.put("G1", "P101*P106-P103-P102");
