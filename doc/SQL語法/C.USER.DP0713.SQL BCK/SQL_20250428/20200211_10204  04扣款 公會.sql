...
, owner_id, owner_name
, accept_no--每筆不可重復號碼
--,benefit_name,benefit_name_long_en,benefit_name2,benefit_name2_long_en,benefit_name3,benefit_name3_long_en
--, customer_status
--, owner_name_long_ch,owner_name_long_en
...
FROM TLGCTBCSIT.dbo.ctbc_ta_policy order by modified_time DESC,accept_no;
/*
*/

--select Top 1 policy_no from TLGCTBCSIT.dbo.ctbc_ta_policy where policy_no like '180720TAW%' order by policy_no DESC
