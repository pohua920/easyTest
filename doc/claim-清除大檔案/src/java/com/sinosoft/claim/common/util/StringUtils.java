...
public class StringUtils extends org.apache.commons.lang.StringUtils {
	...
	public static List<ArrayList> groupListByQuantity(List list, int quantity) {
	    if (list == null || list.size() == 0) {
	        ...
	        List<ArrayList> wrapList = new ArrayList<ArrayList>();
	        int count = 0;
	   ...
	   public static void main(String[] args) {
		   ...
		   int quantity = 2;
		  List list1 = groupListByQuantity(list,2);
