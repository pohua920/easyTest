 ...
 *
 */
public class PropPrintBeforeEditAction extends Struts2Action {
	...
	private String bizNoType;
	  ...
	  * @return
	  */
	public String propPrintBeforeEdit(){
		String forward = "propPrint";
		HttpServletRequest httpServletRequest = super.getRequest();
		String titleName = ConstantsCollection.PROPPRINTTYPEINFO.get(this.printType);
