 ...
 *
 */
public class LiabPrintBeforeEditAction extends Struts2Action {
	...
	private String bizNoType;
	  ...
	  * @return
	  */
	public String liabPrintBeforeEdit(){
		String forward = "liabPrint";
		HttpServletRequest httpServletRequest = super.getRequest();
		String titleName = ConstantsCollection.LIABPRINTTYPEINFO.get(this.printType);
