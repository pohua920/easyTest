...
/**
 * POJO类PrpLscheduleItemId
 */
@Embeddable
public class PrpLscheduleItemId implements java.io.Serializable {
	...
	/**
	 * 类PrpLscheduleItemId的默认构造方法
	 */
	public PrpLscheduleItemId() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof PrpLscheduleItemId)) {
			return false;
		}
		PrpLscheduleItemId castOther = (PrpLscheduleItemId) other;
