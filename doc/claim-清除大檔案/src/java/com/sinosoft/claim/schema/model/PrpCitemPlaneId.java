...
/**
 * PrpCitemPlaneId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCitemPlaneId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String policyNo;
	private Integer itemNo;

	public PrpCitemPlaneId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCitemPlaneId))
			return false;
		PrpCitemPlaneId castOther = (PrpCitemPlaneId) other;
