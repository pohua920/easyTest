...
/**
 * POJO类PrpLsalvationId
 */
@Embeddable
public class PrpLsalvationId implements java.io.Serializable {
	...
	/**
	 * 类PrpLsalvationId的默认构造方法
	 */
	public PrpLsalvationId() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof PrpLsalvationId)) {
			return false;
		}
		PrpLsalvationId castOther = (PrpLsalvationId) other;
