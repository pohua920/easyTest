...
/**
 * PrpCnameId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCnameId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCnameId))
			return false;
		PrpCnameId castOther = (PrpCnameId) other;
