...
/**
 * PrpCitemCarExtId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCitemCarExtId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String policyNo;
	private Integer itemNo;

	public PrpCitemCarExtId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCitemCarExtId))
			return false;
		PrpCitemCarExtId castOther = (PrpCitemCarExtId) other;
