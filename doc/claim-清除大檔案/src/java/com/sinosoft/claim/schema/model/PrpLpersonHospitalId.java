 ...
 */
@Embeddable
public class PrpLpersonHospitalId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof PrpLpersonHospitalId)) {
			return false;
		}
		PrpLpersonHospitalId castOther = (PrpLpersonHospitalId) other;
