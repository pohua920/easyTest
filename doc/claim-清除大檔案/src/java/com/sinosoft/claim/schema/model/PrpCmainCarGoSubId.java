...
/**
 * POJO类PrpCmainCarGoSubId
 */
@Embeddable
public class PrpCmainCarGoSubId implements java.io.Serializable {
	 ...
	 */
	public PrpCmainCarGoSubId() {
	}

	public PrpCmainCarGoSubId(String policyNo, Integer serialNo) {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof PrpCmainCarGoSubId)) {
			return false;
		}
		PrpCmainCarGoSubId castOther = (PrpCmainCarGoSubId) other;
