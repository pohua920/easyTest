...
/**
 * POJO类PrpCinsuredNature
 */
@Entity
@Table(name="PRPCINSUREDNATURE"
)
public class PrpCinsuredNature  implements java.io.Serializable {
    private static final long serialVersionUID = 1L;


   
 /** 属性id */
     private PrpCinsuredNatureId id;
 ...
 /** 属性身高 */
	...
	/**
	 * 类PrpCinsuredNature的默认构造方法
	 */
    public PrpCinsuredNature() {
    }
     ...
     * 属性id的setter方法
     */
    public void setId(PrpCinsuredNatureId id) {
        this.id = id;
    }
    /**
     * 属性关系人角色标志的getter方法
    ...
    @JoinColumns( {
    @JoinColumn(name = "policyNo", referencedColumnName = "policyNo", nullable = false, insertable = false, updatable = false),
