...
/**
 * PrpCitemOilId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCitemOilId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String policyNo;
	private Integer itemNo;

	public PrpCitemOilId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCitemOilId))
			return false;
		PrpCitemOilId castOther = (PrpCitemOilId) other;
