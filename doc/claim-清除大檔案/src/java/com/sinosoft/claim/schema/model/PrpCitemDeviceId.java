...
/**
 * PrpCitemDeviceId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCitemDeviceId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String policyNo;
	private Integer itemNo;

	public PrpCitemDeviceId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCitemDeviceId))
			return false;
		PrpCitemDeviceId castOther = (PrpCitemDeviceId) other;
