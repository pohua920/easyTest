...
/**
 * PrpCitemTravelAgencyId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCitemTravelAgencyId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String policyNo;
	private Integer itemNo;

	public PrpCitemTravelAgencyId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCitemTravelAgencyId))
			return false;
		PrpCitemTravelAgencyId castOther = (PrpCitemTravelAgencyId) other;
