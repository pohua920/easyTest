 ...
 */
@Embeddable
public class PrpLdriverId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof PrpLdriverId)) {
			return false;
		}
		PrpLdriverId castOther = (PrpLdriverId) other;
