...
@Embeddable
@MappedSuperclass
public class SwfLogId implements java.io.Serializable {
	...
	public SwfLogId(String flowID, Integer logNo) {
		super();
		this.flowID = flowID;
		this.logNo = logNo;
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof SwfLogId)) {
			return false;
		}
		SwfLogId castOther = (SwfLogId) other;
