...
public class PrpCcarDriver implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 属性id */
	private PrpCcarDriverId id;
	 ...
	 * 属性id的setter方法
	 */
	public void setId(PrpCcarDriverId id) {
		this.id = id;
	}
