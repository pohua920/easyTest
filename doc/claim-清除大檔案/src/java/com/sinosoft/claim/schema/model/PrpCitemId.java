...
/**
 * PrpCitemId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCitemId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCitemId))
			return false;
		PrpCitemId castOther = (PrpCitemId) other;
