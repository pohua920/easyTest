...
/**
 * POJO类PrpLverifyLossExtId
 */
@Embeddable
public class PrpLverifyLossExtId implements java.io.Serializable {
	...
	/**
	 * 类PrpLverifyLossExtId的默认构造方法
	 */
	public PrpLverifyLossExtId() {
	}
	...
	public boolean equals(Object other) {
		...
		PrpLverifyLossExtId castOther = (PrpLverifyLossExtId) other;
