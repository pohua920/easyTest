...
/**
 * PrpccommissiondetailId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCcommissionDetailId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String policyNo;
	private Integer serialNo;

	public PrpCcommissionDetailId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCcommissionDetailId))
			return false;
		PrpCcommissionDetailId castOther = (PrpCcommissionDetailId) other;
