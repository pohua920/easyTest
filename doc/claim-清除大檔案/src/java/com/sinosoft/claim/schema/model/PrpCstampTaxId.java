...
/**
 * PrpCstampTaxId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCstampTaxId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String policyNo;
	private Integer serialNo;

	public PrpCstampTaxId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCstampTaxId))
			return false;
		PrpCstampTaxId castOther = (PrpCstampTaxId) other;
