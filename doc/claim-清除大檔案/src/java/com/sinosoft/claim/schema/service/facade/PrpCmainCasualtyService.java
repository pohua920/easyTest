...
public interface PrpCmainCasualtyService {
	
	/**
	 * 立案基本信息信息
	 * @param PrpCmainCasualty ：传入的立案基本信息
	 */
	...
	/**
	 * 更新立案基本信息信息
	 * @param PrpCmainCasualty :传入需要更新的立案基本信息
	 */
	public void update(PrpCmainCasualty PrpCmainCasualty) throws Exception;
	 ...
	 */
	public Page findPrpCmainCasualty(QueryRule queryRule, int pageNo, int pageSize) throws Exception;
	/**
	 * 根据查询对象获取立案基本信息的列表
	 * @param queryRule 查询对象
	 * @return 包含的立案基本信息的列表
