 ...
 */
@Embeddable
public class PrpLmedicineId implements java.io.Serializable {
	...
	/**
	 * 类PrpLmedicineId的默认构造方法
	 */
	public PrpLmedicineId() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof PrpLmedicineId)) {
			return false;
		}
		PrpLmedicineId castOther = (PrpLmedicineId) other;
