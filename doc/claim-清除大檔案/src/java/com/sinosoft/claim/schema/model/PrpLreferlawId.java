 ...
 */
@Embeddable
public class PrpLreferlawId implements java.io.Serializable {
	...
	/**
	 * 类PrpLreferlawId的默认构造方法
	 */
	public PrpLreferlawId() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof PrpLreferlawId)) {
			return false;
		}
		PrpLreferlawId castOther = (PrpLreferlawId) other;
