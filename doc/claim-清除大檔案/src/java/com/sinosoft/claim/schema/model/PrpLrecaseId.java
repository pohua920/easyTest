 ...
 */
@Embeddable
public class PrpLrecaseId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof PrpLrecaseId)) {
			return false;
		}
		PrpLrecaseId castOther = (PrpLrecaseId) other;
