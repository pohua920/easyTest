 ...
 */
@Embeddable
public class PrpLaccountId implements java.io.Serializable {
	...
	/**
	 * 类PrplaccountId的默认构造方法
	 */
	public PrpLaccountId() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof PrpLaccountId)) {
			return false;
		}
		PrpLaccountId castOther = (PrpLaccountId) other;
