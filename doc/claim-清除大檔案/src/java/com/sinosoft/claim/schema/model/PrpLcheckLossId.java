...
/**
 * POJO类PrpLcheckLossId
 */
@Embeddable
public class PrpLcheckLossId implements java.io.Serializable {
	...
	/**
	 * 类PrpLcheckLossId的默认构造方法
	 */
	public PrpLcheckLossId() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof PrpLcheckLossId)) {
			return false;
		}
		PrpLcheckLossId castOther = (PrpLcheckLossId) other;
