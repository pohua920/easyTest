...
/**
 * POJO类PrpCcarDriverId
 */
@Embeddable
public class PrpCopyCarDriverId implements java.io.Serializable {
	...
	/**
	 * 类PrpCcarDriverId的默认构造方法
	 */
	public PrpCopyCarDriverId() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof PrpCopyCarDriverId)) {
			return false;
		}
		PrpCopyCarDriverId castOther = (PrpCopyCarDriverId) other;
