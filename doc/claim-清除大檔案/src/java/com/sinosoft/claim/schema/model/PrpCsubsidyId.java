...
/**
 * PrpCsubsidyId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCsubsidyId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String proposalNo;
	private Integer serialNo;

	public PrpCsubsidyId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCsubsidyId))
			return false;
		PrpCsubsidyId castOther = (PrpCsubsidyId) other;
