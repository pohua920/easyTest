...
/**
 * POJO类PrpLreplevyDetailId
 */
@Embeddable
public class PrpLreplevyDetailId implements java.io.Serializable {
	...
	/**
	 * 类PrpLreplevyDetailId的默认构造方法
	 */
	public PrpLreplevyDetailId() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof PrpLreplevyDetailId)) {
			return false;
		}
		PrpLreplevyDetailId castOther = (PrpLreplevyDetailId) other;
