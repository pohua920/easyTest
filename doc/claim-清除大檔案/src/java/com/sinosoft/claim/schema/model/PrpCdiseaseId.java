 ...
 */
@Embeddable
public class PrpCdiseaseId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String policyNo;
	private Integer serialNo;

	public PrpCdiseaseId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCdiseaseId))
			return false;
		PrpCdiseaseId castOther = (PrpCdiseaseId) other;
