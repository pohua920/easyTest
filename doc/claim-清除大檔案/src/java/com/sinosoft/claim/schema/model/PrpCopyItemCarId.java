 ...
 */
@Embeddable
public class PrpCopyItemCarId implements java.io.Serializable {
	...
	/**
	 * 类PrpCitemCarId的默认构造方法
	 */
	public PrpCopyItemCarId() {
	}
	
	/**
	 * 类PrpCitemCarId的默认构造方法
	 */
	public PrpCopyItemCarId(String endorseNo,Integer itemNo) {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof PrpCopyItemCarId)) {
			return false;
		}
		PrpCopyItemCarId castOther = (PrpCopyItemCarId) other;
