...
/**
 * PrpCCarERiskInsId generated by Tools.Don't edit.
 */
@Embeddable
public class PrpCCarERiskInsId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String policyNo;
	private Integer serialNo;

	public PrpCCarERiskInsId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCCarERiskInsId))
			return false;
		PrpCCarERiskInsId castOther = (PrpCCarERiskInsId) other;
