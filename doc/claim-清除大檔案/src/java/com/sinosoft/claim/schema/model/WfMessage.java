 ...
 * 创建於 2005-01-04 16:32:03.593<br>
...
public class WfMessage implements Serializable {
	...
	@EmbeddedId
	@AttributeOverrides({ @AttributeOverride(name = "messageId", column = @Column(name = "MESSAGEID", nullable = false, length = 25)),
