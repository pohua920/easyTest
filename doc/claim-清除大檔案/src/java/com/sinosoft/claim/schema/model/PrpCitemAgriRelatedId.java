 ...
 */
@Embeddable
public class PrpCitemAgriRelatedId implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	private String policyNo;
	private Integer itemNo;

	public PrpCitemAgriRelatedId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PrpCitemAgriRelatedId))
			return false;
		PrpCitemAgriRelatedId castOther = (PrpCitemAgriRelatedId) other;
