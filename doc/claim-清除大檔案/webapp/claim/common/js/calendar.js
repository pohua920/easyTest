...
//insert by wangyi 2008/12/01 clear function
var dateObj=null;
function clearDate(){
  if(dateObj!=null){
    dateObj.value="";
...
document.write("<div id=meizzCalendarLayer style='position: absolute; z-index: 9999; width: 144; height: 245; display: none'>");
...
function writeIframe()
{
    ...
    "table#tableMain{ width: 142; height: 245;}"																																						+
    ...
    "    <table id=tableDay height=140 width=140 border=0 cellspacing=1 cellpadding=0>";
        ...
        //modify by wangyi 2008  2008/12/01  insert clear date function
         strIframe += "<tr>";
         for(var x=35; x<42; x++) strIframe += "<td class=out id='meizzDay"+ x +"'></td>";
         strIframe += "</tr></table></td></tr>";
         strIframe += "<tr><td><table height=30 width=140 border=0 cellspacing=0 cellpadding=0><tr>";
         strIframe +="<td class=out><input style='background-color:"										+
         WebCalendar.btnBgColor +";cursor: hand; padding-top: 4px; width: 50%; height: 100%; border: 0' onfocus='this.blur()'"				+
         " type=button value='\u6e05\u7a7a' onclick='parent.clearDate()'>"+
...
function calendar(dateObjPara) //\u4e3b\u8c03\u51fd\u6570
{   //insert by wangyi 2008/12/01
    dateObj=dateObjPara;
    //insert end
...
function StringPrototypeTrim(){return this.replace(/(^\s*)|(\s*$)/g,"");}
