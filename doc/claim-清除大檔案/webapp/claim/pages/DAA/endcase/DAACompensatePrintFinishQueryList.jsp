		...
		<s:iterator var="strcompensateNo" value="#attr.compensateNo.split(',')" status="compensateNo_status">
			<tr>
				...
				<td width="33%" align="center" class="input">
					<input type="button" name=buttonPrint13 class='button' value="<s:text name='button.print.value'/> " onclick="return printForm1(this,'${strcompensateNo }','Compensate');">
				</td>
				<!--打印-->
			</tr>
		</s:iterator>
