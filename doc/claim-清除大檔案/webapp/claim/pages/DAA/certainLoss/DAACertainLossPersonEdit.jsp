...
<span style="display:" id="SpanPerson" cellspacing="1" cellpadding="1">
			...
			<tbody>
				<tr>
					...
					<td class="input" style="width: 7%" colspan="4" align="right">
						<input type=button name="buttonPersonFeeLossDelete" class="smallbutton" onclick="deleteRowTable(this,'PersonFeeLoss',1,2)" value="-" readonly style="cursor: hand">
					</td>
				</tr>
				<tr name="trPersonFeeLoss" style="display: none;">
					<td class="input" colspan="2">
						<s:text name="certainLoss.nuclearDamage" />：
						<%--核损意见 --%>
					</td>
					<td class="input" style="width: 11%">
						<input name="prpLpersonVeriSumLoss" class="common" style="" value="0" readonly="readonly">
					</td>
					<td class="input" style="width: 11%">
						<input name="prpLpersonVeriSumReject" class="common" style="" value="0" readonly="readonly">
					</td>
					<td class="input" style="width: 11%">
						<input name="prpLpersonVeriSumDefLoss" class="common" style="" value="0" readonly="readonly">
					</td>
					<td class="input" style="width: 35%">
						<input name="prpLpersonVeriRejectReason" class="common" style=""  value="" readonly="readonly">
					</td>
					<td class="input" style="width: 7%" colspan="4" align="right">
					</td>
				</tr>
	...
	<table cellpadding="5" cellspacing="1" class="common">
		<tr class="common">
			<td colspan="4">
				<span style="display: none">
					<table class="common" style="display: none" align="center" id="person_Data" cellpadding="5" cellspacing="1">
						<tbody>
							<tr>
											...
											<td>
												<table cellpadding="1" cellspacing="1" class="common">
													...
													<tr>
														...
														<!--号牌号码-->
														<td class="right">
															<select name="familyName" style="width: 90%">
								...
								<td class="input" style="width: 4%;display:none" >
									<div align="center">
										<input type=button name="buttonPersonDelete" class=smallbutton onclick="directDeleteRow(this,'person',1,1)" value="-" style="cursor: hand">
									</div>
								</td>
							</tr>
						</tbody>
													...
													<td>
														<table cellpadding="1" cellspacing="1" class="common">
															<tr>
																...
																<!--伤者姓名-->
																<td class="right">
																	<input name="prpLpersonPersonName" style="width: 82%" class="input" value="${pageScope.prpLperson1.personName}">
																	<img src="/claim/images/bgMarkMustInput.jpg">
																</td>
															...
															<tr>
																...
																<!--险别代码-->
																<td class="right">
																	<input type="input" name="prpLpersonKindCode" style="width: 82%" class="codecode" value="${pageScope.prpLperson1.kindCode}"
																...
																<!--险别名称-->
																<td class="right">
																	<input type="input" name="prpLpersonKindName" class="codename" value="${pageScope.prpLperson1.kindName}"
																...
																<!--号牌号码-->
																<td class="right">
																	<select name="familyName" style="width: 83%">
																		<c:forEach items="${requestScope.LicenseNoList}" var="prpLthirdParty">
															...
															<tr>
																...
																<!--性别-->
																<td class="right">
																	<select name="prpLpersonPersonSex" class="three" style="width: 82%" value="${pageScope.prpLperson1.personSex}">
																...
																<!--年龄-->
																<td class="right">
																	<input name="prpLpersonPersonAge" class="input" value="${pageScope.prpLperson1.personAge}">
																</td>
																<td class="left">
																...
																<!--身份证号码-->
																<td class="right">
																	<input name="prpLpersonIdentifyNumber" class="input" style="width: 83%" value="${pageScope.prpLperson1.identifyNumber}">
																</td>
															</tr>
															<tr>
																<td class="left">
																...
																<!--所在地区-->
																<td class="right">
																	<input type="input" name="prpLpersonAreaCode" class="codecode" style="width: 27%" value="${pageScope.prpLperson1.areaCode}"
																	...
																	<input type="input" name="prpLpersonAreaName" class="codename" style="width: 51%" value="${pageScope.prpLperson1.areaName}"
																...
																<!--工作单位-->
																<td class="right" colspan="3">
																	<input name="prpLpersonJobUnit" class="input" style="width: 93.5%" value="${pageScope.prpLperson1.jobUnit}">
																</td>
															</tr>
															<tr>
																<td class="left">
																...
																<!--标准工资-->
																<td class="right">
																	<input name="prpLpersonMonthStdWage" class="input" style="width: 82%" value="<fmt:formatNumber value="${pageScope.prpLperson1.monthStdWage}" pattern="#"/>">
																</td>
																<td class="left">
																	<s:text name="certainLoss.monthlyBonuses" />：
																</td>
																<!--月奖金-->
																<td class="right">
																	<input type="input" name="prpLpersonMonthBonus" class="input" value="<fmt:formatNumber value="${pageScope.prpLperson1.monthBonus}" pattern="#"/>">
																</td>
																<td class="left">
																	<s:text name="certainLoss.subsidies" />：
																</td>
																<!--津（补）贴-->
																<td class="right">
																	<input name="prpLpersonAllowance" class="input" style="width: 83%" value="<fmt:formatNumber value="${pageScope.prpLperson1.allowance}" pattern="#"/>">
																</td>
															</tr>
															<tr>
																<td class="left">
																...
																<!--月收入小计-->
																<td class="right">
																	<input type="input" name="prpLpersonMonthWage" class="input" style="width: 82%" value="<fmt:formatNumber value="${pageScope.prpLperson1.monthWage}" pattern="#"/>">
																</td>
																<td class="left">
																	<s:text name="certainLoss.hospitals" />：
																</td>
																<!--就诊医院-->
																<td class="right">
																	<input name="prpLpersonHospital" class="input" value="${pageScope.prpLperson1.hospital}">
																</td>
																<td class="left"></td>
																<td class="right"></td>
															</tr>
															<tr>
																...
																<!--需要护理人数-->
																<td class="right">
																	<input name="prpLpersonNursePersons" class="input" style="width: 82%" value="${pageScope.prpLperson1.nursePersons}">
																</td>
																<td class="left">
																	<s:text name="certainLoss.requiredDay" />：
																</td>
																<!--需要护理天数-->
																<td class="right">
																	<input name="prpLpersonNurseDays" class="input" value="${pageScope.prpLperson1.nurseDays}">
																</td>
																<td class="left">
																	<s:text name="certainLoss.results" />：
																</td>
																<!--诊断结果-->
																<td class="right">
																	<input name="prpLpersonDiagnose" class="input" style="width: 83%" value="${pageScope.prpLperson1.diagnose}">
																</td>
															</tr>
															<tr>
																<td class="left">
																...
																<td class="right">
																	...
																	<s:select name="prpLpersonWoundGrade" value="#attr.tempSelectedValue" listKey="key" listValue="value" list="#request.woundGradeList" />
																</td>
																<td class="left">
																	<s:text name="certainLoss.hospitalsDay" />：
																</td>
																<!--拟住院天数-->
																<td class="right">
																	<input name="prpLpersonHospitalDays" class="input" value="${pageScope.prpLperson1.hospitalDays}">
																</td>
																<td class="left">
																	<s:text name="certainLoss.treatedDay" />：
																</td>
																<!--拟治疗天数-->
																<td class="right">
																	<input name="prpLpersonCureDays" class="input" style="width: 83%" value="${pageScope.prpLperson1.cureDays}">
																</td>
															</tr>
															<tr>
																<td class="left">
																...
																<td class="right">
																	...
																	<s:select name="prpLpersonChangeHospital" value="#attr.tempSelectedValue" listKey="key" listValue="value" list="#request.changeHospitalList" />
																</td>
																<td class="left">
																	<s:text name="certainLoss.incomeSituation" />：
																</td>
																...
																<!--人员类型-->
																<td class="right">
																	<select name="prpLpersonPayPersonType" style="width: 83%" onchange="setPropertyOfPage(this);">
																		<c:forEach items="${requestScope.PayPersonTypeList}" var="labelValueBean">
															...
															<tr>
																...
																<!--关联人员-->
																<td class="right">
																	<input name="prpLpersonRelatePersonNo" class="input" value="${pageScope.prpLperson1.relatePersonNo}" onchange="return checkRelatePersonNo(this);">
																</td>
																<td class="left">
																	<s:text name="verifyLoss.disableRatio" />：
																</td>
																<!--伤残比例-->
																<td class="right">
																	<input name="prpLpersonLossRate" class="input" style="width: 90%" value="${pageScope.prpLperson1.lossRate}">
																	%
																</td>
																<td class="left">
																	<s:text name="db.prpLreplevynew.currency" />：
															...
															<tr>
																...
																<!--入院日期-->
																<td class="right">
																	<rc:rcDate name="prpLpersonInHospDate" style="width:90%" value="${pageScope.prpLperson1.inHospDate}" />
																</td>
																<td class="left">
																	<s:text name="certainLoss.dischargeDate" />：
																</td>
																...
																<td class="right">
																	...
																	<rc:rcDate name="prpLpersonOutHospDate" style="width:90%" value="${pageScope.prpLperson1.outHospDate}" />
																</td>
																<td class="left">
																	<s:text name="certainLoss.dateFixed" />：
																</td>
																...
																<td class="right">
																	...
																	<rc:rcDate name="prpLpersonRestDate" style="width:83%" value="${pageScope.prpLperson1.restDate}" />
																</td>
															</tr>
															<tr>
																<td class="left">
																...
																<!--续医情况说明-->
																<td class="right">
																	<input name="prpLpersonFllowHospRemark" class="input" value="${pageScope.prpLperson1.fllowHospRemark}">
																</td>
																<td class="left">
																	<s:text name="certainLoss.industry" />：
																</td>
																...
																<td class="right" colspan="3">
																	...
																	<input type="text" name="prpLpersonTraceJobName1" class="codename" style="width: 100px" value="${pageScope.prpLperson1.jobName1}"
																	...
																	<input type="text" name="prpLpersonTraceJobName2" class="codename" style="width: 100px" value="${pageScope.prpLperson1.jobName2}"
																	...
																	<input type="text" name="prpLpersonJobName" class="codename" style="width: 100px" value="${pageScope.prpLperson1.jobName}"
															...
															<tr>
																...
																<!--备注-->
																<td class="right" colspan="5">
																	<input name="prpLpersonRemark" class="input" style="width: 89%" value="${pageScope.prpLperson1.remark}">
															...
															<tr>
																<td colspan="6">
																	<span id="spanPersonFeeLoss"> <%-- 多行输入展现域 --%>
																		<table id="PersonFeeLoss" name="PersonFeeLoss" class="common">
																			<thead>
																				<tr>
																					<td class="centertitle" colspan=10>
																						<s:text name="certainLoss.costInformation" />
																			...
																			<tfoot>
																				<tr>
																					...
																					<td class="title" align="right" style="width: 7%" colspan="4">
																						<input type="button" value="+" class="smallbutton" onclick="insertRowTable('PersonFeeLoss','PersonFeeLoss_Data',this);" name="buttonPersonFeeLossInsert" readonly
																							style="cursor: hand">
																					</td>
																				</tr>
																			</tfoot>
																				...
																				<c:forEach items="${requestScope.prpLperson.personList}" var="prpLperson2">
																					<c:if test="${pageScope.prpLperson2.id.personNo == pageScope.prpLperson1.id.personNo}">
																						...
																						<c:if test="${pageScope.prpLperson2.compensateBackFlag =='1'}">
																							...
																							<c:set var="compensatebackDiasable" value="disabled" />
																							<c:set var="compensatebackStyle" value=";background:#CECECE" />
																						</c:if>
																						<c:choose>
																							<c:when test="${empty param.flag}">
																								<tr>
																									<td class="input" style="width: 12%">
																										<input type="hidden" name="personSerialNo" style="" <c:out value="${pageScope.compensatebackReadOnly}" /> value="${prpLperson1.id.serialNo}">
																										<input type="input" name="prpLpersonFeeTypeCode" class="codecode" style="" <c:out value="${pageScope.compensatebackReadOnly}" /> value="${pageScope.prpLperson2.feeTypeCode}"
																									...
																									<td class="input" style="width: 13%">
																										<input type="input" name="prpLpersonFeeTypeName" class="codename" style="" <c:out value="${pageScope.compensatebackReadOnly}" /> value="${pageScope.prpLperson2.feeTypeName}"
																											<c:if test="${empty pageScope.compensatebackReadOnly}">
																									...
																									<td class="input" style="width: 11%">
																										<input name="prpLpersonSumLoss" class="common" style="" <c:out value="${pageScope.compensatebackReadOnly}" />
																											value="<fmt:formatNumber value="${pageScope.prpLperson2.sumLoss}" pattern="#"/>" onBlur="return calSumPersonDefLoss(this)">
																									</td>
																									<td class="input" style="width: 11%">
																										<input name="prpLpersonSumReject" class="common" style="" <c:out value="${pageScope.compensatebackReadOnly}" />
																											value="<fmt:formatNumber value="${pageScope.prpLperson2.sumReject}" pattern="#"/>" onBlur="return calSumPersonDefLoss(this);">
																									</td>
																									<td class="input" style="width: 11%">
																										<input name="prpLpersonSumDefLoss" class="common" style="" <c:out value="${pageScope.compensatebackReadOnly}" />
																											value="<fmt:formatNumber value="${pageScope.prpLperson2.sumDefLoss}" pattern="#"/>" onBlur="return calSumPersonDefLoss(this);">
																									</td>
																									<td class="input" style="width: 35%">
																										<input name="prpLpersonRejectReason" class="common" style="" <c:out value="${pageScope.compensatebackReadOnly}" /> value="${pageScope.prpLperson2.rejectReason}">
																									...
																									<td class="input" style="width: 7%" colspan="4" align="right">
																										<input type=button name="buttonPersonFeeLossDelete" class="smallbutton" <c:out value="${pageScope.compensatebackDiasable}" />
																											onclick="deleteRowTable(this,'PersonFeeLoss',1,2)" value="-" readonly style="cursor: hand">
																									</td>
																									<tr name="trPersonFeeLoss" <c:if test="${param.status !='3'}">style="display: none;"</c:if>>
																										<td class="input" colspan="2">
																											<s:text name="certainLoss.nuclearDamage" />：
																											<%--核损意见 --%>
																										</td>
																										<td class="input" style="width: 11%">
																											<input name="prpLpersonVeriSumLoss" class="readonly" style="" 
																												value="<fmt:formatNumber value="${pageScope.prpLperson2.veriSumLoss}" pattern="#"/>" readonly="readonly">
																										</td>
																										<td class="input" style="width: 11%">
																											<input name="prpLpersonVeriSumReject" class="readonly" style="" 
																												value="<fmt:formatNumber value="${pageScope.prpLperson2.veriSumReject}" pattern="#"/>" readonly="readonly">
																										</td>
																										<td class="input" style="width: 11%">
																											<input name="prpLpersonVeriSumDefLoss" class="readonly" style="" 
																												value="<fmt:formatNumber value="${pageScope.prpLperson2.veriSumDefLoss}" pattern="#"/>" readonly="readonly">
																										</td>
																										<td class="input" style="width: 35%">
																											<input name="prpLpersonVeriRejectReason" class="readonly" style=""  value="${pageScope.prpLperson2.veriRejectReason}" readonly="readonly">
																										</td>
																										<td class="input" style="width: 7%" colspan="4" align="right">
																										</td>
																									</tr>
																							...
																							<c:otherwise>
																								<tr>
																									<td class="input" style="width: 12%">
																										<input type="hidden" name="personSerialNo" style="" value="${prpLperson1.id.serialNo}">
																										<input type="input" name="prpLpersonFeeTypeCode" class="codecode" style="" <c:out value="${pageScope.compensatebackReadOnly}" /> value="${pageScope.prpLperson2.feeTypeCode}"
																											<c:if test="${empty pageScope.compensatebackReadOnly}">
																                                          ondblclick= "code_CodeSelect(this,'PersonFeeType','0,1','Y','Y',fm.prpLverifyLossRiskCode.value);"
																                                          onchange="code_CodeChange(this, 'PersonFeeType','0,1','Y','Y',fm.prpLverifyLossRiskCode.value);"
																									...
																									<td class="input" style="width: 11%">
																										<input name="prpLpersonSumDefLoss" class="common" style="" <c:out value="${pageScope.compensatebackReadOnly}" />
																											value="<fmt:formatNumber value="${pageScope.prpLperson2.sumDefLoss}" pattern="#"/>">
																									</td>
																									<td class="input" style="width: 35%">
																										<input name="prpLpersonRejectReason" class="common" style="" <c:out value="${pageScope.compensatebackReadOnly}" /> value="${pageScope.prpLperson2.rejectReason}">
																										<input type="hidden" name="prpLpersonItemKindNo" value="${pageScope.prpLperson2.itemKindNo}">
