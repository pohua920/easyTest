...
var intHeight = -53 //调整打印高度（上下对位置）
	...
	function openWinSave() {
		...
		msg = window.open(
			"/claim/DAA/print/indemnityReceiptSave.jsp?" + param,
			"NewWindow",
			"toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=no,resizable=no,width=600,Height=300,left=200,top=200");
	}
...
<body leftmargin=0 topmargin=0 onload="loadForm()" style="font-family: 宋体; font-size: 11pt;">
	<form name=fm>
		<span id="spClaimNo" style="WIDTH: 300px; LEFT: 370px; POSITION: absolute; TOP: 105px; font-family: 宋体; font-size: 11pt;">赔案号：<%=strClaimNo%></span> <span id="spComName1"
			...
			style="WIDTH: 400px; LEFT: 150px; POSITION: absolute; TOP: 250px; font-family: 宋体; font-size: 11pt;"><%=strSumPrePaid%></span> <span id="spSumPaid"
			style="WIDTH: 400px; LEFT: 420px; POSITION: absolute; TOP: 250px; font-family: 宋体; font-size: 11pt;"><%=strCSumPrePaid%></span> <span id="spSumPrePaid"
			style="WIDTH: 400px; LEFT: 340px; POSITION: absolute; TOP: 300px; font-family: 宋体; font-size: 11pt;">预付赔款</span> <span id="spuserName"
