...
<body bgcolor="#FFFFFF">
	...
	<table border=1 width="97%" align="center" cellspacing="0" cellpadding="2" style="border-collapse: collapse" bordercolor="#111111" style="font-family:宋体; font-size:10pt;">
		<tr>
			<td width="2%" rowspan="2">序 号</td>
			<td width="7%">立案编号</td>
			<td width="7%">被保险人</td>
			<td width="7%">厂牌型号</td>
			<td width="8%">驾驶员姓名</td>
			<td colspan="2">出险地点</td>
			<td width="7%" w>报案方式</td>
			<td width="8%" rowspan="2">受理人处理意见</td>
			<td width="12%" rowspan="2">承保公司回應情况日期及委托事宜</td>
			<td width="8%">查勘人员</td>
			<td width="6%" rowspan="2">查勘时间</td>
			<td width="6%" rowspan="2">估损金额合计</td>
