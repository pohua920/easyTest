...
<%--系统内从prpdcompany带出，系统外则从客户资料表prpdcustomer_unit中取值--%>
			...
			<table class=common cellpadding="0" cellspacing="1" width="100%">
				...
				<tr>
					...
					<td class="right">
						...
						<input name="prpLcheckDamageName" class="codename" style="width: 70%" maxlength=20 description="<s:text name='db.prpLregist.damageCode'/>" value="${prpLcheck.damageName}"
				...
				<tr>
					...
					<td class="right" colspan="3">
						...
						<input type="text" name="prpLcheckDamageAddress" onchange="changeLDamageAddress()" class="input" style="width: 350px" value="${prpLcheck.damageAddress}" onclick="showProvinceCity(this,'countryCName','prpLcheckAddressName');" selectValue="${prpLcheck.addressName}">
					</td>
					<td class="left"></td>
					<td class="right"></td>
				</tr>
		...
		<td>
			<table class=common cellpadding="0" cellspacing="1" width="100%">
				...
				<tr>
					...
					<td class="right">
						<input name='prpLcheckEstimateLoss' class='input' maxlength=20  value="<fmt:formatNumber value="${prpLcheck.estimateLoss}"pattern="#"/>">
						<img src="/claim/images/bgMarkMustInput.jpg">
					</td>
					<td class="left" style="valign: bottom">
						<%--预估费用 --%>
					...
					<td class="right" style="valign: middle">
						<input name='prpLcheckEstimateFee' class='input' maxlength=20 value="<fmt:formatNumber value="${prpLcheck.estimateFee}"pattern="#"/>">
						<img src="/claim/images/bgMarkMustInput.jpg">
					</td>
				</tr>
			</table>
