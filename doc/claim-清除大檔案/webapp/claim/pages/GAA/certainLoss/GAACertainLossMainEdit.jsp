...
<table border="0" align="center" cellpadding="0" cellspacing="0" class="common">
	<tr>
		...
		<td>
			<input type="button" name="message" value="<s:text name='button.composeMessage.value'/>" class="bigbutton" onclick="openWinSave()">
		</td>
		<td>
			<input type="button" name="messageView" value="<s:text name='button.viewMessage.value'/>" class="bigbutton" onclick="openWinQuery()">
		</td>
		<td width="70%" align="right">
			<font color="#666666"> <s:text name="scheduleObject.note1" />“<font color="#FF0000">*</font>”<s:text name="scheduleObject.note2" />，“<img src="/claim/images/bgDoubleClick2.gif" width="13"
				height="13" align="absbottom">”<%-- 撰写留言 --%>
				<%--  查看留言--%>
				<%-- 注： --%>
