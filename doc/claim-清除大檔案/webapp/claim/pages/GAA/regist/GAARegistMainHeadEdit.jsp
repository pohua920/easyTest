...
<table class="common" align="center" width="100%">
	...
	<tr>
		...
		<td class="input" colspan="3">
			...
			<span id="prpLregistInsuredNameSpan"> 
				<input type=text name="prpLregistInsuredName" title="<s:text name='db.prpCmain.insuredName'/>" class="codecode" style="width: 34%" ondblclick="getCinsured(this);"
	...
	<tr>
		...
		<%-- 保险期间 --%>
		<td class="input">
			<%-- <input type=text name="prpLregistStartDate" title="起保日期" class="readonly" style="width:80px" readonly="true"  value="${prpLregist.startDate}">${ startHour}--%>
			...
			${startHour}
			<%-- <input type=text name="prpLregistEndDate"   title="终保日期" class="readonly" style="width:80px" readonly="true"   value="${prpLregist.endDate}">${endHour}--%>
	...
	<tr>
		...
		<%-- 报案时间 --%>
		<td class="input">
			<rc:rcDate name="prpLregistReportDate" class="readonly" readonly="true" wdatePicker="false" style="width:80px" value="${prpLregist.reportDate}" onchange="flashPage(this);"/>
			<s:text name="regist.prpLregist.date" />
			<input name="prpLregistReportHour" class="input" maxlength="2" style="width: 25px" class="readonly" readonly="true" value="${prpLregist.reportHour}" onchange="flashPage(this);">
			<s:text name="regist.prpLregist.hour" />
			<%-- 时 --%>
			<input name="prpLregistReportMinute" class="input" maxlength="2" style="width: 25px" class="readonly" readonly="true" value="${prpLregist.reportMinute}" onchange="flashPage(this);">
	...
	<tr>
		...
		<td class="input">
			<input type="text" name="prpLregistLinkerName" title="<s:text name='db.prpDagent.linkerName'/>" class="input" style="width: 80%" value="${prpLregist.linkerName}" /><%-- 联系人 --%>
			<img src="${ctx}/images/bgMarkMustInput.jpg">
		</td>
		<td class="title">
	...
	<%@ include file="/pages/GAA/regist/GAARegistLinkmanEdit.jsp"%>
	<tr>
		<td class="title">
	...
	<tr>
		...
		<td class="input" colspan='3'>
			...
			<input type=text class="codecode" name="countryCName" style="display: none" title="<s:text name='common.select.country'/>" style="width:120px" ondblclick="code_CodeSelect(this, 'CountryCode','-1,0','Y','N');"
				onkeyup="code_CodeSelect(this, 'CountryCode','-1,0','Y','N');" onchange="code_CodeSelect(this, 'CountryCode','-1,0','Y','N');" /><%-- 选择国家名 --%>
			...
			<input type=hidden class="codecode" name="provinceName" title="<s:text name='common.select.province'/>" ondblclick="code_CodeSelect(this, 'utiAdminProvice','-1,0','Y','N');"
				onkeyup="code_CodeSelect(this, 'utiAdminProvice','-1,0','Y','N');" onchange="code_CodeSelect(this, 'utiAdminProvice','-1,0','Y','N');" value=""/><%-- 选择省 --%>
			<input type=hidden class="codecode" name="cityCode" style="display: none" />
			<input type=hidden class="codecode" name="cityName" title="<s:text name='common.select.city'/>" style="width: 120px" ondblclick="code_CodeSelect(this, 'utiAdminCity','-1,0','Y','N',fm.provinceCode.value);"
				onkeyup="code_CodeSelect(this, 'utiAdminCity','-1,0','Y','N',fm.provinceCode.value);" onchange="code_CodeSelect(this, 'utiAdminCity','-1,0','Y','N',fm.provinceCode.value);" /><%-- 选择市 --%>
			...
			<input type=text name="prpLregistDamageAddress" title="<s:text name='db.prpLregist.damageAddress'/>" Class="input" style="width: 350px" value="${prpLregist.damageAddress}" onclick="showProvinceCity(this,'countryCName','prpLregistAddressName');" selectValue="${prpLregist.addressName}"><%-- 出险地点 --%>
			<img src="${ctx }/images/bgMarkMustInput.jpg">
		</td>
	</tr>
	<tr>
