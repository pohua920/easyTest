...
<table id="buttonArea" cellpadding="0" cellspacing="0" width="80%" style="display:">
	...
	<tr>
		<logic:equal name="prpLregistDto" property="status" value="1">
		...
		<logic:equal name="prpLregistDto" property="status" value="2">
		...
		<logic:equal name="prpLregistDto" property="status" value="3">
			<td class=button style="width: 33%" align="center">
				<!--保存按钮-->
			...
			<td class=button style="width: 33%" align="center">
				<!--回退按钮-->
				<input type="button" name=buttonSave class='button' value="<s:text name='button.fallback.value'/>" onclick="return saveForm(this,'2');">
			</td>
			<td class=button style="width: 33%" align="center">
				<!--提交按钮-->
				<input type="button" name=buttonSaveFinishSubmit class='button' value="<s:text name='button.submit.value'/>" onclick="return saveForm(this,'4');">
