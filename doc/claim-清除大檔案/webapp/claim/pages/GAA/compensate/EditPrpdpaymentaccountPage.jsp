				...
				<table class="common" style="width: 100%">
					...
					<tr>
						...
						<td class="input" style="width: 18%">
							...
							<input name="prpLpayObjectInfoOwnerName" class="input" maxlength="100" value="">
							<img src="${ctx}/images/bgMarkMustInput.jpg">
						</td>
						<td class="title" style="width: 15%"><s:text name="claim.payoutType"/>：</td><%--费用类型--%>
						<td class="input" style="width: 18%">
							<s:select name="prpLpayObjectInfoPaymentKind" onchange="changePaymentKind(this);" value="'4'" list="#request.paymentKindList" listKey="key" listValue="value" style="width: 50%" ></s:select>
					...
					<tr name="AreaInfo">
						...
						<!--  \webapp\claim\pages\GAA\compensate\EditPrpdpaymentaccountPage.jsp -->
								...
								<td class="subformtitle" style="width: 96%">
									<table class="common" style="width: 100%">
										...
										<tr>
											...
											<td class="input" style="width: 18%">
												<!-- mantis： CLM0017，處理人員：Sam，需求單編號：CLM0017，原住名姓名調整作業_車 -->
												<input name="prpLpayObjectInfoOwnerName" class="input" maxlength="100" value="${prpLpayObject.ownerName}">
												<img src="${ctx}/images/bgMarkMustInput.jpg">
											</td>
											<td class="title" style="width: 15%"><s:text name="claim.payoutType"/>：</td><%--费用类型--%>
											<td class="input" style="width: 18%">
												<s:select name="prpLpayObjectInfoPaymentKind" onchange="changePaymentKind(this);" value="#attr.prpLpayObject.paymentKind" list="#request.paymentKindList" listKey="key" listValue="value" style="width: 50%" ></s:select>
												<img src="${ctx}/images/bgMarkMustInput.jpg" complete="complete" />
											</td>
										...
										<!-- mantis：CLM0145，處理人員：DP0713，需求單編號：CLM0145，.新核心-理算任務處理賠付對象郵遞區號長度檢核 -->
										<!--  \webapp\claim\pages\GAA\compensate\EditPrpdpaymentaccountPage.jsp 2-->
