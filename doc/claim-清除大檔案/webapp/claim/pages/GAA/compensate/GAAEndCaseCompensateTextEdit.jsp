...
<script type="text/javascript">
	function getContext(field){
		...
		if (contextNo == "") {
			...
			$.post("${ctx}/compensate/getCompeContext.do", {
				contextNo : contextNo,
				riskCode : riskCode
			}, function(data){
...
<table class="common" cellpadding="5" cellspacing="1" id="Lltext" style="display: none">
	<tr>
		<td class="common" style="text-align: left;">
			...
			<input type="hidden" class=readonly readonly name="tdLltextTitle" value="<s:text name='compensate.adjustmentInformation'/>">
			<input class=readonly readonly value="理算說明" style="width: 75px">
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
