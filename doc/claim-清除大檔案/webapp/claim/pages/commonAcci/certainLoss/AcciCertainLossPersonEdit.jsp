...
****************************************************************************
--%>
<span style="display:" id="SpanPerson" cellspacing="1" cellpadding="0"> <span style="display: none">
			...
			<tbody>
				<tr>
					<td class="input">
						...
						<input type="input" name="prpLpersonKindCode" class="codecode" style="width: 40px" ondblclick="code_CodeSelect(this,'PolicyKindCode');" onkeyup="code_CodeSelect(this,'PolicyKindCode');">
					</td>
					<td class="input">
						<input type="input" name="prpLpersonKindName" class="codename" style="width: 100px" ondblclick="code_CodeSelect(this, 'PolicyKindCode','-1','always','none','post');" onkeyup="code_CodeSelect(this, 'PolicyKindCode','-1','always','none','post');">
					</td>
					<td class="input">
						<input type="input" name="prpLpersonItemCode" class="codecode" style="width: 40px" ondblclick="code_CodeSelect(this,'PolicyKindCode');" onkeyup="code_CodeSelect(this,'PolicyKindCode');">
						<input type="input" name="prpLpersonItemName" class="codename" style="width: 80px" ondblclick="code_CodeSelect(this, 'PolicyKindCode','-1','always','none','post');" onkeyup="code_CodeSelect(this, 'PolicyKindCode','-1','always','none','post');">
					</td>
					<td class="input">
						<input type="input" name="prpLpersonFeeTypeCode" class="codecode" style="width: 40px" ondblclick="code_CodeSelect(this,'FeeTypeCode');" onkeyup="code_CodeSelect(this,'FeeTypeCode');">
						<input type="input" name="prpLpersonFeeTypeName" class="codename" style="width: 60px" ondblclick="code_CodeSelect(this, 'FeeTypeCode','-1','always','none','post');" onkeyup="code_CodeSelect(this, 'FeeTypeCode','-1','always','none','post');">
					</td>
					<td class="input">
						<input type="input" name="prpLpersonCurrency" class="codecode" style="width: 30px" ondblclick="code_CodeSelect(this,'Currency');" onkeyup="code_CodeSelect(this,'Currency');">
						<input type="input" name="prpLpersonCurrencyName" class="codename" style="width: 60px" ondblclick="code_CodeSelect(this, 'Currency','-1','always','none','post');" onkeyup="code_CodeSelect(this, 'Currency','-1','always','none','post');">
					</td>
					<td class="input">
	...
	<table align="center" border="0" cellpadding="1" cellspacing="1" class="common" width="100%">
		<!--表示显示多行的-->
		<tr>
			<td class="subformtitle" colspan="4" align="center">
				<s:text name="commonAcci.certainLoss.personnelShallDamage" />
				<%--人员核定损清单--%>
			</td>
		</tr>
		<tr>
			<td class="subformtitle" colspan="4">
									...
									<table cellpadding="0" cellspacing="1" class="common">
										<tr>
											...
											<td class="input" style="width: 85%" colspan="3">
												<input name="prpLpersonPersonName" class="input" style="width: 150px">
										...
										<tr>
											...
											<td class="input" style="width: 35%">
												<select name="prpLpersonPersonSex" class='input' style="width: 110">
													<option value="1">
										...
										<tr>
											<td class="title" style="width: 15%">
												<s:text name="commonAcci.certainLoss.currency" />:
											</td>
											<%--折合币别--%>
											<td class="input" style="width: 35%">
												<input name="prpLpersonCurrency2" type="text" class="readonly" readonly style="width: 50px" value="CNY">
												<input name="prpLpersonCurrency2Name" class="readonly" readonly style="width: 150px" value="人民币">
											</td>
											<td class="title" style="width: 15%">
												<s:text name="compensate.compel.lossTotal" />:
											</td>
											<%--损失合计--%>
											<td class="input" style="width: 35%">
												<input name="prpLpersonSumDefLossSum" class="readonly" readonly style="width: 150px">
											</td>
										</tr>
										<tr>
											<td class="title" style="width: 15%">
											...
											<td class="input" style="width: 50%" colspan="2">
												<input name="prpLpersonRemark" class="input" style="width: 350px">
												<input type="hidden" name="prpLpersonPersonNo">
											</td>
											<td class="input" align="center" style="width: 35%">
												<input type="button" class="bigbutton" name="button_Person_Collect" value="<s:text name='button.lossTotal.value' />" onclick="alert('损失合计');">
											</td>
											<%--损失合计--%>
										</tr>
										<tr>
													...
													<table id="PersonFeeLoss" name="PersonFeeLoss" class="common" align="center" cellspacing="1" cellpadding="0">
														<thead>
															...
															<tr>
																...
																<%--险别代码--%>
																<td class="centertitle" style="width: 17%">
																	<s:text name="regist.prpLregist.kindName" />
																</td>
																<%--险别名称--%>
																<td class="centertitle" style="width: 20%">
																	<s:text name="commonAcci.certainLoss.classificateResponsib" />
																</td>
																<%--责任分类--%>
																<td class="centertitle" style="width: 18%">
																	<s:text name="commonAcci.certainLoss.responsibilityDetail" />
																</td>
																<%--责任明细--%>
				...
				</span> <span id="spanPerson"> <%-- 多行输入展现域 --%>
					<table id="person" class="common" align="center" cellspacing="1" cellpadding="0">
						...
						<tfoot>
							<tr>
								...
								<td class="title" align="right" style="width: 4%">
									<div align="center">
										<input type="button" class="smallbutton" value="+" onclick="insertRow('person')" name="buttonPersonInsert" style="cursor: hand">
									</div>
								</td>
							</tr>
						</tfoot>
								...
								<td class="subformtitle">
									<table cellpadding="0" cellspacing="1" class="common">
										<tr>
											...
											<%--人员姓名--%>
											<td class="input" style="width: 85%" colspan="3">
												<input name="prpLpersonPersonName" class="input" style="width: 150px" value="<%=PrpLpersonDto1.getPersonName()%>">
												<img src="/claim/images/bgMarkMustInput.jpg">
											</td>
										</tr>
										<tr>
											...
											<%--性别--%>
											<td class="input" style="width: 35%">
												<select name="prpLpersonPersonSex" class="three" style="width: 110px" value="<%=PrpLpersonDto1.getPersonSex()%>">
													<option value="1" <%=PrpLpersonDto1.getPersonSex().trim().equals("1") ? "selected" : ""%>>
														<s:text name="certainLoss.male" />
													</option>
													<%--男--%>
													<option value="2" <%=PrpLpersonDto1.getPersonSex().trim().equals("2") ? "selected" : ""%>>
														<s:text name="certainLoss.female" />
													</option>
													<%--女--%>
												</select>
										...
										<input type="hidden" name="familyName" style="width: 150px" value="<%=PrpLpersonDto1.getFamilyName()%>">
										...
										<tr>
											...
											<td class="input" align="center" style="width: 35%">
												<input type="button" name="button_Person_Collect" class="bigbutton" value="<s:text name='button.lossTotal.value' />" onclick="alert('损失合计');">
											</td>
											<%--损失合计--%>
										</tr>
										<tr>
														...
														<tbody>
															...
															<tr>
																<td class="input">
																	...
																	<input type="input" name="prpLpersonKindCode" class="codecode" style="width: 40px" value="<%=PrpLpersonDto2.getKindCode()%>" ondblclick="code_CodeSelect(this,'PolicyKindCode');" onkeyup="code_CodeSelect(this,'PolicyKindCode');">
																</td>
																<td class="input">
																	<input type="input" name="prpLpersonKindName" class="codename" style="width: 100px" value="<%=PrpLpersonDto2.getKindName()%>" ondblclick="code_CodeSelect(this, 'PolicyKindCode','-1','always','none','post');" onkeyup="code_CodeSelect(this, 'PolicyKindCode','-1','always','none','post');">
																</td>
																<td class="input">
																	<input type="input" name="prpLpersonItemCode" class="codecode" style="width: 40px" value="<%=PrpLpersonDto2.getItemCode()%>" ondblclick="code_CodeSelect(this,'PolicyKindCode');" onkeyup="code_CodeSelect(this,'PolicyKindCode');">
																	<input type="input" name="prpLpersonItemName" class="codename" style="width: 80px" value="<%=PrpLpersonDto2.getItemName()%>" ondblclick="code_CodeSelect(this, 'PolicyKindCode','-1','always','none','post');" onkeyup="code_CodeSelect(this, 'PolicyKindCode','-1','always','none','post');">
																</td>
																<td class="input">
																	<input type="input" name="prpLpersonFeeTypeCode" class="codecode" style="width: 40px" value="<%=PrpLpersonDto2.getFeeTypeCode()%>" ondblclick="code_CodeSelect(this,'FeeTypeCode');" onkeyup="code_CodeSelect(this,'FeeTypeCode');">
																	<input type="input" name="prpLpersonFeeTypeName" class="codename" style="width: 60px" value="<%=PrpLpersonDto2.getFeeTypeName()%>" ondblclick="code_CodeSelect(this, 'FeeTypeCode','-1','always','none','post');" onkeyup="code_CodeSelect(this, 'FeeTypeCode','-1','always','none','post');">
																</td>
																<td class="input">
																	<input type="input" name="prpLpersonCurrency" class="codecode" style="width: 30px" value="<%=PrpLpersonDto2.getCurrency()%>" ondblclick="code_CodeSelect(this,'Currency');" onkeyup="code_CodeSelect(this,'Currency');">
																	<input type="input" name="prpLpersonCurrencyName" class="codename" style="width: 60px" value="<%=PrpLpersonDto2.getCurrencyName()%>" ondblclick="code_CodeSelect(this, 'Currency','-1','always','none','post');" onkeyup="code_CodeSelect(this, 'Currency','-1','always','none','post');">
																</td>
																<td class="input">
																	<input name="prpLpersonSumLoss" class="common" style="width: 60px" value="<%=PrpLpersonDto2.getSumLoss()%>" onBlur="return calSumPersonDefLoss(this);">
																</td>
																<td class="input">
															...
															<tr>
																<td class="input">
																	<input type="hidden" name="personSerialNo" style="width: 20px" value="<%=personNo + 1%>">
																	<input type="input" name="prpLpersonKindCode" class="codecode" style="width: 60px" value="<%=PrpLpersonDto2.getKindCode()%>" ondblclick="code_CodeSelect(this,'PolicyKindCode');" onkeyup="code_CodeSelect(this,'PolicyKindCode');">
																</td>
																<td class="input">
																	<input type="input" name="prpLpersonKindName" class="codename" style="width: 80px" value="<%=PrpLpersonDto2.getKindName()%>" ondblclick="code_CodeSelect(this, 'PolicyKindCode','-1','always','none','post');" onkeyup="code_CodeSelect(this, 'PolicyKindCode','-1','always','none','post');">
																</td>
																<td class="input">
																	<input type="input" name="prpLpersonFeeTypeCode" class="codecode" style="width: 60px" value="<%=PrpLpersonDto2.getFeeTypeCode()%>" ondblclick="code_CodeSelect(this,'FeeTypeCode');" onkeyup="code_CodeSelect(this,'FeeTypeCode');">
																</td>
																<td class="input">
																	<input type="input" name="prpLpersonFeeTypeName" class="codename" style="width: 80px" value="<%=PrpLpersonDto2.getFeeTypeName()%>" ondblclick="code_CodeSelect(this, 'FeeTypeCode','-1','always','none','post');" onkeyup="code_CodeSelect(this, 'FeeTypeCode','-1','always','none','post');">
																</td>
																<td class="input">
																	<input name="prpLpersonUnitLoss" title="單價" class="common" style="width: 60px" value="<%=PrpLpersonDto2.getUnitLoss()%>">
																</td>
																<td class="input">
																...
																<td class="input">
																	<input name="prpLpersonSumReject" class="common" style="width: 60px" value="<%=PrpLpersonDto2.getSumReject()%>" onBlur="return calSumPersonDefLoss(this);">
																</td>
																<td class="input">
																	<input name="prpLpersonSumDefLoss" class="common" style="width: 60px" value="<%=PrpLpersonDto2.getSumDefLoss()%>">
																	<input type="hidden" name="prpLpersonItemKindNo" value="<%=PrpLpersonDto2.getItemKindNo()%>">
															...
															<tr>
																...
																<td class="input">
																	<input name="prpLpersonVeriSumLoss" class="common" style="width: 60px" value="<%=PrpLpersonDto2.getVeriSumLoss()%>">
																</td>
																<td class="input">
																	<input name="prpLpersonVeriSumReject" class="common" style="width: 60px" value="<%=PrpLpersonDto2.getVeriSumReject()%>">
																</td>
																<td class="input">
																	<input name="prpLpersonVeriSumDefLoss" class="common" style="width: 60px" value="<%=PrpLpersonDto2.getVeriSumDefLoss()%>">
																</td>
																<td class="input">&nbsp;</td>
															</tr>
															<%
