...
<span id="SpanProp"> <!--建立显示的录入条，可以收缩显示的-->
	<table class="common" align="center" style="width: 100%" cellspacing="1" cellpadding="0">
		<!--表示显示多行的-->
		<tr>
			<td class="subformtitle" colspan="4">
				<s:text name="commonAcci.certainLoss.damagePropertyInfo" />
				<br>
				<%--财产损失清单信息--%>
									...
									<table cellpadding="0" cellspacing="1" class="common">
										<tr>
											...
											<td class="input" style='width: 35%'>
												<input type="input" name="prpLpropKindCode" class="codecode" style='width: 25%' ondblclick="code_CodeSelect(this,'PolicyKindCode');" onkeyup="code_CodeSelect(this,'PolicyKindCode');">
												<input type="input" name="prpLpropKindName" class="codename" style='width: 60%' ondblclick="code_CodeSelect(this, 'PolicyKindCode','-1','always','none','post');" onkeyup="code_CodeSelect(this, 'PolicyKindCode','-1','always','none','post');">
											</td>
											<td class="title">
												<s:text name="db.prpVersion.projectName" />：
											</td>
											<%--项目名称--%>
											<td class="input">
										...
										<tr>
											<td class="title">
												<s:text name="compensate.compel.lossProject" />：
											</td>
											<%--损失项目--%>
										...
										<tr>
											...
											<%--损失明细--%>
											<td class="input">
												<input type="input" name="feeTypeCode" class="codecode" style='width: 25%' ondblclick="code_CodeSelect(this,'ChargeCode');" onkeyup="code_CodeSelect(this,'ChargeCode');">
												<input type="input" name="prpLpropFeeTypeName" class="codename" style='width: 60%' ondblclick="code_CodeSelect(this, 'ChargeCode','-1','always','none','post');" onkeyup="code_CodeSelect(this, 'ChargeCode','-1','always','none','post');">
											</td>
											<td class="title">
											...
											<%--币别--%>
											<td class="input">
												<input class="input" style='width: 25%' name="prpLpropCurrency" value="CNY" class="readonly" readonly ondblclick="code_CodeSelect(this,'Currency');" onkeyup="code_CodeSelect(this,'Currency');">
												<input class="input" name="prpLpropCurrencyName" style='width: 60%' value="人民币" class="readonly" readonly ondblclick="code_CodeSelect(this, 'Currency','-1','always','none','post');" onkeyup="code_CodeSelect(this, 'Currency','-1','always','none','post');">
											</td>
										</tr>
										<tr>
											<td class="title">
											...
											<td class="title">
												<s:text name="commonAcci.certainLoss.damagQuantity" />：
											</td>
											<%--受损数量--%>
											<td class="input">
										...
										<tr>
											<td class="title">
												<s:text name="commonAcci.certainLoss.allowDepreciate" />：
											</td>
											<%--折旧率--%>
											<td class="input" colspan="3">
										...
										<tr>
											...
											<%--剔除金额--%>
											<td class="input">
												<input class="input" name="prpLpropSumReject">
											</td>
										</tr>
										<tr>
											<td class="title">
												<s:text name="commonAcci.certainLoss.lossRate" />：
											</td>
											<%--损失率--%>
											<td class="input">
											...
											<td class="title">
												<s:text name="commonAcci.certainLoss.checkUnderlyLoss" />：
											</td>
											<%--核定标的损失--%>
											<td class="input">
												<input class="input" name="prpLpropSumDefLoss">
											</td>
										</tr>
										<tr>
											<td class="title">
												<s:text name="db.prpLmedicine.rejectReason" />：
											</td>
											<%--剔除原因--%>
											<td class="input" colspan="3">
										...
										<td class="subformtitle">
											<table cellpadding="0" cellspacing="1" class="common">
												<tr>
													...
													<%--险别--%>
													<td class="input" style='width: 35%'>
														<input type="input" name="prpLpropKindCode" class="codecode" style='width: 25%' value="<bean:write name='prpLpropDto1' property='kindCode'/>" ondblclick="code_CodeSelect(this,'PolicyKindCode');" onkeyup="code_CodeSelect(this,'PolicyKindCode');">
														<input type="input" name="prpLpropKindName" class="codename" style='width: 60%' value="<bean:write name='prpLpropDto1' property='kindName'/>" ondblclick="code_CodeSelect(this, 'PolicyKindCode','-1','always','none','post');" onkeyup="code_CodeSelect(this, 'PolicyKindCode','-1','always','none','post');">
													</td>
													<td class="title">
														<s:text name="db.prpVersion.projectName" />：
													</td>
												...
												<tr>
													...
													<%--损失项目--%>
													<td class="input" colspan="3">
														<input name="prpLpropLossItemName" class=common value="<bean:write name='prpLpropDto1' property='lossItemName'/>">
													</td>
												</tr>
												<tr>
													<td class="title">
													...
													<%--损失明细--%>
													<td class="input">
														<input type="input" name="feeTypeCode" class="codecode" style='width: 25%' value="<bean:write name='prpLpropDto1' property='feeTypeCode'/>" ondblclick="code_CodeSelect(this,'ChargeCode');" onkeyup="code_CodeSelect(this,'ChargeCode');">
														<input type="input" name="prpLpropFeeTypeName" class="codename" style='width: 60%' value="<bean:write name='prpLpropDto1' property='feeTypeName'/>" ondblclick="code_CodeSelect(this, 'ChargeCode','-1','always','none','post');" onkeyup="code_CodeSelect(this, 'ChargeCode','-1','always','none','post');">
													</td>
													<td class="title">
														<s:text name="db.prpLperson.currency" />：
													</td>
													<%--币别--%>
													<td class="input">
														<input type="input" style='width: 25%' name="prpLpropCurrency" value="<bean:write name='prpLpropDto1' property='currency'/>" class="readonly" readonly ondblclick="code_CodeSelect(this,'Currency');" onkeyup="code_CodeSelect(this,'Currency');">
														<input type="input" name="prpLpropCurrencyName" style='width: 60%' value="<bean:write name='prpLpropDto1' property='currencyName'/>" class="readonly" readonly ondblclick="code_CodeSelect(this, 'Currency','-1','always','none','post');" onkeyup="code_CodeSelect(this, 'Currency','-1','always','none','post');">
													</td>
												</tr>
												<tr>
													<td class="title">
													...
													<%--单价--%>
													<td class="input">
														<input class="input" name="prpLpropUnitPrice" value="<bean:write name='prpLpropDto1' property='unitPrice'/>">
													</td>
													<td class="title">
														<s:text name="commonAcci.certainLoss.damagQuantity" />：
													</td>
													<%--受损数量--%>
													<td class="input">
														<input class="input" name="prpLpropLossQuantity" value="<bean:write name='prpLpropDto1' property='lossQuantity'/>">
													</td>
												</tr>
												<tr>
													<td class="title">
													...
													<%--折旧率--%>
													<td class="input" colspan="3">
														<input class="input" name="prpLpropDepreRate" value="<bean:write name='prpLpropDto1' property='depreRate'/>">%
													</td>
												</tr>
												<tr>
													<td class="title">
													...
													<%--剔除金额--%>
													<td class="input">
														<input class="input" name="prpLpropSumReject" value="<bean:write name='prpLpropDto1' property='sumReject'/>">
													</td>
												</tr>
												<tr>
													<td class="title">
													...
													<%--损失率--%>
													<td class="input">
														<input class="input" name="prpLpropLossRate" value="<bean:write name='prpLpropDto1' property='lossRate'/>">%
													</td>
													<td class="title">
														<s:text name="commonAcci.certainLoss.checkUnderlyLoss" />：
													</td>
													<%--核定标的损失--%>
													<td class="input">
														<input class="input" name="prpLpropSumDefLoss" value="<bean:write name='prpLpropDto1' property='sumDefLoss'/>">
													</td>
												</tr>
												<tr>
													<td class="title">
													...
													<%--剔除原因--%>
													<td class="input" colspan="3">
														<input class="input" name="prpLpropRejectReason" value="<bean:write name='prpLpropDto1' property='rejectReason'/>">
													</td>
												</tr>
												<tr>
													<td class="title">
													...
													<%--备注--%>
													<td class="input" colspan="3">
														<input class="input" name="prpLpropRemark" value="<bean:write name='prpLpropDto1' property='remark'/>">
	...
	<table border="0" align="center" cellpadding="5" cellspacing="1" class="common">
		<tr>
			<td class='title' width="33%">
				...
				<input class='readonly' readonly="true" name='prpLpropSumSumLoss'>
				<%--受损金额合计--%>
			</td>
			<td class='title' width="33%">
				<s:text name="certainLoss.removeTotals" />:
				<input class='readonly' readonly="true" name='prpLpropSumSumReject'>
				<%--剔除金额合计--%>
			</td>
			<td class='title' width="33%">
				<s:text name="certainLoss.lossTotal" />:
				<input class='readonly' readonly="true" name='prpLpropSumSumDefLoss'>
				<%--定损金额合计--%>
			</td>
		</tr>
	</table>
