				...
				<table class="sub" style='width: 100%' id="Engage">
					...
					<tbody>
						...
						<tr class=oddrow>
							...
							<td class="centertitle">
								<input type=button ACCESSKEY="." num=<%=indexEngage%> value='...' name='button_Engage_Open_Context' onclick="buttonOnClick1(this);">
									...
									<table class="prompt">
										...
										<tr>
											<td colspan=6 class="prompttitle">
												<input type=button name='button_Engage_Close_Context' value="<s:text name='button.close.value' />" ACCESSKEY="O" onclick="hideSubPage(this,'span_Engage_Context')">
											</td>
										</tr>
									</table>
								</span>
