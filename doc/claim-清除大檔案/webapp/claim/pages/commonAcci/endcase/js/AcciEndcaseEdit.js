...
function saveForm(field, saveType) {
	if (!confirm(i18n.commonAcci.endcase.notModifySureClos)) //结案後不能再修改。\n确定结案吗？
		return false;
...
function openWinSave1() {
	...
	msg = window.open("/claim/messageSave.do?businessNo=" + businessNo + "&nodeType=endca&policyNo=" + policyNo + "&claimNo=" + claimNo + "&registNo=" + registNo, "NewWindow", "toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=no,resizable=yes,width=500,Height=600");
}
