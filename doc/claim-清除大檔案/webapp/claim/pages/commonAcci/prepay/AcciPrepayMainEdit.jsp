...
<table border="0" align="center" cellpadding="0" cellspacing="0" class="common">
	<tr>
		...
		<td>
			<input type="button" name="message" value="<s:text name='button.disMessage.value' />" onclick="openWinSave()">
		</td>
		<%--讨论留言--%>
		<td>
			<input type="button" name="messageView" value="<s:text name='button.viewMessage.value' />" onclick="openWinQuery()">
		</td>
		<%--查看留言--%>
		<td width="70%" align="right">
			<font color="#666666"> <s:text name="scheduleObject.note1" />
				<%--注:--%>“<font color="#FF0000">*</font>”<s:text name="scheduleObject.note2" />，<%--为必选项--%>“<img src="${ctx}/images/bgDoubleClick2.gif" width="13" height="13" align="absbottom">” <s:text name="scheduleObject.note3" />。<%--为双击选择项--%></font>
		</td>
	</tr>
</table>
<table border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#2D8EE1" class="title" width="100%">
	...
	<tr>
		...
		<td class="input" style="width: 36%">
			<input type=text name="prpLprepayPreCompensateNo" title="預付賠款號碼" maxlength="22" class="readonly" readonly="true" value="${prpLprepay.preCompensateNo}">
		</td>
		<td class="title" style="width: 15%">
	...
	<tr>
		...
		<%--币别--%>
		<td class="input">
			<input name="prpLprepayCurrency" class="readonly" readonly style="width: 40px" value="${prpLprepay.currency}" ondblclick="code_CodeSelect(this, 'Currency');" onkeyup="code_CodeSelect(this, 'Currency');">
			<input name="prpLprepayCurrencyName" class="readonly" readonly style="width: 100px" value="${prpLprepay.currencyName}" ondblclick="code_CodeSelect(this, 'Currency','-1','always','none','post');" onkeyup="code_CodeSelect(this, 'Currency','-1','always','none','post');">
		</td>
		<td class="title">
		...
		<%--预赔金额--%>
		<td class="input">
			<input name="prpLprepaySumPrePaid" type="text" class="input" style="width: 130" value="<fmt:formatNumber value='${prpLprepay.sumPrePaid' pattern='#'/>">
			<img src="${ctx}/images/bgMarkMustInput.jpg">
		</td>
	</tr>
	<tr>
		<td class="title">
			<s:text name="db.prpLreplevy.comCode" />:
		</td>
		<%--业务归属机构--%>
		<td class="input">
	...
	<tr>
		...
		<%--经办人--%>
		<td class="input">
			<input name="prpLprepayHandlerCode" class="codecode" style="width: 40%" value="${prpLprepay.handlerCode}" ondblclick="code_CodeSelect(this, 'HanderCode');" onkeyup="code_CodeSelect(this, 'HanderCode');">
			<input name="prpLprepayHandlerName" class="codename" style="width: 50%" title="經辦人" value="${prpLprepay.handlerName}" ondblclick="code_CodeSelect(this, 'HanderCode','-1','always','none','post');" onkeyup="code_CodeSelect(this, 'HanderCode','-1','always','none','post');">
		</td>
		<td class="title">
			<s:text name="cdb.prpLclaim.statisticsYM" />:
		</td>
		<%--统计年月--%>
		<td class="input">
			<input type="text" class="input" style="width: 130" name="prpLprepayStatisticsYM" value="${prpLprepay.statisticsYM}">
			<img src="${ctx}/images/bgMarkMustInput.jpg">
		</td>
	</tr>
</table>
