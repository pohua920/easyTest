					...
					<tbody>
						<tr>
							...
							<td class="input" style="width: 25%" style="align:center">
								<input type=text name="prpLclaimLossKindCode" value="" class="codecode" style="width: 50px" title="險別" ondblclick="code_CodeSelect(this,'PolicyKindCode','0,1','Y','Y',fm.policyno.value+'|'+fm.damageStartDate.value+'|'+fm.damageStartHour.value);"
									onchange="code_CodeChange(this,'PolicyKindCode','0,1,2,3','Y','Y',fm.policyno.value+'|'+fm.damageStartDate.value+'|'+fm.damageStartHour.value);" onkeyup="code_CodeSelect(this,'PolicyKindCode','0,1','Y','Y',fm.policyno.value+'|'+fm.damageStartDate.value+'|'+fm.damageStartHour.value);">
								<input type=text name="prpLclaimLossKindName" class="codecode" style="width: 250px" title="險別" ondblclick="code_CodeSelect(this,'PolicyKindCode','-1,0','Y','N',fm.policyno.value+'|'+fm.damageStartDate.value+'|'+fm.damageStartHour.value);"
									onchange="code_CodeChange(this,'PolicyKindCode','-1,0,1,2','Y','N',fm.policyno.value+'|'+fm.damageStartDate.value+'|'+fm.damageStartHour.value);" onkeyup="code_CodeSelect(this,'PolicyKindCode','-1,0','Y','N',fm.policyno.value+'|'+fm.damageStartDate.value+'|'+fm.damageStartHour.value);">
