		...
		<td class="common" colspan="4">
			<span style="display: none">
					...
					<tbody>
						<tr>
							...
							<td class="input" style="width: 18%" style="align:center">
								<input type="text" name="prpLclaimLossKindCode" value="" class="codecode" style="width: 15%" title="險別" ondblclick="code_CodeSelect(this,'PolicyKindCode','0,1','Y','Y',fm.policyno.value+'|'+fm.damageStartDate.value+'|'+fm.damageStartHour.value);"
									onchange="code_CodeChange(this,'PolicyKindCode','0,1','Y','Y',fm.policyno.value+'|'+fm.damageStartDate.value+'|'+fm.damageStartHour.value);" onkeyup="code_CodeSelect(this,'PolicyKindCode','0,1','Y','Y',fm.policyno.value+'|'+fm.damageStartDate.value+'|'+fm.damageStartHour.value);">
								<input type="text" name="prpLclaimLossKindName" class="codecode" style="width: 75%" title="險別" ondblclick="code_CodeSelect(this,'PolicyKindCode','-1,0','Y','N',fm.policyno.value+'|'+fm.damageStartDate.value+'|'+fm.damageStartHour.value);"
									onchange="code_CodeChange(this,'PolicyKindCode','-1,0','Y','N',fm.policyno.value+'|'+fm.damageStartDate.value+'|'+fm.damageStartHour.value);" onkeyup="code_CodeSelect(this,'PolicyKindCode','-1,0','Y','N',fm.policyno.value+'|'+fm.damageStartDate.value+'|'+fm.damageStartHour.value);">
							...
							<td class="input" style="width: 13%" style="align:center">
								...
								<%--标的代码--%>
								<input type='input' name="prpLclaimLossItemName" class="codename" style="width: 65%" title="<s:text name='regist.prpLregist.itemName'/>"
							...
							<td class="input" style="width: 10%" align="center">
								...
								<input readonly name="prpLclaimLossFeeCategory" type="hidden" value="">
				...
				<table class="common" style="width: 100%" id="ClaimLoss">
					<thead>
						<tr>
							<td class="formtitle" colspan="11"><s:text name="claim.amountInsurLossInfo" /></td><%-- 险别估损金额信息--%>
						</tr>
						<tr>
							<td class="centertitle" style="width: 5%"><s:text name="claim.dangeSerialNum" /></td><%-- 危险单位序号--%>
							<td class="centertitle" style="width: 18%"><s:text name="certainLoss.thirdCarLoss.prpLcheckRiskType" /></td><%-- 险别--%>
							<td class="centertitle" style="width: 13%">標的物</td>
							<td class="centertitle" style="width: 7%">保險金額</td>
							<td class="centertitle" style="width: 7%"><s:text name="claim.cost" /></td><%-- 费用类别--%>
							...
							<td class="centertitle" style="width: 10%">修改日期</td><%-- 输入日期--%>
					...
					<tfoot>
						<tr>
							<td class="title" colspan="10"><s:text name="prompt.schedule.addRename10" /></td><%--  (按"+"号键增加估损金额信息，按"-"号键删除信息) --%>
					...
					<tbody>
						<c:forEach var="prpLclaimLoss" items="${claimDto.prpLclaimLossList}">
							<tr>
								...
								<td class="input" style="width: 18%" style="align:center">
									<input readonly type="text" name="prpLclaimLossKindCode" class="codecode" style="width: 15%" title="險別" value="${prpLclaimLoss.kindCode}">
									<input readonly type="text" name="prpLclaimLossKindName" class="codecode" style="width: 75%" title="險別" value="${prpLclaimLoss.kindName}">
									<input type="hidden" class="readonly" name="prpLclaimLossKindRest" value="${prpLclaimLoss.kindRest}">
								</td>
								<td class="input" style="width: 13%" style="align:center">
									<input type='input' name='prpLclaimLossItemCode' class="codecode" style="width: 25%" title="<s:text name='db.prpDlimit.itemCode'/>" value="${prpLclaimLoss.itemCode}"
										ondblclick="claimLossItemCodeSelect(this,'policyItemKindCodeNoRisk','0,1,2,3,-2,-1','Y','Y',fm.policyno.value);"
										onkeyup="claimLossItemCodeSelect(this,'policyItemKindCodeNoRisk','0,1,2,3,-2,-1','Y','Y',fm.policyno.value);"
										onchange="claimLossItemCodeSelect(this,'policyItemKindCodeNoRisk','0,1,2,3,-2,-1','Y','Y',fm.policyno.value);"><%--标的代码--%>
									<input type='input' name="prpLclaimLossItemName" class="codename" style="width: 65%" title="<s:text name='regist.prpLregist.itemName'/>" value="${prpLclaimLoss.itemDetailName}"
										ondblclick="claimLossItemCodeSelect(this,'policyItemKindCodeNoRisk','-1,0,1,2,-3,-2','Y','N',fm.policyno.value);"
										onkeyup="claimLossItemCodeSelect(this,'policyItemKindCodeNoRisk','-1,0,1,2,-3,-2','Y','N',fm.policyno.value);"
								...
								<td class="input" style="width: 7%" align="center"><%--保险金额 --%>
									<input type="text" name="prpLclaimLossAmount" class="readonly" readonly style="" title="<s:text name="db.prpLpersonloss.amount" />" value="<fmt:formatNumber value='${prpLclaimLoss.amount}' pattern='#'/>">
								</td>
								<td class="input" style="width: 7%" align="center">
