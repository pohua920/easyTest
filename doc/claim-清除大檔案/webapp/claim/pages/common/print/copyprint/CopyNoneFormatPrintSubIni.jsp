...
<%
	...
	String[] arrEngageTitleFlag = null; //标题标志
	String[] arrClauseCode = null; //条款代码
	String strEngage = "";
	...
	if (policyDto.getPrpCitemKindDtoList() != null) {
		...
		while (iterator.hasNext()) {
			...
			if (prpCitemKindDtoTemp.getFlag() == null || "".equals(prpCitemKindDtoTemp.getFlag())) {
				strItemKindFlag[i] = "";
			} else {
	...
	if (policyDto.getPrpCengageDtoList() != null) {
		...
		arrEngageTitleFlag = new String[collection.size()];
		...
		while (iterator.hasNext()) {
			...
			arrEngageTitleFlag[i] = prpCengageDto.getTitleFlag();
			arrClauseCode[i] = prpCengageDto.getClauseCode();
			if (arrClauseCode[i].substring(0, 1).equals("T")) {
				if (arrEngageTitleFlag[i].substring(0, 1).equals("0")) {
					strEngage = strEngage + "\n" + arrEngage[i] + " ";
				} else {
