				...
				<table width="100%" align="center" style="font-family: 宋体; font-size: 11pt;">
					...
					<%
						for (i = 0; i < strKindName.length; i++) {
								...
								if (strCalculateFlag != null && strCalculateFlag[i].substring(2, 3).equals("1") && strCalculateFlag[i].substring(4, 5).equals("0") && strCalculateFlag[i].substring(5, 6).equals("0")) {
					%>
					<tr>
						<td align="left">
							&nbsp;&nbsp;<%=strKindName[i]%></td>
						...
						<td colspan="4">
							<table width="100%" align="center" style="font-family: 宋体; font-size: 11pt;">
								...
								<%
									for (i = 0; i < strKindName.length; i++) {
											//利损附加险
											if (strCalculateFlag != null && strCalculateFlag[i].substring(2, 3).equals("1") && strCalculateFlag[i].substring(4, 5).equals("0") && strCalculateFlag[i].substring(5, 6).equals("1")) {
								%>
								<tr>
									<td align="center">
										&nbsp;&nbsp;<%=strKindName[i]%></td>
