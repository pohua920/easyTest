...
<script language='javascript'>
	function print(type) {
		var strUrl = '';
		strUrl = '/claim/common/guarantee/print/UIEditReportPrint.jsp?BizNo=' + fm.ClaimNo.value + '&BizType=3&PrintType=' + type;
		printWindow(strUrl, "列印1");
	}

	function edit() {
		strUrl = '/claim/common/guarantee/print/MairineRightsTransferReportPrint.jsp?claimNo=' + fm.ClaimNo.value;
		printWindow(strUrl, "列印1");
	}
	...
	<form name=fm action="/claim/guarantee.do?actionType=undwrtSubmit" method="post" onsubmit="">
		...
		<table class="common" cellpadding="5" cellspacing="1">
			...
			<tr>
				...
				<td class="title">
					<s:text name="guarantee.documentsCopiesIssued" />
				</td>
				<!-- 单证出具份数 -->
				<td class="input">
		...
		<table class="common" align="center">
			...
			<tr>
				...
				<td class="button">
					<input type="button" name="buttonSave" value="<s:text name="button.next.value" />" class="bigbutton"
					<!-- 船货不可分割协议 -->
					onclick="print('9');"
					<%
