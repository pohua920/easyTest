...
<html lang="zh">
<head>
<title><s:text name="guarantee.sponsorshipApplyQuery" /></title>
<!-- 担保申请查询 -->
	...
	<form name="fm" action="/claim/guarantee.do?actionType=search" method="post">
		...
		<table>
			<tr>
				...
				<td align="center" class="centertitle" style="width: 5%">
			...
			<logic:iterate id="prpLclaimDto" name="claimList">
				<tr class=listodd>
					...
					<td align="center">
						<a href="/claim/guarantee.do?actionType=add&prpLGuaranteeClaimNo=<bean:write name='prpLclaimDto' property="claimNo"/>"><bean:write name='prpLclaimDto' property="claimNo" /> </a>
					</td>
					<td align="center">
