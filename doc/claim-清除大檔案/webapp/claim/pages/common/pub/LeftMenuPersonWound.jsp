	...
	<td nowrap>
		...
		<table border=0 cellspacing=0 cellpadding=0 class="menu">
			...
			<tr>
				<td nowrap></td>
				<td align=left nowrap>
					<font ID="1601font" color="#000000" onClick="maingo('1601','sysMenu','正在处理预赔任務','/claim/claimStatusQuery.do?status=2&nodeType=prepa','1601')" style="cursor: 'hand'"> <v:line
							style="POSITION: absolute" from="0,0" to="0,16">
							<v:stroke dashstyle="ShortDot"></v:stroke>
						</v:line> <v:line style="POSITION: absolute" from="0,10" to="10,10">
							<v:stroke dashstyle="ShortDot"></v:stroke>
			...
			<tr>
				<td nowrap></td>
				<td align=left nowrap>
					<font ID="1603font" color="#000000" onClick="maingo('1603','sysMenu','已提交预赔任務','/claim/claimStatusQuery.do?status=4&nodeType=prepa','1603')" style="cursor: 'hand'"> <v:line
							style="POSITION: absolute" from="0,0" to="0,16">
							<v:stroke dashstyle="ShortDot"></v:stroke>
						</v:line> <v:line style="POSITION: absolute" from="0,10" to="10,10">
							<v:stroke dashstyle="ShortDot"></v:stroke>
