...
<script language='javascript'>
	...
	function submitForm() {
		fm.action = '/claim/referlaw.do?actionType=save';
		fm.submit();
	}
</script>
</head>
...
<body class="interface" onload="">
	<form name=fm action="/claim/referlaw.do?actionType=save" method="post" onsubmit="">
		...
		<table class="common" cellpadding="5" cellspacing="1">
			...
			<tr>
				<td class="input" colspan="4">
					<textarea class="text" style="wrap: hard" rows="5" cols="80" name="adjudgmentOne"></textarea>
				</td>
			</tr>
			<tr>
				<td class="input" colspan="4">
			...
			<tr>
				<td class="input" colspan="4">
					<textarea class="text" style="wrap: hard" rows="5" cols="80" name="adjudgmentTwo"></textarea>
				</td>
			</tr>
			<tr>
				<td class="input" colspan="4">
			...
			<tr>
				<td class="input" colspan="4">
					<textarea class="text" style="wrap: hard" rows="5" cols="80" name="adjudgmentThree"></textarea>
				</td>
			</tr>
		</table>
