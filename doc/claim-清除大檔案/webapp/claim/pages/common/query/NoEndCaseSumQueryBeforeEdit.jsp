		...
		<table border="0" align="center" cellpadding="5" cellspacing="1" class="common">
			<tr>
				<td colspan=4 class="formtitle">
					<s:text name="query.noClaimQuery" />
					<%--未决赔案查询 --%>
				</td>
			</tr>
			<tr>
				...
				<td class='title'>
					<s:text name="db.prpDkind.riskCode" />
					<%--险种代码 --%>
					：
				</td>
				<td class=input>
...
-->
    ...
    <tr>
	  <td class=title><s:text name="query.claimsSummaryList" />业务来源:</td>
      <td class="input">
        <select class=tag  name="CurBusinessNatureSign">
            <option value="*">*</option>
            <option value="=">=</option>
          </select> <input name="BusinessNature" class="query"   maxlength="22"></td>
      <td class=title><s:text name="query.claimsSummaryList" />币别:</td>
      <td class=input>
...
<!--
      <td class=title><s:text name="query.claimsSummaryList" />总保险金额:</td>
      <td class=input>
    ...
    <tr>
      <td class=title><s:text name="query.claimsSummaryList" />总保险费:</td>
      <td class=input>
...
-->
    <tr>
      <td class=title><s:text name="query.claimsSummaryList" />出单机构:</td>
      <td class=input>
        <select class=tag  name="MakeComSign">
            <option value="*">*</option>
            <option value="=">=</option>
          </select> <input name="MakeCom" class="query"   maxlength="8"></td>
      <td class=title><s:text name="query.claimsSummaryList" />归属机构:</td>
      <td class=input>
    ...
    <tr>
		<td class=title><s:text name="query.claimsSummaryList" />业务员代码:</td>
      <td class=input>
        <select class=tag   name="Handler1CodeSign">
            <option value="*">*</option>
            <option value="=">=</option>
          </select> <input name="Handler1Code" class="query"   maxlength="10"></td>
	  <td class=title><s:text name="query.claimsSummaryList" />经办人代码:</td>
      <td class=input>
    ...
    <tr>
      <td class=title><s:text name="query.claimsSummaryList" />操作员代码:</td>
      <td class=input>
...
-->
	  <td class=title><s:text name="query.claimsSummaryList" />代理人代码:</td>
      <td class=input>
...
<table width=100%>
    <tr>
      <td colspan=2 class=button>
        <input type="button" name="buttonSubmit" class="button" value=" <s:text name="query.claimsSummaryList" />查 询 " onclick="submitForm()">
      </td>
      <td colspan=2 class=button>
        <input type="button" name="buttonCancel" class="button" value=" <s:text name="query.claimsSummaryList" />清 除 " onclick="resetForm()">
      </td>
    </tr>
