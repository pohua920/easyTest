		...
		function initChecklist() {
			if (document.all && document.getElementById) {
				...
				for (i = 0; i < lists.length; i++) {
					...
					if (theList.className.indexOf("btn_add") > -1 ) {

							theList.onmouseover = function() { this.className="btn_add_over"; };
							theList.onmouseout = function() { this.className="btn_add"; };

					}
					if (theList.className.indexOf("btn_del") > -1 ) {

							theList.onmouseover = function() { this.className="btn_del_over"; };
							theList.onmouseout = function() { this.className="btn_del"; };

					}
					if (theList.className.indexOf("btn_edit") > -1 ) {

							theList.onmouseover = function() { this.className="btn_edit_over"; };
							theList.onmouseout = function() { this.className="btn_edit"; };
