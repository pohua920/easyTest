...
public class GetPrpDCodeWithServiceImpl implements
	...
	public String execute(String requestxml) throws Exception {
		...
		dictPage = dictionaryService.getPrpDCodeWithRisk(systemCode,codeType,codeCode,codeCName,withCode,ignoreCode,extraCodeCode,upperCode,pageNo, pageSize);
	    head = MessageUtil.setHeadMessage(ServiceInfoConst.ERRORCODE_SUCCESS, ServiceInfoConst.ERRORMSG_SUCCESS, ServiceInfoConst.GETPRPDCODEWITHRISK, ServiceInfoConst.RESPONSECODE_SUCCESS);
