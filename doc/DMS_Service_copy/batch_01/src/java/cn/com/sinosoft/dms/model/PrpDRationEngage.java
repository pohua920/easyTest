...
/**
* PrpDRationEngage generated by Tools.Don't edit.
 */
@Entity
@Table(name="PRPDRATIONENGAGE"
)
public class PrpDRationEngage  implements java.io.Serializable {
    private static final long serialVersionUID = 1L;


     /** �ر�Լ������ */
     private PrpDRationEngageId id;
     /** �������� */
    ...
    public PrpDRationEngageId getId() {
        return this.id;
    }
    
    public void setId(PrpDRationEngageId id) {
        this.id = id;
    }
    /**       
     * ��������
