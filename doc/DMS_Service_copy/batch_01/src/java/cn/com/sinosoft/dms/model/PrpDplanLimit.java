...
/**
 * PrpDplanLimit generated by Tools.Don't edit.
 */
@Entity
@Table(name = "prpdplanlimit")
public class PrpDplanLimit implements java.io.Serializable {
	private static final long serialVersionUID = 1L;

	/** 序号 */
	private PrpDplanLimitId id;
	/** 限额/免赔标志 */
	...
	public PrpDplanLimitId getId() {
		return this.id;
	}

	public void setId(PrpDplanLimitId id) {
		this.id = id;
	}
