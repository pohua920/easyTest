	...
	<table class="fix_table">
		...
		<tr>
			...
			<td class="long"><s:textfield name="utiIUserIdv.age" value="${utiIUserIdv.age}"
					id="utiIUserIdv.age" cssClass='input_w w_15' maxlength="20"/></td>
		...
		<tr>
			...
			<td class="long">
				<s:textfield name="utiIUserIdv.creatorCode" 
					id="utiIUserIdv.creatorCode" cssClass='input_w w_15' maxlength="3" value="${utiIUserIdv.creatorCode}" />
			</td>
			<td class="bgc_tt short">信息创建日期</td>
			<td class="long"><s:textfield name="utiIUserIdv.createDate" 
					id="utiIUserIdv.createDate" cssClass='input_w w_15' maxlength="3" value="${utiIUserIdv.createDate}" />
			</td>
		</tr>
		<tr>
			...
			<td class="long">
				<s:textfield name="utiIUserIdv.updaterCode" 
					id="utiIUserIdv.updaterCode" cssClass='input_w w_15' maxlength="3" value="${utiIUserIdv.updaterCode}" />
			</td>
			<td class="bgc_tt short">信息修改日期</td>
			<td class="long"><s:textfield name="utiIUserIdv.updateDate" 
					id="utiIUserIdv.updateDate" cssClass='input_w w_15' maxlength="3" value="${utiIUserIdv.updateDate}" />
			</td>
		</tr>
		<tr>
			<td class="bgc_tt short">印章</td>
			<td class="long"><s:textfield name="utiIUserIdv.seal" value="${utiIUserIdv.seal}"
					id="utiIUserIdv.seal" cssClass='input_w w_15' maxlength="20"/></td>
			<td class="bgc_tt short">备注</td>
			<td class="long"><s:textfield name="utiIUserIdv.remark" 
					id="utiIUserIdv.remark" cssClass='input_w w_15' maxlength="20" value="${utiIUserIdv.remark }" />
			</td>
		</tr>
		<tr>
			<td colspan="4">
...
<script type="text/javascript">
	function addMethod(){
		fm.action="${ctx}/utiIUser/insertUserIdv.do";
		fm.submit();
		return true;
	}
