...
public class TransFindPrpDitemTypeByCondition implements
		DataTransformer<FindByConditionReqPacket, PrpDitemTypeListResPacket> {
	...
	public String execute(String requestxml) throws Exception {
		...
		list = dictionaryService.findPrpDitemTypeByCondition(requestPacket.getHEAD()
				.getSYSTEMCODE(), requestPacket.getBODY().getCONDITION());
		
		//TODO 在ServiceInfoConst中添加对应接口的代码（FINDPRPDCLASSBYID）
		requestType = ServiceInfoConst.FINDPRPDITEMTYPEBYCONDITION;// 设置返回报文的requesttype
