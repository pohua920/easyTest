...
public class TransFindPrpDriskEngageByCondition implements
		DataTransformer<FindByConditionReqPacket, PrpDriskEngageListResPacket> {
	...
	public String execute(String requestxml) throws Exception {
		...
		//TODO 在数据字典接口中添加方法（findPrpDriskEngageById）
		list = dictionaryService.findPrpDriskEngageByCondition(requestPacket.getHEAD()
				.getSYSTEMCODE(), requestPacket.getBODY().getCONDITION());
		
		//TODO 在ServiceInfoConst中添加对应接口的代码（FINDPRPDCLASSBYID）
		requestType = ServiceInfoConst.FINDPRPDRISKENGAGEBYCONDITION;// 设置返回报文的requesttype
