...
public class TransFindPrpDframeByCondition implements
		DataTransformer<FindByConditionReqPacket, PrpDframeListResPacket> {
	...
	public String execute(String requestxml) throws Exception {
		...
		list = dictionaryService.findPrpDframeByCondition(requestPacket.getHEAD()
				.getSYSTEMCODE(), requestPacket.getBODY().getCONDITION());
		
		//TODO 在ServiceInfoConst中添加对应接口的代码（FINDPRPDCLASSBYID）
		requestType = ServiceInfoConst.FINDPRPDFRAMEBYCONDITION;// 设置返回报文的requesttype
