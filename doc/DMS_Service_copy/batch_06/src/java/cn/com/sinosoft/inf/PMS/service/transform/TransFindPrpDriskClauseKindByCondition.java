...
public class TransFindPrpDriskClauseKindByCondition implements
		DataTransformer<FindByConditionReqPacket, PrpDriskClauseKindListResPacket> {
	...
	public String execute(String requestxml) throws Exception {
		...
		list = dictionaryService.findPrpDriskClauseKindByCondition(requestPacket.getHEAD()
				.getSYSTEMCODE(), requestPacket.getBODY().getCONDITION());
		
		//TODO 在ServiceInfoConst中添加对应接口的代码（FINDPRPDCLASSBYID）
		requestType = ServiceInfoConst.FINDPRPDRISKCLAUSEKINDBYCONDITION;// 设置返回报文的requesttype
...
//				prpDriskClauseKindResInfo.setCLAUSECODE(prpDriskClauseKind.getClauseAttribute());//注释的为删除的字段
...
//				prpDriskClauseKindResInfo.setCLAUSEATTRIBUTE(prpDriskClauseKind.getClauseAttribute());
				...
				prpDriskClauseKindResInfo.setCLACULATEFAG(prpDriskClauseKind.getClaculateFag());
				prpDriskClauseKindResInfo.setCLAIMTYPE(prpDriskClauseKind.getClaimType());
				prpDriskClauseKindResInfo.setENDUPDATERCODE(prpDriskClauseKind.getEndUpdaterCode());
				prpDriskClauseKindResInfo.setOPERATETIMEFORHIS(prpDriskClauseKind.getOperateTimeForHis().toString());//这些为新加入的字段end...
