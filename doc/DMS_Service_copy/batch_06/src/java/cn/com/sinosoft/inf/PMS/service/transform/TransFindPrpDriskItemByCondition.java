...
public class TransFindPrpDriskItemByCondition implements
		DataTransformer<FindByConditionReqPacket, PrpDriskItemListResPacket> {
	...
	public String execute(String requestxml) throws Exception {
		...
		list = dictionaryService.findPrpDriskItemByCondition(requestPacket.getHEAD()
				.getSYSTEMCODE(), requestPacket.getBODY().getCONDITION());
		
		//TODO 在ServiceInfoConst中添加对应接口的代码（FINDPRPDCLASSBYID）
		requestType = ServiceInfoConst.FINDPRPDRISKITEMBYCONDITION;// 设置返回报文的requesttype
