...
YAHOO.widget.Calendar._DEFAULT_CONFIG = {
	...
	MONTHS_SHORT : {key:"months_short", value:["一月", "二月", "三月", "四月", "五月", "六月", "七月", "八月", "九月", "十月", "十一月", "十二月"]},
	MONTHS_LONG: {key:"months_long", value:["一月", "二月", "三月", "四月", "五月", "六月", "七月", "八月", "九月", "十月", "十一月", "十二月"]},
	WEEKDAYS_1CHAR: {key:"weekdays_1char", value:["S", "M", "T", "W", "T", "F", "S"]},
	WEEKDAYS_SHORT: {key:"weekdays_short", value:["日", "一", "二", "三", "四", "五", "六"]},
...
* @param {Calendar} cal	A reference to the calendar passed by the Event utility点击面板
*/
...
* 面板鼠标事件
*/
    YAHOO.util.Event.addListener(this.oDomContainer, "click", function(e, cal) {cal.hide(); YAHOO.util.Event.preventDefault(e); }, this);
