	...
	function init(){
		 ...
		 YAHOO.widget.Column.formatLink = function(elCell, oRecord, oColumn, oData) { 
		    var oId = oRecord.userCode;
		     if(oColumn.key=="edit"){
	    		 elCell.innerHTML = "<a href=\"#\" onclick=\"editRecordBig('${ctx}/saaUserInstead/checkUserInstead.do?userCode=" + oId+"')\">配置</a>";
		      }
		...
		contentColumnHeaders =[
			...
			{key:"edit",text:"代岗授权",width:"20em",type:"link",resizeable:true}
			]; 
	}
	//Query Data
