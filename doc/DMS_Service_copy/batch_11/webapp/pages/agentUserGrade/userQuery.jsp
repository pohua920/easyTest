	...
	<table class="fix_table">	
		<tr>
			...
			<td class="long"><input name="saaUser.userCode"
				...
				ondblclick="code_CodeQuery(this, 'AgentUserCode', '0,1', 'Y','')"
				onkeyup="code_CodeQuery(this, 'AgentUserCode', '0,1', 'Y','')"
				onchange="code_CodeChange(this, 'AgentUserCode', '0,1', 'Y','')"/></td>			
		...
		<tr>
			...
			<td class="long"><input name="saaUser.comCode"
				...
				ondblclick="code_CodeQuery(this, 'AgentComCode', '0,1', 'Y','')"
				onkeyup="code_CodeQuery(this, 'AgentComCode', '0,1', 'Y','')"
				onchange="code_CodeChange(this, 'AgentComCode', '0,1', 'Y','')"/></td>
...
<script type="text/javascript">
		 ...
		 YAHOO.widget.Column.formatLink = function(elCell, oRecord, oColumn, oData) { 
		    var oId = oRecord.userCode;
		     if(oColumn.key=="gradeEdit"){
	    		 elCell.innerHTML = "<a href=\"#\" onclick=\"editRecord('${ctx}/saaUserGrade/prepareUpdateUserGrade.do?userCode=" + oId+"')\">配置</a>";
		      }
		      if(oColumn.key=="powerEdit"){
	    		  elCell.innerHTML = "<a href=\"#\" onclick=\"editRecord('${ctx}/saaUserGrade/prepareUpdateAgentUserGradePower.do?userCode=" + oId+"')\">配置</a>";
		      }
		      if(oColumn.key=="powerGrantEdit"){
	    		  elCell.innerHTML = "<a href=\"#\" onclick=\"editRecord('${ctx}/saaUserPower/prepareUpdateAgentUserGradePower.do?userCode=" + oId+"')\">配置</a>";
		      }
	...
	function executeQuery(pageNo,pageSize){
		...
		var myDataSource = new YAHOO.util.DataSource("${ctx}/saaUser/queryAgentUser.do");
