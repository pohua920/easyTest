...
--%>			
      ...
      <tr>       
        ...
        <td class="long"><s:textfield name="prpDagentAll.upperAgentCode" 
          id="upperAgentCode" cssClass='input_w w_30' maxlength="12" readonly="true"/></td>
        <td class="bgc_tt short">新的代理人代码 </td>
        <td class="long"><s:textfield name="prpDagentAll.newAgentCode" 
...
-->
		<ct:select name="prpDagentAll.validStatus" value="${prpDagentAll.validStatus}" id="validStatus" sysCode="IMS" codeType="ValidStatus" disabled="true"></ct:select>
		</td>  
        <td class="bgc_tt short">专项代码</td>
         <td class="long"><s:textfield name="prpDagentAll.articleCode" 
          id="articleCode" cssClass='input_w w_30' maxlength="8" readonly="true"/></td>
      </tr>
      <tr>     
        <td class="bgc_tt short">是否允许下级机构使用</td>
        <td class="long"><s:select name="prpDagentAll.agentNature" 
    ...
    <s:elseif test="${editType=='update' }">
      ...
      <tr>
      	<td class="bgc_tt short">本地机构代码</td>
        <td class="long"><s:textfield name="prpDagentAll.id.locateComCode" 
          id="locateComCode" cssClass='input_w w_30' maxlength="8"/></td>
        <td class="bgc_tt short">归属机构代码</td>
        <td class="long"><input name="prpDagentAll.comCode" 
          id="comCode" Class='input_y w_15' maxlength="8" VALUE="${prpDagentAll.comCode}"
...
-->
		<ct:select name="prpDagentAll.validStatus" id="validStatus" sysCode="IMS" codeType="ValidStatus" value="${prpDagent.validStatus}"></ct:select>
		<s:hidden name="prpDagentAll.validStatus" id="validStatus" value="${prpDagent.validStatus}"></s:hidden>
		</td>  
        <td class="bgc_tt short">专项代码</td>
        <td class="long"><s:textfield name="prpDagentAll.articleCode" 
    ...
    <s:elseif test="${editType=='insert'}">
      ...
      <tr>
        ...
        <td class="bgc_tt short">归属机构代码</td>
		<td class="long">
                <input  name="prpDagentAll.comCode" id="comCode"
...
<!--
        <s:select name="prpDagent.ValidStatus" id="validStatus"
          list="#@java.util.HashMap@{'1':'有效','0':'无效'}"/>
-->
		<ct:select name="prpDagentAll.validStatus" id="validStatus" sysCode="IMS" codeType="ValidStatus" value="1"></ct:select>
		<s:hidden name="prpDagentAll.validStatus" id="validStatus" value="1"></s:hidden>
        <td class="bgc_tt short">专项代码</td>
         <td class="long"><s:textfield name="prpDagentAll.articleCode" 
          id="articleCode" cssClass='input_w w_30' maxlength="8"/></td>
      </tr>
