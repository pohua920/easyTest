 ...
 * @version 2.0 2007-01-19 李子扬，使用BufferedInputStream，替换原有的FilterInputStream.
 */

//public class JOXBeanInputStream extends FilterInputStream{
public class JOXBeanInputStream extends BufferedInputStream{ 
	...
	public void readObject(Object ob) throws IOException {
		...
		//LZY: reader.readObject(ob, new InputSource(in));
		reader.readObject(ob, new InputSource(this));
	}
