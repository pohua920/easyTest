...
/**
 * A writer filter that writes out a bean as an XML document. The writer can
 * write out basic Java types, their object equivalents and also strings, dates
 * and other beans. The XML tag names are the same as the bean properties.
 * 
 * @author Mark Wutka
...
public class JOXBeanWriter extends FilterWriter implements JOXOutput {
	...
	/**
	 * Create a new writer around an existing writer and specifies a DTD for
	 * selecting which attributes should be written and what the names should
	 * look like.
	 * 
	 * @param dtdURI
	 *            The URI of the DTD
	 ...
	 *            The XML encoding to use
	 */
	public JOXBeanWriter(String dtdURI, Writer baseWriter, String anEncoding)
			throws IOException {
		super(baseWriter);
	 ...
	 *            The XML encoding to use
	 */
	public JOXBeanWriter(DTD dtd, Writer baseWriter, String anEncoding)
			throws IOException {
		super(baseWriter);
	...
	/**
	 * Write a string to the writer This method is used by the output utility to
	 * write a string to either an output stream or a writer.
	 * 
	 * @param str
	 *            The string to write
	 */
